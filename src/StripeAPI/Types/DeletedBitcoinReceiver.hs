...
data DeletedBitcoinReceiver = DeletedBitcoinReceiver {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeletedBitcoinReceiver
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["id" Data.Aeson.Types.ToJSON..= deletedBitcoinReceiverId obj] : ["deleted" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.Bool GHC.Types.True] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "bitcoin_receiver"] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON DeletedBitcoinReceiver
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "DeletedBitcoinReceiver" (\obj -> GHC.Base.pure DeletedBitcoinReceiver GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id"))
-- | Create a new 'DeletedBitcoinReceiver' with all required fields.
mkDeletedBitcoinReceiver :: Data.Text.Internal.Text -- ^ 'deletedBitcoinReceiverId'
