...
instance Data.Aeson.ToJSON IssuingAuthorizationVerificationData where
...
instance Data.Aeson.ToJSON IssuingAuthorizationVerificationDataAddressLine1Check' where
...
instance Data.Aeson.FromJSON IssuingAuthorizationVerificationDataAddressLine1Check' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "match")
          then IssuingAuthorizationVerificationDataAddressLine1Check'EnumStringMatch
          else
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "mismatch")
              then IssuingAuthorizationVerificationDataAddressLine1Check'EnumStringMismatch
              else
                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "not_provided")
...
instance Data.Aeson.ToJSON IssuingAuthorizationVerificationDataAddressZipCheck' where
...
instance Data.Aeson.FromJSON IssuingAuthorizationVerificationDataAddressZipCheck' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "match")
...
instance Data.Aeson.ToJSON IssuingAuthorizationVerificationDataAuthentication' where
...
instance Data.Aeson.FromJSON IssuingAuthorizationVerificationDataAuthentication' where
  parseJSON val =
    GHC.Base.pure
          ...
          then IssuingAuthorizationVerificationDataAuthentication'EnumStringFailure
            ...
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "none")
              then IssuingAuthorizationVerificationDataAuthentication'EnumStringNone
                ...
                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "success")
...
instance Data.Aeson.ToJSON IssuingAuthorizationVerificationDataCvcCheck' where
...
instance Data.Aeson.FromJSON IssuingAuthorizationVerificationDataCvcCheck' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "match")
