...
mkSubscriptionItem :: GHC.Types.Int -- ^ 'subscriptionItemCreated'
  ...
  -> SubscriptionItem
mkSubscriptionItem subscriptionItemCreated subscriptionItemId subscriptionItemMetadata subscriptionItemPrice subscriptionItemSubscription = SubscriptionItem{subscriptionItemBillingThresholds = GHC.Maybe.Nothing,
