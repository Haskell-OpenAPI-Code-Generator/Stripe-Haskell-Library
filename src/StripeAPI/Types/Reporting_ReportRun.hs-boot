...
instance Show Reporting'reportRunResult'Purpose'
instance Eq Reporting'reportRunResult'Purpose'
instance FromJSON Reporting'reportRunResult'Purpose'
instance ToJSON Reporting'reportRunResult'Purpose'
