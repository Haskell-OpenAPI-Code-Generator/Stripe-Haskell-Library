...
instance Data.Aeson.ToJSON Balance where
...
instance Data.Aeson.ToJSON BalanceObject' where
...
instance Data.Aeson.FromJSON BalanceObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "balance")
