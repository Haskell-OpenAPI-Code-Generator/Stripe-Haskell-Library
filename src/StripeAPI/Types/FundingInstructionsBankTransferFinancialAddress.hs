...
mkFundingInstructionsBankTransferFinancialAddress fundingInstructionsBankTransferFinancialAddressType = FundingInstructionsBankTransferFinancialAddress{fundingInstructionsBankTransferFinancialAddressIban = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON FundingInstructionsBankTransferFinancialAddressSupportedNetworks'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bacs" -> FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumBacs
...
instance Data.Aeson.Types.FromJSON.FromJSON FundingInstructionsBankTransferFinancialAddressType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "iban" -> FundingInstructionsBankTransferFinancialAddressType'EnumIban
