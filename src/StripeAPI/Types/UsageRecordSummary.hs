...
instance Data.Aeson.ToJSON UsageRecordSummary where
...
instance Data.Aeson.ToJSON UsageRecordSummaryObject' where
...
instance Data.Aeson.FromJSON UsageRecordSummaryObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "usage_record_summary")
