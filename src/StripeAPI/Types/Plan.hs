...
data PlanAggregateUsage'NonNullable =
   PlanAggregateUsage'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PlanAggregateUsage'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PlanAggregateUsage'NonNullableEnumLastDuringPeriod -- ^ Represents the JSON value @"last_during_period"@
  | PlanAggregateUsage'NonNullableEnumLastEver -- ^ Represents the JSON value @"last_ever"@
  | PlanAggregateUsage'NonNullableEnumMax -- ^ Represents the JSON value @"max"@
  | PlanAggregateUsage'NonNullableEnumSum -- ^ Represents the JSON value @"sum"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlanAggregateUsage'NonNullable
    where toJSON (PlanAggregateUsage'NonNullableOther val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PlanAggregateUsage'NonNullable
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "last_during_period" -> PlanAggregateUsage'NonNullableEnumLastDuringPeriod
