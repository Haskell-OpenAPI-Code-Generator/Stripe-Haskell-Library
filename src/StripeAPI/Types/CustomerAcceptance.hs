...
instance Data.Aeson.ToJSON CustomerAcceptance where
...
instance Data.Aeson.ToJSON CustomerAcceptanceType' where
...
instance Data.Aeson.FromJSON CustomerAcceptanceType' where
  parseJSON val =
    GHC.Base.pure
