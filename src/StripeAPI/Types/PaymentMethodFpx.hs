...
instance Data.Aeson.ToJSON PaymentMethodFpx where
...
instance Data.Aeson.ToJSON PaymentMethodFpxBank' where
...
instance Data.Aeson.FromJSON PaymentMethodFpxBank' where
  parseJSON val =
    GHC.Base.pure
