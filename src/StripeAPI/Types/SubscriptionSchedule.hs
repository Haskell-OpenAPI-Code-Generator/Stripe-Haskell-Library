...
mkSubscriptionSchedule :: GHC.Types.Int -- ^ 'subscriptionScheduleCreated'
...
mkSubscriptionSchedule subscriptionScheduleCreated subscriptionScheduleCustomer subscriptionScheduleDefaultSettings subscriptionScheduleEndBehavior subscriptionScheduleId subscriptionScheduleLivemode subscriptionSchedulePhases subscriptionScheduleStatus = SubscriptionSchedule{subscriptionScheduleApplication = GHC.Maybe.Nothing,
