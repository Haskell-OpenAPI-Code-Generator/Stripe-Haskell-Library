...
instance Show IssuingCardShippingSpeed'
instance Eq IssuingCardShippingSpeed'
instance FromJSON IssuingCardShippingSpeed'
instance ToJSON IssuingCardShippingSpeed'
