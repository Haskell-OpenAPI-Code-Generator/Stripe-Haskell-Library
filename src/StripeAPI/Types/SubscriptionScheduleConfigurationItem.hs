...
mkSubscriptionScheduleConfigurationItem :: SubscriptionScheduleConfigurationItemPrice'Variants -- ^ 'subscriptionScheduleConfigurationItemPrice'
  -> SubscriptionScheduleConfigurationItem
mkSubscriptionScheduleConfigurationItem subscriptionScheduleConfigurationItemPrice = SubscriptionScheduleConfigurationItem{subscriptionScheduleConfigurationItemBillingThresholds = GHC.Maybe.Nothing,
