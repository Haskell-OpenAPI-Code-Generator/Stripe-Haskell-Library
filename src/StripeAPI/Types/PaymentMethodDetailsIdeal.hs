...
instance Data.Aeson.ToJSON PaymentMethodDetailsIdeal where
...
instance Data.Aeson.ToJSON PaymentMethodDetailsIdealBank' where
...
instance Data.Aeson.FromJSON PaymentMethodDetailsIdealBank' where
  parseJSON val =
    GHC.Base.pure
...
instance Data.Aeson.ToJSON PaymentMethodDetailsIdealBic' where
...
instance Data.Aeson.FromJSON PaymentMethodDetailsIdealBic' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "ABNANL2A")
          then PaymentMethodDetailsIdealBic'EnumStringABNANL2A
          else
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "ASNBNL21")
              then PaymentMethodDetailsIdealBic'EnumStringASNBNL21
              else
                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "BUNQNL2A")
                  then PaymentMethodDetailsIdealBic'EnumStringBUNQNL2A
                  else
                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "FVLBNL22")
                      then PaymentMethodDetailsIdealBic'EnumStringFVLBNL22
                      else
                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "HANDNL2A")
                          then PaymentMethodDetailsIdealBic'EnumStringHANDNL2A
                          else
                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "INGBNL2A")
                              then PaymentMethodDetailsIdealBic'EnumStringINGBNL2A
                              else
                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "KNABNL2H")
                                  then PaymentMethodDetailsIdealBic'EnumStringKNABNL2H
                                  else
                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "MOYONL21")
                                      then PaymentMethodDetailsIdealBic'EnumStringMOYONL21
                                      else
                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "RABONL2U")
                                          then PaymentMethodDetailsIdealBic'EnumStringRABONL2U
                                          else
                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "RBRBNL21")
                                              then PaymentMethodDetailsIdealBic'EnumStringRBRBNL21
                                              else
                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "SNSBNL2A")
                                                  then PaymentMethodDetailsIdealBic'EnumStringSNSBNL2A
                                                  else
                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "TRIONL2U")
