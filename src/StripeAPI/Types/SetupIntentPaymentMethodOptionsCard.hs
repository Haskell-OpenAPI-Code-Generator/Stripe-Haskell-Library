...
instance Data.Aeson.ToJSON SetupIntentPaymentMethodOptionsCard where
...
instance Data.Aeson.ToJSON SetupIntentPaymentMethodOptionsCardRequestThreeDSecure' where
...
instance Data.Aeson.FromJSON SetupIntentPaymentMethodOptionsCardRequestThreeDSecure' where
  parseJSON val =
    GHC.Base.pure
