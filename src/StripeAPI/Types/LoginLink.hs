...
instance Data.Aeson.ToJSON LoginLink where
...
instance Data.Aeson.ToJSON LoginLinkObject' where
...
instance Data.Aeson.FromJSON LoginLinkObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "login_link")
