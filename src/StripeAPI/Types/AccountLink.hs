...
instance Data.Aeson.ToJSON AccountLink where
...
instance Data.Aeson.ToJSON AccountLinkObject' where
...
instance Data.Aeson.FromJSON AccountLinkObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "account_link")
