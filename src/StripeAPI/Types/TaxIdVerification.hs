...
instance Data.Aeson.ToJSON TaxIdVerification where
...
instance Data.Aeson.ToJSON TaxIdVerificationStatus' where
...
instance Data.Aeson.FromJSON TaxIdVerificationStatus' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "pending")
          then TaxIdVerificationStatus'EnumStringPending
            ...
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "unavailable")
              then TaxIdVerificationStatus'EnumStringUnavailable
              else
                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "unverified")
                  then TaxIdVerificationStatus'EnumStringUnverified
                  else
                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verified")
