...
instance Data.Aeson.ToJSON Radar'valueListItem where
...
instance Data.Aeson.ToJSON Radar'valueListItemObject' where
...
instance Data.Aeson.FromJSON Radar'valueListItemObject' where
  parseJSON val =
    GHC.Base.pure
