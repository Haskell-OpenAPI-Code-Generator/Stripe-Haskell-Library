...
instance Data.Aeson.ToJSON ApplePayDomain where
...
instance Data.Aeson.ToJSON ApplePayDomainObject' where
...
instance Data.Aeson.FromJSON ApplePayDomainObject' where
  parseJSON val =
    GHC.Base.pure
