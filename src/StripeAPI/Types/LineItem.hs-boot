...
instance FromJSON LineItemPlan'AggregateUsage'
instance ToJSON LineItemPlan'AggregateUsage'
data LineItemPlan'BillingScheme'
instance Show LineItemPlan'BillingScheme'
instance Eq LineItemPlan'BillingScheme'
instance FromJSON LineItemPlan'BillingScheme'
instance ToJSON LineItemPlan'BillingScheme'
data LineItemPlan'Interval'
instance Show LineItemPlan'Interval'
...
instance FromJSON LineItemPlan'Product'Variants
instance ToJSON LineItemPlan'Product'Variants
data LineItemPlan'TiersMode'
instance Show LineItemPlan'TiersMode'
...
instance FromJSON LineItemPlan'TransformUsage'Round'
instance ToJSON LineItemPlan'TransformUsage'Round'
data LineItemPlan'UsageType'
instance Show LineItemPlan'UsageType'
instance Eq LineItemPlan'UsageType'
instance FromJSON LineItemPlan'UsageType'
instance ToJSON LineItemPlan'UsageType'
data LineItemType'
