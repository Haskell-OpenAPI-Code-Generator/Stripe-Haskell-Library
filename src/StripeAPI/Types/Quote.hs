...
mkQuote ::
  ...
  Quote
mkQuote quoteAmountSubtotal quoteAmountTotal quoteAutomaticTax quoteCollectionMethod quoteComputed quoteCreated quoteDiscounts quoteExpiresAt quoteId quoteInvoiceSettings quoteLivemode quoteMetadata quoteStatus quoteStatusTransitions quoteSubscriptionData quoteTotalDetails =
  Quote
