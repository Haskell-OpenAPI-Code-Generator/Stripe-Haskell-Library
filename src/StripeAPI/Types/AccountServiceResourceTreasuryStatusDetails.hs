...
data AccountServiceResourceTreasuryStatusDetails = AccountServiceResourceTreasuryStatusDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountServiceResourceTreasuryStatusDetails
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("closed" Data.Aeson.Types.ToJSON..=)) (accountServiceResourceTreasuryStatusDetailsClosed obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountServiceResourceTreasuryStatusDetails
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountServiceResourceTreasuryStatusDetails" (\obj -> GHC.Base.pure AccountServiceResourceTreasuryStatusDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "closed"))
...
data AccountServiceResourceTreasuryStatusDetailsClosed'NonNullable = AccountServiceResourceTreasuryStatusDetailsClosed'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountServiceResourceTreasuryStatusDetailsClosed'NonNullable
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reasons" Data.Aeson.Types.ToJSON..=)) (accountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountServiceResourceTreasuryStatusDetailsClosed'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountServiceResourceTreasuryStatusDetailsClosed'NonNullable" (\obj -> GHC.Base.pure AccountServiceResourceTreasuryStatusDetailsClosed'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reasons"))
...
data AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons' =
   AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'EnumAccountRejected -- ^ Represents the JSON value @"account_rejected"@
  | AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'EnumClosedByPlatform -- ^ Represents the JSON value @"closed_by_platform"@
  | AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'EnumOther -- ^ Represents the JSON value @"other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'
    where toJSON (AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account_rejected" -> AccountServiceResourceTreasuryStatusDetailsClosed'NonNullableReasons'EnumAccountRejected
