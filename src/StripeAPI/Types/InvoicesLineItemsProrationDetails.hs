...
data InvoicesLineItemsProrationDetails = InvoicesLineItemsProrationDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesLineItemsProrationDetails
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("credited_items" Data.Aeson.Types.ToJSON..=)) (invoicesLineItemsProrationDetailsCreditedItems obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesLineItemsProrationDetails
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesLineItemsProrationDetails" (\obj -> GHC.Base.pure InvoicesLineItemsProrationDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "credited_items"))
...
data InvoicesLineItemsProrationDetailsCreditedItems'NonNullable = InvoicesLineItemsProrationDetailsCreditedItems'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesLineItemsProrationDetailsCreditedItems'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesLineItemsProrationDetailsCreditedItems'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesLineItemsProrationDetailsCreditedItems'NonNullable" (\obj -> (GHC.Base.pure InvoicesLineItemsProrationDetailsCreditedItems'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice_line_items"))
...
mkInvoicesLineItemsProrationDetailsCreditedItems'NonNullable = InvoicesLineItemsProrationDetailsCreditedItems'NonNullable{invoicesLineItemsProrationDetailsCreditedItems'NonNullableInvoice = GHC.Maybe.Nothing,
