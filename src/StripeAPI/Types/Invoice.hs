...
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceDiscount' where
  toJSON obj = Data.Aeson.Types.Internal.object ("checkout_session" Data.Aeson.Types.ToJSON..= invoiceDiscount'CheckoutSession obj : "coupon" Data.Aeson.Types.ToJSON..= invoiceDiscount'Coupon obj : "customer" Data.Aeson.Types.ToJSON..= invoiceDiscount'Customer obj : "end" Data.Aeson.Types.ToJSON..= invoiceDiscount'End obj : "id" Data.Aeson.Types.ToJSON..= invoiceDiscount'Id obj : "invoice" Data.Aeson.Types.ToJSON..= invoiceDiscount'Invoice obj : "invoice_item" Data.Aeson.Types.ToJSON..= invoiceDiscount'InvoiceItem obj : "object" Data.Aeson.Types.ToJSON..= invoiceDiscount'Object obj : "promotion_code" Data.Aeson.Types.ToJSON..= invoiceDiscount'PromotionCode obj : "start" Data.Aeson.Types.ToJSON..= invoiceDiscount'Start obj : "subscription" Data.Aeson.Types.ToJSON..= invoiceDiscount'Subscription obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("checkout_session" Data.Aeson.Types.ToJSON..= invoiceDiscount'CheckoutSession obj) GHC.Base.<> (("coupon" Data.Aeson.Types.ToJSON..= invoiceDiscount'Coupon obj) GHC.Base.<> (("customer" Data.Aeson.Types.ToJSON..= invoiceDiscount'Customer obj) GHC.Base.<> (("end" Data.Aeson.Types.ToJSON..= invoiceDiscount'End obj) GHC.Base.<> (("id" Data.Aeson.Types.ToJSON..= invoiceDiscount'Id obj) GHC.Base.<> (("invoice" Data.Aeson.Types.ToJSON..= invoiceDiscount'Invoice obj) GHC.Base.<> (("invoice_item" Data.Aeson.Types.ToJSON..= invoiceDiscount'InvoiceItem obj) GHC.Base.<> (("object" Data.Aeson.Types.ToJSON..= invoiceDiscount'Object obj) GHC.Base.<> (("promotion_code" Data.Aeson.Types.ToJSON..= invoiceDiscount'PromotionCode obj) GHC.Base.<> (("start" Data.Aeson.Types.ToJSON..= invoiceDiscount'Start obj) GHC.Base.<> ("subscription" Data.Aeson.Types.ToJSON..= invoiceDiscount'Subscription obj)))))))))))

instance Data.Aeson.Types.FromJSON.FromJSON InvoiceDiscount' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoiceDiscount'" (\obj -> ((((((((((GHC.Base.pure InvoiceDiscount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "checkout_session")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "end")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "invoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "invoice_item")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "object")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "promotion_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "start")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "subscription"))
...
mkInvoiceDiscount' =
  InvoiceDiscount'
    { invoiceDiscount'CheckoutSession = GHC.Maybe.Nothing,
      ...
      invoiceDiscount'Object = GHC.Maybe.Nothing,
...
data InvoiceDiscount'Object'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    InvoiceDiscount'Object'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    InvoiceDiscount'Object'Typed Data.Text.Internal.Text
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceDiscount'Object' where
  toJSON (InvoiceDiscount'Object'Other val) = val
  toJSON (InvoiceDiscount'Object'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (InvoiceDiscount'Object'EnumDiscount) = "discount"

instance Data.Aeson.Types.FromJSON.FromJSON InvoiceDiscount'Object' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "discount" -> InvoiceDiscount'Object'EnumDiscount
            | GHC.Base.otherwise -> InvoiceDiscount'Object'Other val
      )
...
data InvoiceLastFinalizationError'Source' = InvoiceLastFinalizationError'Source'
  { -- | account: The ID of the account that the bank account is associated with.
    ...
    -- | object: String representing the object\'s type. Objects of the same type share the same value.
    invoiceLastFinalizationError'Source'Object :: (GHC.Maybe.Maybe InvoiceLastFinalizationError'Source'Object'),
...
mkInvoiceLastFinalizationError'Source' =
  InvoiceLastFinalizationError'Source'
    { invoiceLastFinalizationError'Source'Account = GHC.Maybe.Nothing,
      ...
      invoiceLastFinalizationError'Source'Object = GHC.Maybe.Nothing,
...
data InvoiceLastFinalizationError'Source'Object'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    InvoiceLastFinalizationError'Source'Object'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    InvoiceLastFinalizationError'Source'Object'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"bank_account"@
    InvoiceLastFinalizationError'Source'Object'EnumBankAccount
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON InvoiceLastFinalizationError'Source'Object' where
  toJSON (InvoiceLastFinalizationError'Source'Object'Other val) = val
  toJSON (InvoiceLastFinalizationError'Source'Object'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (InvoiceLastFinalizationError'Source'Object'EnumBankAccount) = "bank_account"

instance Data.Aeson.Types.FromJSON.FromJSON InvoiceLastFinalizationError'Source'Object' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "bank_account" -> InvoiceLastFinalizationError'Source'Object'EnumBankAccount
            | GHC.Base.otherwise -> InvoiceLastFinalizationError'Source'Object'Other val
      )
