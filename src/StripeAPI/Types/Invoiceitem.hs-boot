...
instance FromJSON InvoiceitemPlan'AggregateUsage'
instance ToJSON InvoiceitemPlan'AggregateUsage'
data InvoiceitemPlan'BillingScheme'
instance Show InvoiceitemPlan'BillingScheme'
instance Eq InvoiceitemPlan'BillingScheme'
instance FromJSON InvoiceitemPlan'BillingScheme'
instance ToJSON InvoiceitemPlan'BillingScheme'
data InvoiceitemPlan'Interval'
instance Show InvoiceitemPlan'Interval'
...
instance FromJSON InvoiceitemPlan'Product'Variants
instance ToJSON InvoiceitemPlan'Product'Variants
data InvoiceitemPlan'TiersMode'
instance Show InvoiceitemPlan'TiersMode'
...
instance FromJSON InvoiceitemPlan'TransformUsage'Round'
instance ToJSON InvoiceitemPlan'TransformUsage'Round'
data InvoiceitemPlan'UsageType'
instance Show InvoiceitemPlan'UsageType'
instance Eq InvoiceitemPlan'UsageType'
instance FromJSON InvoiceitemPlan'UsageType'
instance ToJSON InvoiceitemPlan'UsageType'
