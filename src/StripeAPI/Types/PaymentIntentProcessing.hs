...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentProcessing where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("card" Data.Aeson.Types.ToJSON..=)) (paymentIntentProcessingCard obj) : ["type" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "card"] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentProcessing where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentProcessing" (\obj -> GHC.Base.pure PaymentIntentProcessing GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card"))
