...
instance Data.Aeson.Types.ToJSON.ToJSON CreditNoteLineItem where
  toJSON obj = Data.Aeson.Types.Internal.object ("amount" Data.Aeson.Types.ToJSON..= creditNoteLineItemAmount obj : "description" Data.Aeson.Types.ToJSON..= creditNoteLineItemDescription obj : "discount_amount" Data.Aeson.Types.ToJSON..= creditNoteLineItemDiscountAmount obj : "id" Data.Aeson.Types.ToJSON..= creditNoteLineItemId obj : "invoice_line_item" Data.Aeson.Types.ToJSON..= creditNoteLineItemInvoiceLineItem obj : "livemode" Data.Aeson.Types.ToJSON..= creditNoteLineItemLivemode obj : "quantity" Data.Aeson.Types.ToJSON..= creditNoteLineItemQuantity obj : "tax_amounts" Data.Aeson.Types.ToJSON..= creditNoteLineItemTaxAmounts obj : "tax_rates" Data.Aeson.Types.ToJSON..= creditNoteLineItemTaxRates obj : "type" Data.Aeson.Types.ToJSON..= creditNoteLineItemType obj : "unit_amount" Data.Aeson.Types.ToJSON..= creditNoteLineItemUnitAmount obj : "unit_amount_decimal" Data.Aeson.Types.ToJSON..= creditNoteLineItemUnitAmountDecimal obj : "object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "credit_note_line_item" : [])
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("amount" Data.Aeson.Types.ToJSON..= creditNoteLineItemAmount obj) GHC.Base.<> (("description" Data.Aeson.Types.ToJSON..= creditNoteLineItemDescription obj) GHC.Base.<> (("discount_amount" Data.Aeson.Types.ToJSON..= creditNoteLineItemDiscountAmount obj) GHC.Base.<> (("id" Data.Aeson.Types.ToJSON..= creditNoteLineItemId obj) GHC.Base.<> (("invoice_line_item" Data.Aeson.Types.ToJSON..= creditNoteLineItemInvoiceLineItem obj) GHC.Base.<> (("livemode" Data.Aeson.Types.ToJSON..= creditNoteLineItemLivemode obj) GHC.Base.<> (("quantity" Data.Aeson.Types.ToJSON..= creditNoteLineItemQuantity obj) GHC.Base.<> (("tax_amounts" Data.Aeson.Types.ToJSON..= creditNoteLineItemTaxAmounts obj) GHC.Base.<> (("tax_rates" Data.Aeson.Types.ToJSON..= creditNoteLineItemTaxRates obj) GHC.Base.<> (("type" Data.Aeson.Types.ToJSON..= creditNoteLineItemType obj) GHC.Base.<> (("unit_amount" Data.Aeson.Types.ToJSON..= creditNoteLineItemUnitAmount obj) GHC.Base.<> (("unit_amount_decimal" Data.Aeson.Types.ToJSON..= creditNoteLineItemUnitAmountDecimal obj) GHC.Base.<> ("object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "credit_note_line_item")))))))))))))

instance Data.Aeson.Types.FromJSON.FromJSON CreditNoteLineItem where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "CreditNoteLineItem" (\obj -> (((((((((((GHC.Base.pure CreditNoteLineItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "discount_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "invoice_line_item")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_amounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_rates")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "unit_amount_decimal"))
...
mkCreditNoteLineItem ::
  ...
  CreditNoteLineItemType' ->
  CreditNoteLineItem
mkCreditNoteLineItem creditNoteLineItemAmount creditNoteLineItemDiscountAmount creditNoteLineItemId creditNoteLineItemLivemode creditNoteLineItemTaxAmounts creditNoteLineItemTaxRates creditNoteLineItemType =
  CreditNoteLineItem
...
instance Data.Aeson.Types.FromJSON.FromJSON CreditNoteLineItemType' where
  parseJSON val =
    GHC.Base.pure
      ( if  | val GHC.Classes.== "custom_line_item" -> CreditNoteLineItemType'EnumCustomLineItem
