...
instance Data.Aeson.Types.FromJSON.FromJSON CreditNoteLineItem where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "CreditNoteLineItem" (\obj -> ((((((((((((GHC.Base.pure CreditNoteLineItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "discount_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "invoice_line_item")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "object")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_amounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_rates")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "unit_amount_decimal"))
...
instance Data.Aeson.Types.ToJSON.ToJSON CreditNoteLineItemObject' where
  toJSON (CreditNoteLineItemObject'EnumOther patternName) = Data.Aeson.Types.ToJSON.toJSON patternName
  toJSON (CreditNoteLineItemObject'EnumTyped patternName) = Data.Aeson.Types.ToJSON.toJSON patternName
  toJSON (CreditNoteLineItemObject'EnumStringCreditNoteLineItem) = "credit_note_line_item"

instance Data.Aeson.Types.FromJSON.FromJSON CreditNoteLineItemObject' where
  parseJSON val =
    GHC.Base.pure
      ( if  | val GHC.Classes.== "credit_note_line_item" -> CreditNoteLineItemObject'EnumStringCreditNoteLineItem
            | GHC.Base.otherwise -> CreditNoteLineItemObject'EnumOther val
      )
...
instance Data.Aeson.Types.ToJSON.ToJSON CreditNoteLineItemType' where
  toJSON (CreditNoteLineItemType'EnumOther patternName) = Data.Aeson.Types.ToJSON.toJSON patternName
  toJSON (CreditNoteLineItemType'EnumTyped patternName) = Data.Aeson.Types.ToJSON.toJSON patternName
  toJSON (CreditNoteLineItemType'EnumStringCustomLineItem) = "custom_line_item"
  toJSON (CreditNoteLineItemType'EnumStringInvoiceLineItem) = "invoice_line_item"

instance Data.Aeson.Types.FromJSON.FromJSON CreditNoteLineItemType' where
  parseJSON val =
    GHC.Base.pure
      ( if  | val GHC.Classes.== "custom_line_item" -> CreditNoteLineItemType'EnumStringCustomLineItem
            | val GHC.Classes.== "invoice_line_item" -> CreditNoteLineItemType'EnumStringInvoiceLineItem
            | GHC.Base.otherwise -> CreditNoteLineItemType'EnumOther val
      )
