...
data InvoiceTransferData = InvoiceTransferData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceTransferData
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (invoiceTransferDataAmount obj) : ["destination" Data.Aeson.Types.ToJSON..= invoiceTransferDataDestination obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoiceTransferData
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoiceTransferData" (\obj -> (GHC.Base.pure InvoiceTransferData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "destination"))
-- | Create a new 'InvoiceTransferData' with all required fields.
mkInvoiceTransferData :: InvoiceTransferDataDestination'Variants -- ^ 'invoiceTransferDataDestination'
  -> InvoiceTransferData
mkInvoiceTransferData invoiceTransferDataDestination = InvoiceTransferData{invoiceTransferDataAmount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceTransferDataDestination'Variants
    where toJSON (InvoiceTransferDataDestination'Text a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (InvoiceTransferDataDestination'Account a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON InvoiceTransferDataDestination'Variants
    where parseJSON val = case (InvoiceTransferDataDestination'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((InvoiceTransferDataDestination'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
