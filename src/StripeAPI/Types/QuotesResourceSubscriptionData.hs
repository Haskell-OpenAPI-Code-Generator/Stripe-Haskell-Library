...
data QuotesResourceSubscriptionData = QuotesResourceSubscriptionData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceSubscriptionData
...
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceSubscriptionData
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "QuotesResourceSubscriptionData" (\obj -> (GHC.Base.pure QuotesResourceSubscriptionData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "effective_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "trial_period_days"))
...
mkQuotesResourceSubscriptionData = QuotesResourceSubscriptionData{quotesResourceSubscriptionDataEffectiveDate = GHC.Maybe.Nothing,
