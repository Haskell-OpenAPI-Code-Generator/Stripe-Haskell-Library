...
data OrdersPaymentMethodOptionsAfterpayClearpay = OrdersPaymentMethodOptionsAfterpayClearpay {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON OrdersPaymentMethodOptionsAfterpayClearpay
...
instance Data.Aeson.Types.FromJSON.FromJSON OrdersPaymentMethodOptionsAfterpayClearpay
...
mkOrdersPaymentMethodOptionsAfterpayClearpay = OrdersPaymentMethodOptionsAfterpayClearpay{ordersPaymentMethodOptionsAfterpayClearpayCaptureMethod = GHC.Maybe.Nothing,
...
data OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod' =
   OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod'EnumManual -- ^ Represents the JSON value @"manual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod'
    where toJSON (OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> OrdersPaymentMethodOptionsAfterpayClearpayCaptureMethod'EnumAutomatic
...
data OrdersPaymentMethodOptionsAfterpayClearpaySetupFutureUsage' =
   OrdersPaymentMethodOptionsAfterpayClearpaySetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | OrdersPaymentMethodOptionsAfterpayClearpaySetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | OrdersPaymentMethodOptionsAfterpayClearpaySetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON OrdersPaymentMethodOptionsAfterpayClearpaySetupFutureUsage'
    where toJSON (OrdersPaymentMethodOptionsAfterpayClearpaySetupFutureUsage'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON OrdersPaymentMethodOptionsAfterpayClearpaySetupFutureUsage'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> OrdersPaymentMethodOptionsAfterpayClearpaySetupFutureUsage'EnumNone
