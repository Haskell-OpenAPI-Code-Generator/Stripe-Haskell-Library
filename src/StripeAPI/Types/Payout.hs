...
mkPayout :: GHC.Types.Int -- ^ 'payoutAmount'
  ...
  -> PayoutType' -- ^ 'payoutType'
  -> Payout
mkPayout payoutAmount payoutArrivalDate payoutAutomatic payoutCreated payoutCurrency payoutId payoutLivemode payoutMethod payoutSourceType payoutStatus payoutType = Payout{payoutAmount = payoutAmount,
