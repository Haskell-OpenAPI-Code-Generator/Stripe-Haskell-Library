...
data OrdersV2ResourceShippingCost = OrdersV2ResourceShippingCost {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON OrdersV2ResourceShippingCost
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount_subtotal" Data.Aeson.Types.ToJSON..= ordersV2ResourceShippingCostAmountSubtotal obj] : ["amount_tax" Data.Aeson.Types.ToJSON..= ordersV2ResourceShippingCostAmountTax obj] : ["amount_total" Data.Aeson.Types.ToJSON..= ordersV2ResourceShippingCostAmountTotal obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_rate" Data.Aeson.Types.ToJSON..=)) (ordersV2ResourceShippingCostShippingRate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("taxes" Data.Aeson.Types.ToJSON..=)) (ordersV2ResourceShippingCostTaxes obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON OrdersV2ResourceShippingCost
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "OrdersV2ResourceShippingCost" (\obj -> ((((GHC.Base.pure OrdersV2ResourceShippingCost GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_subtotal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "taxes"))
-- | Create a new 'OrdersV2ResourceShippingCost' with all required fields.
mkOrdersV2ResourceShippingCost :: GHC.Types.Int -- ^ 'ordersV2ResourceShippingCostAmountSubtotal'
  -> GHC.Types.Int -- ^ 'ordersV2ResourceShippingCostAmountTax'
  -> GHC.Types.Int -- ^ 'ordersV2ResourceShippingCostAmountTotal'
  -> OrdersV2ResourceShippingCost
mkOrdersV2ResourceShippingCost ordersV2ResourceShippingCostAmountSubtotal ordersV2ResourceShippingCostAmountTax ordersV2ResourceShippingCostAmountTotal = OrdersV2ResourceShippingCost{ordersV2ResourceShippingCostAmountSubtotal = ordersV2ResourceShippingCostAmountSubtotal,
...
instance Data.Aeson.Types.ToJSON.ToJSON OrdersV2ResourceShippingCostShippingRate'NonNullableVariants
    where toJSON (OrdersV2ResourceShippingCostShippingRate'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (OrdersV2ResourceShippingCostShippingRate'NonNullableShippingRate a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON OrdersV2ResourceShippingCostShippingRate'NonNullableVariants
    where parseJSON val = case (OrdersV2ResourceShippingCostShippingRate'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((OrdersV2ResourceShippingCostShippingRate'NonNullableShippingRate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
