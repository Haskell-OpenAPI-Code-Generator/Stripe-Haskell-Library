...
data PaymentSource = PaymentSource {
  ...
  -- 
  -- * Maximum length of 5000
  , paymentSourceDescription :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  ...
  -- 
  -- * Maximum length of 5000
  , paymentSourcePayment :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  -- | payment_amount: If the Alipay account object is not reusable, the exact amount that you can create a charge for.
  , paymentSourcePaymentAmount :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int))
  -- | payment_currency: If the Alipay account object is not reusable, the exact currency that you can create a charge for.
  , paymentSourcePaymentCurrency :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  ...
  , paymentSourceRecipient :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentSourceRecipient'NonNullableVariants))
  -- | redirect: 
  ...
  -- 
  -- * Maximum length of 5000
  , paymentSourceRefundAddress :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  -- | requirements: 
  ...
  , paymentSourceUsedForPayment :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Bool))
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceBusinessProfile'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceBusinessProfile'NonNullable" (\obj -> (((((((GHC.Base.pure PaymentSourceBusinessProfile'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mcc")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product_description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "support_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "support_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "support_phone")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "support_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "url"))
...
mkPaymentSourceBusinessProfile'NonNullable = PaymentSourceBusinessProfile'NonNullable{paymentSourceBusinessProfile'NonNullableMcc = GHC.Maybe.Nothing,
...
data PaymentSourceExternalAccounts'Data' = PaymentSourceExternalAccounts'Data' {
  ...
  -- | recipient: The recipient that this card belongs to. This attribute will not be in the card object if the card belongs to a customer or account instead.
  , paymentSourceExternalAccounts'Data'Recipient :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentSourceExternalAccounts'Data'Recipient'NonNullableVariants))
  -- | routing_number: The routing transit number for the bank account.
  -- 
  -- Constraints:
  -- 
...
data PaymentSourceExternalAccounts'Data'Recipient'NonNullableVariants =
   PaymentSourceExternalAccounts'Data'Recipient'NonNullableText Data.Text.Internal.Text
  | PaymentSourceExternalAccounts'Data'Recipient'NonNullableRecipient Recipient
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'Recipient'NonNullableVariants
    where toJSON (PaymentSourceExternalAccounts'Data'Recipient'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PaymentSourceExternalAccounts'Data'Recipient'NonNullableRecipient a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceExternalAccounts'Data'Recipient'NonNullableVariants
    where parseJSON val = case (PaymentSourceExternalAccounts'Data'Recipient'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentSourceExternalAccounts'Data'Recipient'NonNullableRecipient Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
data PaymentSourceRecipient'NonNullableVariants =
   PaymentSourceRecipient'NonNullableText Data.Text.Internal.Text
  | PaymentSourceRecipient'NonNullableRecipient Recipient
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceRecipient'NonNullableVariants
    where toJSON (PaymentSourceRecipient'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PaymentSourceRecipient'NonNullableRecipient a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceRecipient'NonNullableVariants
    where parseJSON val = case (PaymentSourceRecipient'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentSourceRecipient'NonNullableRecipient Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceSettings'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceSettings'NonNullable" (\obj -> ((((((((GHC.Base.pure PaymentSourceSettings'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bacs_debit_payments")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "branding")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card_issuing")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card_payments")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "dashboard")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payments")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payouts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "sepa_debit_payments")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "treasury"))
...
data PaymentSourceTransactions' = PaymentSourceTransactions' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceTransactions'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= paymentSourceTransactions'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= paymentSourceTransactions'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= paymentSourceTransactions'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= paymentSourceTransactions'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= paymentSourceTransactions'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= paymentSourceTransactions'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceTransactions'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceTransactions'" (\obj -> ((GHC.Base.pure PaymentSourceTransactions' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'PaymentSourceTransactions'' with all required fields.
mkPaymentSourceTransactions' :: [BitcoinTransaction] -- ^ 'paymentSourceTransactions'Data'
  -> GHC.Types.Bool -- ^ 'paymentSourceTransactions'HasMore'
  -> Data.Text.Internal.Text -- ^ 'paymentSourceTransactions'Url'
  -> PaymentSourceTransactions'
mkPaymentSourceTransactions' paymentSourceTransactions'Data paymentSourceTransactions'HasMore paymentSourceTransactions'Url = PaymentSourceTransactions'{paymentSourceTransactions'Data = paymentSourceTransactions'Data,
