...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentFlowsAutomaticPaymentMethodsPaymentIntent
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= paymentFlowsAutomaticPaymentMethodsPaymentIntentEnabled obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentFlowsAutomaticPaymentMethodsPaymentIntent
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentFlowsAutomaticPaymentMethodsPaymentIntent" (\obj -> GHC.Base.pure PaymentFlowsAutomaticPaymentMethodsPaymentIntent GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled"))
