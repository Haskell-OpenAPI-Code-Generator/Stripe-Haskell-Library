...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSofort where
  toJSON obj = Data.Aeson.Types.Internal.object ("bank_code" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortBankCode obj : "bank_name" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortBankName obj : "bic" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortBic obj : "country" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortCountry obj : "generated_sepa_debit" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortGeneratedSepaDebit obj : "generated_sepa_debit_mandate" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortGeneratedSepaDebitMandate obj : "iban_last4" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortIbanLast4 obj : "preferred_language" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortPreferredLanguage obj : "verified_name" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortVerifiedName obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("bank_code" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortBankCode obj) GHC.Base.<> (("bank_name" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortBankName obj) GHC.Base.<> (("bic" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortBic obj) GHC.Base.<> (("country" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortCountry obj) GHC.Base.<> (("generated_sepa_debit" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortGeneratedSepaDebit obj) GHC.Base.<> (("generated_sepa_debit_mandate" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortGeneratedSepaDebitMandate obj) GHC.Base.<> (("iban_last4" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortIbanLast4 obj) GHC.Base.<> (("preferred_language" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortPreferredLanguage obj) GHC.Base.<> ("verified_name" Data.Aeson.Types.ToJSON..= paymentMethodDetailsSofortVerifiedName obj)))))))))
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSofortGeneratedSepaDebit'Variants where
  toJSON (PaymentMethodDetailsSofortGeneratedSepaDebit'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PaymentMethodDetailsSofortGeneratedSepaDebit'PaymentMethod a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsSofortGeneratedSepaDebit'Variants where
  parseJSON val = case (PaymentMethodDetailsSofortGeneratedSepaDebit'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentMethodDetailsSofortGeneratedSepaDebit'PaymentMethod Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSofortGeneratedSepaDebitMandate'Variants where
  toJSON (PaymentMethodDetailsSofortGeneratedSepaDebitMandate'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PaymentMethodDetailsSofortGeneratedSepaDebitMandate'Mandate a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsSofortGeneratedSepaDebitMandate'Variants where
  parseJSON val = case (PaymentMethodDetailsSofortGeneratedSepaDebitMandate'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentMethodDetailsSofortGeneratedSepaDebitMandate'Mandate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
    Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
    Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSofortPreferredLanguage' where
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'Other val) = val
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'EnumDe) = "de"
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'EnumEn) = "en"
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'EnumEs) = "es"
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'EnumFr) = "fr"
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'EnumIt) = "it"
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'EnumNl) = "nl"
  toJSON (PaymentMethodDetailsSofortPreferredLanguage'EnumPl) = "pl"

instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsSofortPreferredLanguage' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "de" -> PaymentMethodDetailsSofortPreferredLanguage'EnumDe
            | val GHC.Classes.== "en" -> PaymentMethodDetailsSofortPreferredLanguage'EnumEn
            | val GHC.Classes.== "es" -> PaymentMethodDetailsSofortPreferredLanguage'EnumEs
            | val GHC.Classes.== "fr" -> PaymentMethodDetailsSofortPreferredLanguage'EnumFr
            | val GHC.Classes.== "it" -> PaymentMethodDetailsSofortPreferredLanguage'EnumIt
            | val GHC.Classes.== "nl" -> PaymentMethodDetailsSofortPreferredLanguage'EnumNl
            | val GHC.Classes.== "pl" -> PaymentMethodDetailsSofortPreferredLanguage'EnumPl
            | GHC.Base.otherwise -> PaymentMethodDetailsSofortPreferredLanguage'Other val
      )
