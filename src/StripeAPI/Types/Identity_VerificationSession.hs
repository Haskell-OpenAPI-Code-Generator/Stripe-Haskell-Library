...
mkIdentity'verificationSession :: GHC.Types.Int -- ^ 'identity'verificationSessionCreated'
  ...
  -> GelatoVerificationSessionOptions -- ^ 'identity'verificationSessionOptions'
  -> Identity'verificationSessionStatus' -- ^ 'identity'verificationSessionStatus'
  -> Identity'verificationSessionType' -- ^ 'identity'verificationSessionType'
  -> Identity'verificationSession
mkIdentity'verificationSession identity'verificationSessionCreated identity'verificationSessionId identity'verificationSessionLivemode identity'verificationSessionMetadata identity'verificationSessionOptions identity'verificationSessionStatus identity'verificationSessionType = Identity'verificationSession{identity'verificationSessionClientSecret = GHC.Maybe.Nothing,
