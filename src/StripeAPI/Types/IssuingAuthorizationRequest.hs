...
instance Data.Aeson.ToJSON IssuingAuthorizationRequest where
...
instance Data.Aeson.ToJSON IssuingAuthorizationRequestReason' where
...
instance Data.Aeson.FromJSON IssuingAuthorizationRequestReason' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "account_compliance_disabled")
          then IssuingAuthorizationRequestReason'EnumStringAccountComplianceDisabled
          else
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "account_inactive")
              then IssuingAuthorizationRequestReason'EnumStringAccountInactive
              else
                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "authentication_failed")
                  then IssuingAuthorizationRequestReason'EnumStringAuthenticationFailed
                  else
                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "authorization_controls")
                      then IssuingAuthorizationRequestReason'EnumStringAuthorizationControls
                      else
                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "card_active")
                          then IssuingAuthorizationRequestReason'EnumStringCardActive
                          else
                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "card_inactive")
                              then IssuingAuthorizationRequestReason'EnumStringCardInactive
                              else
                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "cardholder_inactive")
                                  then IssuingAuthorizationRequestReason'EnumStringCardholderInactive
                                  else
                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "cardholder_verification_required")
                                      then IssuingAuthorizationRequestReason'EnumStringCardholderVerificationRequired
                                      else
                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "insufficient_funds")
                                          then IssuingAuthorizationRequestReason'EnumStringInsufficientFunds
                                          else
                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "not_allowed")
                                              then IssuingAuthorizationRequestReason'EnumStringNotAllowed
                                              else
                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "suspected_fraud")
                                                  then IssuingAuthorizationRequestReason'EnumStringSuspectedFraud
                                                  else
                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "webhook_approved")
                                                      then IssuingAuthorizationRequestReason'EnumStringWebhookApproved
                                                      else
                                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "webhook_declined")
                                                          then IssuingAuthorizationRequestReason'EnumStringWebhookDeclined
                                                          else
                                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "webhook_timeout")
