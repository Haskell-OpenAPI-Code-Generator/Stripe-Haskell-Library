...
instance Data.Aeson.Types.FromJSON.FromJSON OrdersV2ResourceTotalDetails
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "OrdersV2ResourceTotalDetails" (\obj -> (((GHC.Base.pure OrdersV2ResourceTotalDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_shipping")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "breakdown"))
-- | Create a new 'OrdersV2ResourceTotalDetails' with all required fields.
mkOrdersV2ResourceTotalDetails :: GHC.Types.Int -- ^ 'ordersV2ResourceTotalDetailsAmountDiscount'
  -> GHC.Types.Int -- ^ 'ordersV2ResourceTotalDetailsAmountTax'
  -> OrdersV2ResourceTotalDetails
mkOrdersV2ResourceTotalDetails ordersV2ResourceTotalDetailsAmountDiscount ordersV2ResourceTotalDetailsAmountTax = OrdersV2ResourceTotalDetails{ordersV2ResourceTotalDetailsAmountDiscount = ordersV2ResourceTotalDetailsAmountDiscount,
