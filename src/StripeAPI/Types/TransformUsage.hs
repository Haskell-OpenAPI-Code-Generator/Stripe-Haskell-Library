...
instance Data.Aeson.ToJSON TransformUsage where
...
instance Data.Aeson.ToJSON TransformUsageRound' where
...
instance Data.Aeson.FromJSON TransformUsageRound' where
  parseJSON val =
    GHC.Base.pure
