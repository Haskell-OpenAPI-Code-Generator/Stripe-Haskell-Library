...
instance Data.Aeson.Types.FromJSON.FromJSON Terminal'readerAction'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "Terminal'readerAction'NonNullable" (\obj -> ((((((GHC.Base.pure Terminal'readerAction'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "failure_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "failure_message")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "process_payment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "process_setup_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "set_reader_display")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))
...
mkTerminal'readerAction'NonNullable = Terminal'readerAction'NonNullable{terminal'readerAction'NonNullableFailureCode = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON Terminal'readerAction'NonNullableType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "process_payment_intent" -> Terminal'readerAction'NonNullableType'EnumProcessPaymentIntent
