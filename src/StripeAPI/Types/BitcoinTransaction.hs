...
instance Data.Aeson.Types.FromJSON.FromJSON BitcoinTransaction
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "BitcoinTransaction" (\obj -> (((((GHC.Base.pure BitcoinTransaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bitcoin_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "receiver"))
-- | Create a new 'BitcoinTransaction' with all required fields.
mkBitcoinTransaction :: GHC.Types.Int -- ^ 'bitcoinTransactionAmount'
  -> GHC.Types.Int -- ^ 'bitcoinTransactionBitcoinAmount'
  -> GHC.Types.Int -- ^ 'bitcoinTransactionCreated'
  -> Data.Text.Internal.Text -- ^ 'bitcoinTransactionCurrency'
  -> Data.Text.Internal.Text -- ^ 'bitcoinTransactionId'
  -> Data.Text.Internal.Text -- ^ 'bitcoinTransactionReceiver'
  -> BitcoinTransaction
mkBitcoinTransaction bitcoinTransactionAmount bitcoinTransactionBitcoinAmount bitcoinTransactionCreated bitcoinTransactionCurrency bitcoinTransactionId bitcoinTransactionReceiver = BitcoinTransaction{bitcoinTransactionAmount = bitcoinTransactionAmount,
