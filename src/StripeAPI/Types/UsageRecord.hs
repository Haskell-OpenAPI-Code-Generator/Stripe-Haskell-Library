...
instance Data.Aeson.ToJSON UsageRecord where
...
instance Data.Aeson.ToJSON UsageRecordObject' where
...
instance Data.Aeson.FromJSON UsageRecordObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "usage_record")
