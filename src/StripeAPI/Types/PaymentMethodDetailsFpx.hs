...
instance Data.Aeson.ToJSON PaymentMethodDetailsFpx where
...
instance Data.Aeson.ToJSON PaymentMethodDetailsFpxBank' where
...
instance Data.Aeson.FromJSON PaymentMethodDetailsFpxBank' where
  parseJSON val =
    GHC.Base.pure
