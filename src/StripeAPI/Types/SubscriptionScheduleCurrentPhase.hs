...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleCurrentPhase where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "end_date" (subscriptionScheduleCurrentPhaseEndDate obj) : (Data.Aeson..=) "start_date" (subscriptionScheduleCurrentPhaseStartDate obj) : [])
