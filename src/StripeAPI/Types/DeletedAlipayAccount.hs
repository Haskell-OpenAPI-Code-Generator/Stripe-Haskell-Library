...
data DeletedAlipayAccount = DeletedAlipayAccount {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeletedAlipayAccount
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["id" Data.Aeson.Types.ToJSON..= deletedAlipayAccountId obj] : ["deleted" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.Bool GHC.Types.True] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "alipay_account"] : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["id" Data.Aeson.Types.ToJSON..= deletedAlipayAccountId obj] : ["deleted" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.Bool GHC.Types.True] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "alipay_account"] : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON DeletedAlipayAccount
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "DeletedAlipayAccount" (\obj -> GHC.Base.pure DeletedAlipayAccount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id"))
-- | Create a new 'DeletedAlipayAccount' with all required fields.
mkDeletedAlipayAccount :: Data.Text.Internal.Text -- ^ 'deletedAlipayAccountId'
