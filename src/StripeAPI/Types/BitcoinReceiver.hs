...
data BitcoinReceiver = BitcoinReceiver {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BitcoinReceiver
...
instance Data.Aeson.Types.FromJSON.FromJSON BitcoinReceiver
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "BitcoinReceiver" (\obj -> ((((((((((((((((((((GHC.Base.pure BitcoinReceiver GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "active")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_received")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bitcoin_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bitcoin_amount_received")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bitcoin_uri")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "filled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "inbound_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refund_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transactions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "uncaptured_funds")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "used_for_payment"))
-- | Create a new 'BitcoinReceiver' with all required fields.
mkBitcoinReceiver :: GHC.Types.Bool -- ^ 'bitcoinReceiverActive'
  -> GHC.Types.Int -- ^ 'bitcoinReceiverAmount'
  -> GHC.Types.Int -- ^ 'bitcoinReceiverAmountReceived'
  -> GHC.Types.Int -- ^ 'bitcoinReceiverBitcoinAmount'
  -> GHC.Types.Int -- ^ 'bitcoinReceiverBitcoinAmountReceived'
  -> Data.Text.Internal.Text -- ^ 'bitcoinReceiverBitcoinUri'
  -> GHC.Types.Int -- ^ 'bitcoinReceiverCreated'
  -> Data.Text.Internal.Text -- ^ 'bitcoinReceiverCurrency'
  -> GHC.Types.Bool -- ^ 'bitcoinReceiverFilled'
  -> Data.Text.Internal.Text -- ^ 'bitcoinReceiverId'
  -> Data.Text.Internal.Text -- ^ 'bitcoinReceiverInboundAddress'
  -> GHC.Types.Bool -- ^ 'bitcoinReceiverLivemode'
  -> GHC.Types.Bool -- ^ 'bitcoinReceiverUncapturedFunds'
  -> BitcoinReceiver
mkBitcoinReceiver bitcoinReceiverActive bitcoinReceiverAmount bitcoinReceiverAmountReceived bitcoinReceiverBitcoinAmount bitcoinReceiverBitcoinAmountReceived bitcoinReceiverBitcoinUri bitcoinReceiverCreated bitcoinReceiverCurrency bitcoinReceiverFilled bitcoinReceiverId bitcoinReceiverInboundAddress bitcoinReceiverLivemode bitcoinReceiverUncapturedFunds = BitcoinReceiver{bitcoinReceiverActive = bitcoinReceiverActive,
...
data BitcoinReceiverTransactions' = BitcoinReceiverTransactions' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BitcoinReceiverTransactions'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= bitcoinReceiverTransactions'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= bitcoinReceiverTransactions'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= bitcoinReceiverTransactions'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON BitcoinReceiverTransactions'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "BitcoinReceiverTransactions'" (\obj -> ((GHC.Base.pure BitcoinReceiverTransactions' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'BitcoinReceiverTransactions'' with all required fields.
mkBitcoinReceiverTransactions' :: [BitcoinTransaction] -- ^ 'bitcoinReceiverTransactions'Data'
  -> GHC.Types.Bool -- ^ 'bitcoinReceiverTransactions'HasMore'
  -> Data.Text.Internal.Text -- ^ 'bitcoinReceiverTransactions'Url'
  -> BitcoinReceiverTransactions'
mkBitcoinReceiverTransactions' bitcoinReceiverTransactions'Data bitcoinReceiverTransactions'HasMore bitcoinReceiverTransactions'Url = BitcoinReceiverTransactions'{bitcoinReceiverTransactions'Data = bitcoinReceiverTransactions'Data,
