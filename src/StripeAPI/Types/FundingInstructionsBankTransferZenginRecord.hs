...
mkFundingInstructionsBankTransferZenginRecord = FundingInstructionsBankTransferZenginRecord{fundingInstructionsBankTransferZenginRecordAccountHolderName = GHC.Maybe.Nothing,
