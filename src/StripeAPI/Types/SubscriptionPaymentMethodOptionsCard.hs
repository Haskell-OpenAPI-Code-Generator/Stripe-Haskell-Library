...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionPaymentMethodOptionsCard
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionPaymentMethodOptionsCard" (\obj -> (GHC.Base.pure SubscriptionPaymentMethodOptionsCard GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "request_three_d_secure"))
