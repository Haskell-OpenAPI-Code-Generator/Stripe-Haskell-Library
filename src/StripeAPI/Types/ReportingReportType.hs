...
instance Data.Aeson.ToJSON Reporting'reportType where
...
instance Data.Aeson.ToJSON Reporting'reportTypeObject' where
...
instance Data.Aeson.FromJSON Reporting'reportTypeObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "reporting.report_type")
