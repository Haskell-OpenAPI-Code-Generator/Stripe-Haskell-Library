...
mkPaymentMethodDetailsCardPresent paymentMethodDetailsCardPresentExpMonth paymentMethodDetailsCardPresentExpYear = PaymentMethodDetailsCardPresent{paymentMethodDetailsCardPresentAmountAuthorized = GHC.Maybe.Nothing,
