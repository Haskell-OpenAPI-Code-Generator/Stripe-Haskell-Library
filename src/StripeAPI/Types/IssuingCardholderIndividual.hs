...
mkIssuingCardholderIndividual :: Data.Text.Internal.Text -- ^ 'issuingCardholderIndividualFirstName'
  -> Data.Text.Internal.Text -- ^ 'issuingCardholderIndividualLastName'
  -> IssuingCardholderIndividual
mkIssuingCardholderIndividual issuingCardholderIndividualFirstName issuingCardholderIndividualLastName = IssuingCardholderIndividual{issuingCardholderIndividualDob = GHC.Maybe.Nothing,
