...
instance Data.Aeson.ToJSON Terminal'reader where
...
instance Data.Aeson.ToJSON Terminal'readerDeviceType' where
...
instance Data.Aeson.FromJSON Terminal'readerDeviceType' where
  parseJSON val =
    GHC.Base.pure
...
instance Data.Aeson.ToJSON Terminal'readerObject' where
...
instance Data.Aeson.FromJSON Terminal'readerObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "terminal.reader")
