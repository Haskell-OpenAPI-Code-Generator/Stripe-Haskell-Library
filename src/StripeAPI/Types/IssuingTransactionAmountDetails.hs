...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingTransactionAmountDetails
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("atm_fee" Data.Aeson.Types.ToJSON..=)) (issuingTransactionAmountDetailsAtmFee obj) : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("atm_fee" Data.Aeson.Types.ToJSON..=)) (issuingTransactionAmountDetailsAtmFee obj) : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON IssuingTransactionAmountDetails
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingTransactionAmountDetails" (\obj -> GHC.Base.pure IssuingTransactionAmountDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "atm_fee"))
