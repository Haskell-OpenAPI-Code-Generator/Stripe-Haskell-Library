...
instance Data.Aeson.Types.ToJSON.ToJSON ScheduledQueryRunFile'NonNullable where
...
instance Data.Aeson.Types.FromJSON.FromJSON ScheduledQueryRunFile'NonNullable where
...
mkScheduledQueryRunFile'NonNullable =
  ScheduledQueryRunFile'NonNullable
    { scheduledQueryRunFile'NonNullableCreated = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON ScheduledQueryRunFile'NonNullableLinks'NonNullable where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= scheduledQueryRunFile'NonNullableLinks'NonNullableData obj] : ["has_more" Data.Aeson.Types.ToJSON..= scheduledQueryRunFile'NonNullableLinks'NonNullableHasMore obj] : ["url" Data.Aeson.Types.ToJSON..= scheduledQueryRunFile'NonNullableLinks'NonNullableUrl obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON ScheduledQueryRunFile'NonNullableLinks'NonNullable where
...
mkScheduledQueryRunFile'NonNullableLinks'NonNullable ::
  -- | 'scheduledQueryRunFile'NonNullableLinks'NonNullableData'
  [FileLink] ->
  -- | 'scheduledQueryRunFile'NonNullableLinks'NonNullableHasMore'
  GHC.Types.Bool ->
  -- | 'scheduledQueryRunFile'NonNullableLinks'NonNullableUrl'
  Data.Text.Internal.Text ->
  ScheduledQueryRunFile'NonNullableLinks'NonNullable
mkScheduledQueryRunFile'NonNullableLinks'NonNullable scheduledQueryRunFile'NonNullableLinks'NonNullableData scheduledQueryRunFile'NonNullableLinks'NonNullableHasMore scheduledQueryRunFile'NonNullableLinks'NonNullableUrl =
  ScheduledQueryRunFile'NonNullableLinks'NonNullable
    { scheduledQueryRunFile'NonNullableLinks'NonNullableData = scheduledQueryRunFile'NonNullableLinks'NonNullableData,
...
data ScheduledQueryRunFile'NonNullableObject'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    ScheduledQueryRunFile'NonNullableObject'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    ScheduledQueryRunFile'NonNullableObject'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"file"@
    ScheduledQueryRunFile'NonNullableObject'EnumFile
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON ScheduledQueryRunFile'NonNullableObject' where
  toJSON (ScheduledQueryRunFile'NonNullableObject'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON ScheduledQueryRunFile'NonNullableObject' where
  parseJSON val =
    GHC.Base.pure
      ( if
...
data ScheduledQueryRunFile'NonNullablePurpose'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    ScheduledQueryRunFile'NonNullablePurpose'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    ScheduledQueryRunFile'NonNullablePurpose'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"account_requirement"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumAccountRequirement
  | -- | Represents the JSON value @"additional_verification"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumAdditionalVerification
  | -- | Represents the JSON value @"business_icon"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumBusinessIcon
  | -- | Represents the JSON value @"business_logo"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumBusinessLogo
  | -- | Represents the JSON value @"customer_signature"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumCustomerSignature
  | -- | Represents the JSON value @"dispute_evidence"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumDisputeEvidence
  | -- | Represents the JSON value @"document_provider_identity_document"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumDocumentProviderIdentityDocument
  | -- | Represents the JSON value @"finance_report_run"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumFinanceReportRun
  | -- | Represents the JSON value @"identity_document"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumIdentityDocument
  | -- | Represents the JSON value @"identity_document_downloadable"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumIdentityDocumentDownloadable
  | -- | Represents the JSON value @"pci_document"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumPciDocument
  | -- | Represents the JSON value @"selfie"@
    ScheduledQueryRunFile'NonNullablePurpose'EnumSelfie
...
instance Data.Aeson.Types.ToJSON.ToJSON ScheduledQueryRunFile'NonNullablePurpose' where
  toJSON (ScheduledQueryRunFile'NonNullablePurpose'Other val) = val
