...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "fixed_count" -> PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumFixedCount
...
data PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullable =
  ...
  | PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumChallengeOnly -- ^ Represents the JSON value @"challenge_only"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
