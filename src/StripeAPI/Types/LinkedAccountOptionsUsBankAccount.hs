...
data LinkedAccountOptionsUsBankAccountPermissions'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    LinkedAccountOptionsUsBankAccountPermissions'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    LinkedAccountOptionsUsBankAccountPermissions'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"balances"@
    LinkedAccountOptionsUsBankAccountPermissions'EnumBalances
  | -- | Represents the JSON value @"ownership"@
    LinkedAccountOptionsUsBankAccountPermissions'EnumOwnership
  | -- | Represents the JSON value @"payment_method"@
    LinkedAccountOptionsUsBankAccountPermissions'EnumPaymentMethod
  | -- | Represents the JSON value @"transactions"@
    LinkedAccountOptionsUsBankAccountPermissions'EnumTransactions
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON LinkedAccountOptionsUsBankAccountPermissions' where
  toJSON (LinkedAccountOptionsUsBankAccountPermissions'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON LinkedAccountOptionsUsBankAccountPermissions' where
  parseJSON val =
    GHC.Base.pure
      ( if
