...
data PlatformTaxFee = PlatformTaxFee {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlatformTaxFee
...
instance Data.Aeson.Types.FromJSON.FromJSON PlatformTaxFee
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PlatformTaxFee" (\obj -> (((GHC.Base.pure PlatformTaxFee GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "source_transaction")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))
-- | Create a new 'PlatformTaxFee' with all required fields.
mkPlatformTaxFee :: Data.Text.Internal.Text -- ^ 'platformTaxFeeAccount'
  -> Data.Text.Internal.Text -- ^ 'platformTaxFeeId'
  -> Data.Text.Internal.Text -- ^ 'platformTaxFeeSourceTransaction'
  -> Data.Text.Internal.Text -- ^ 'platformTaxFeeType'
  -> PlatformTaxFee
mkPlatformTaxFee platformTaxFeeAccount platformTaxFeeId platformTaxFeeSourceTransaction platformTaxFeeType = PlatformTaxFee{platformTaxFeeAccount = platformTaxFeeAccount,
