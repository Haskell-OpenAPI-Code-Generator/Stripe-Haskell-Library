...
instance Data.Aeson.ToJSON PlatformTaxFee where
...
instance Data.Aeson.ToJSON PlatformTaxFeeObject' where
...
instance Data.Aeson.FromJSON PlatformTaxFeeObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "platform_tax_fee")
