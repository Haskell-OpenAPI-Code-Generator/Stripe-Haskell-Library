...
data InvoicesStatusTransitions = InvoicesStatusTransitions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesStatusTransitions
...
mkInvoicesStatusTransitions = InvoicesStatusTransitions{invoicesStatusTransitionsFinalizedAt = GHC.Maybe.Nothing,
