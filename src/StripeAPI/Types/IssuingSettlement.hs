...
instance Data.Aeson.ToJSON Issuing'settlement where
...
instance Data.Aeson.ToJSON Issuing'settlementNetwork' where
...
instance Data.Aeson.FromJSON Issuing'settlementNetwork' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "visa")
...
instance Data.Aeson.ToJSON Issuing'settlementObject' where
...
instance Data.Aeson.FromJSON Issuing'settlementObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "issuing.settlement")
