...
instance Data.Aeson.Types.FromJSON.FromJSON PriceRecurring'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PriceRecurring'NonNullable" (\obj -> (((GHC.Base.pure PriceRecurring'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "aggregate_usage")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "usage_type"))
-- | Create a new 'PriceRecurring'NonNullable' with all required fields.
mkPriceRecurring'NonNullable :: PriceRecurring'NonNullable
mkPriceRecurring'NonNullable = PriceRecurring'NonNullable{priceRecurring'NonNullableAggregateUsage = GHC.Maybe.Nothing,
...
data PriceRecurring'NonNullableAggregateUsage'NonNullable =
   PriceRecurring'NonNullableAggregateUsage'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PriceRecurring'NonNullableAggregateUsage'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PriceRecurring'NonNullableAggregateUsage'NonNullableEnumLastDuringPeriod -- ^ Represents the JSON value @"last_during_period"@
  | PriceRecurring'NonNullableAggregateUsage'NonNullableEnumLastEver -- ^ Represents the JSON value @"last_ever"@
  | PriceRecurring'NonNullableAggregateUsage'NonNullableEnumMax -- ^ Represents the JSON value @"max"@
  | PriceRecurring'NonNullableAggregateUsage'NonNullableEnumSum -- ^ Represents the JSON value @"sum"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceRecurring'NonNullableAggregateUsage'NonNullable
    where toJSON (PriceRecurring'NonNullableAggregateUsage'NonNullableOther val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceRecurring'NonNullableAggregateUsage'NonNullable
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "last_during_period" -> PriceRecurring'NonNullableAggregateUsage'NonNullableEnumLastDuringPeriod
