...
instance Data.Aeson.ToJSON CountrySpec where
...
instance Data.Aeson.ToJSON CountrySpecObject' where
...
instance Data.Aeson.FromJSON CountrySpecObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "country_spec")
