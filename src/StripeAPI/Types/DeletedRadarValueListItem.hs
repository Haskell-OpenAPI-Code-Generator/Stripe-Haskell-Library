...
instance Data.Aeson.ToJSON DeletedRadar'valueListItem where
...
instance Data.Aeson.ToJSON DeletedRadar'valueListItemDeleted' where
...
instance Data.Aeson.FromJSON DeletedRadar'valueListItemDeleted' where
  parseJSON val =
    GHC.Base.pure
...
instance Data.Aeson.ToJSON DeletedRadar'valueListItemObject' where
...
instance Data.Aeson.FromJSON DeletedRadar'valueListItemObject' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "radar.value_list_item")
