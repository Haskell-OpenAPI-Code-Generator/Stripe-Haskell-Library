...
-- | Contains the types generated from the schema PaymentMethodDetailsStripeAccount
...
-- | Defines the data type for the schema payment_method_details_stripe_account
-- 
-- 
data PaymentMethodDetailsStripeAccount = PaymentMethodDetailsStripeAccount {
