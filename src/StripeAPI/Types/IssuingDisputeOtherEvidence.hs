...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeOtherEvidence where
  toJSON obj = Data.Aeson.Types.Internal.object ("additional_documentation" Data.Aeson.Types.ToJSON..= issuingDisputeOtherEvidenceAdditionalDocumentation obj : "explanation" Data.Aeson.Types.ToJSON..= issuingDisputeOtherEvidenceExplanation obj : "product_description" Data.Aeson.Types.ToJSON..= issuingDisputeOtherEvidenceProductDescription obj : "product_type" Data.Aeson.Types.ToJSON..= issuingDisputeOtherEvidenceProductType obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("additional_documentation" Data.Aeson.Types.ToJSON..= issuingDisputeOtherEvidenceAdditionalDocumentation obj) GHC.Base.<> (("explanation" Data.Aeson.Types.ToJSON..= issuingDisputeOtherEvidenceExplanation obj) GHC.Base.<> (("product_description" Data.Aeson.Types.ToJSON..= issuingDisputeOtherEvidenceProductDescription obj) GHC.Base.<> ("product_type" Data.Aeson.Types.ToJSON..= issuingDisputeOtherEvidenceProductType obj))))
...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeOtherEvidenceAdditionalDocumentation'Variants where
  toJSON (IssuingDisputeOtherEvidenceAdditionalDocumentation'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (IssuingDisputeOtherEvidenceAdditionalDocumentation'File a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeOtherEvidenceAdditionalDocumentation'Variants where
  parseJSON val = case (IssuingDisputeOtherEvidenceAdditionalDocumentation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((IssuingDisputeOtherEvidenceAdditionalDocumentation'File Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeOtherEvidenceProductType' where
  toJSON (IssuingDisputeOtherEvidenceProductType'Other val) = val
  toJSON (IssuingDisputeOtherEvidenceProductType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (IssuingDisputeOtherEvidenceProductType'EnumMerchandise) = "merchandise"
  toJSON (IssuingDisputeOtherEvidenceProductType'EnumService) = "service"

instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeOtherEvidenceProductType' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "merchandise" -> IssuingDisputeOtherEvidenceProductType'EnumMerchandise
            | val GHC.Classes.== "service" -> IssuingDisputeOtherEvidenceProductType'EnumService
            | GHC.Base.otherwise -> IssuingDisputeOtherEvidenceProductType'Other val
      )
