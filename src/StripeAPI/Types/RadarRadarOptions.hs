...
instance Data.Aeson.Types.ToJSON.ToJSON RadarRadarOptions where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("session" Data.Aeson.Types.ToJSON..=)) (radarRadarOptionsSession obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON RadarRadarOptions where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "RadarRadarOptions" (\obj -> GHC.Base.pure RadarRadarOptions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "session"))
