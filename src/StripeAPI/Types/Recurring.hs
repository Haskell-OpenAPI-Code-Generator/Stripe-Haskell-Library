...
data RecurringAggregateUsage'NonNullable
  ...
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    RecurringAggregateUsage'NonNullableTyped Data.Text.Internal.Text
  | -- | Represents the JSON value @"last_during_period"@
    RecurringAggregateUsage'NonNullableEnumLastDuringPeriod
  | -- | Represents the JSON value @"last_ever"@
    RecurringAggregateUsage'NonNullableEnumLastEver
  | -- | Represents the JSON value @"max"@
    RecurringAggregateUsage'NonNullableEnumMax
  | -- | Represents the JSON value @"sum"@
    RecurringAggregateUsage'NonNullableEnumSum
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON RecurringAggregateUsage'NonNullable where
  toJSON (RecurringAggregateUsage'NonNullableOther val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON RecurringAggregateUsage'NonNullable where
  parseJSON val =
    GHC.Base.pure
      ( if
