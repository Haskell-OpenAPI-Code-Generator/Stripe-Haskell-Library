...
instance Data.Aeson.Types.ToJSON.ToJSON Recurring where
  toJSON obj = Data.Aeson.Types.Internal.object ("aggregate_usage" Data.Aeson.Types.ToJSON..= recurringAggregateUsage obj : "interval" Data.Aeson.Types.ToJSON..= recurringInterval obj : "interval_count" Data.Aeson.Types.ToJSON..= recurringIntervalCount obj : "usage_type" Data.Aeson.Types.ToJSON..= recurringUsageType obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("aggregate_usage" Data.Aeson.Types.ToJSON..= recurringAggregateUsage obj) GHC.Base.<> (("interval" Data.Aeson.Types.ToJSON..= recurringInterval obj) GHC.Base.<> (("interval_count" Data.Aeson.Types.ToJSON..= recurringIntervalCount obj) GHC.Base.<> ("usage_type" Data.Aeson.Types.ToJSON..= recurringUsageType obj))))

instance Data.Aeson.Types.FromJSON.FromJSON Recurring where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "Recurring" (\obj -> (((GHC.Base.pure Recurring GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "aggregate_usage")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "usage_type"))
...
mkRecurring recurringInterval recurringIntervalCount recurringUsageType =
  Recurring
    { recurringAggregateUsage = GHC.Maybe.Nothing,
      recurringInterval = recurringInterval,
...
instance Data.Aeson.Types.ToJSON.ToJSON RecurringAggregateUsage' where
  toJSON (RecurringAggregateUsage'Other val) = val
  toJSON (RecurringAggregateUsage'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (RecurringAggregateUsage'EnumLastDuringPeriod) = "last_during_period"
  toJSON (RecurringAggregateUsage'EnumLastEver) = "last_ever"
  toJSON (RecurringAggregateUsage'EnumMax) = "max"
  toJSON (RecurringAggregateUsage'EnumSum) = "sum"

instance Data.Aeson.Types.FromJSON.FromJSON RecurringAggregateUsage' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "last_during_period" -> RecurringAggregateUsage'EnumLastDuringPeriod
            | val GHC.Classes.== "last_ever" -> RecurringAggregateUsage'EnumLastEver
            | val GHC.Classes.== "max" -> RecurringAggregateUsage'EnumMax
            | val GHC.Classes.== "sum" -> RecurringAggregateUsage'EnumSum
            | GHC.Base.otherwise -> RecurringAggregateUsage'Other val
      )
