...
instance Data.Aeson.ToJSON IssuingCardholderRequirements where
...
instance Data.Aeson.ToJSON IssuingCardholderRequirementsDisabledReason' where
...
instance Data.Aeson.FromJSON IssuingCardholderRequirementsDisabledReason' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "listed")
          then IssuingCardholderRequirementsDisabledReason'EnumStringListed
          else
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "rejected.listed")
...
instance Data.Aeson.ToJSON IssuingCardholderRequirementsPastDue' where
...
instance Data.Aeson.FromJSON IssuingCardholderRequirementsPastDue' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "individual.dob.day")
          then IssuingCardholderRequirementsPastDue'EnumStringIndividual'dob'day
          else
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "individual.dob.month")
              then IssuingCardholderRequirementsPastDue'EnumStringIndividual'dob'month
              else
                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "individual.dob.year")
                  then IssuingCardholderRequirementsPastDue'EnumStringIndividual'dob'year
                  else
                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "individual.first_name")
                      then IssuingCardholderRequirementsPastDue'EnumStringIndividual'firstName
                      else
                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "individual.last_name")
                          then IssuingCardholderRequirementsPastDue'EnumStringIndividual'lastName
                          else
                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "individual.verification.document")
