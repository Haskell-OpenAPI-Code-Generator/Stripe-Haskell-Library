...
instance Data.Aeson.Types.FromJSON.FromJSON AccountRequirementsErrorCode'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "invalid_address_city_state_postal_code" -> AccountRequirementsErrorCode'EnumInvalidAddressCityStatePostalCode
