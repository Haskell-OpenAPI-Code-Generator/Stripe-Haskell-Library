...
instance Data.Aeson.ToJSON AccountRequirementsError where
...
instance Data.Aeson.ToJSON AccountRequirementsErrorCode' where
...
instance Data.Aeson.FromJSON AccountRequirementsErrorCode' where
  parseJSON val =
    GHC.Base.pure
      ( if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "invalid_address_city_state_postal_code")
          then AccountRequirementsErrorCode'EnumStringInvalidAddressCityStatePostalCode
          else
            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "invalid_street_address")
              then AccountRequirementsErrorCode'EnumStringInvalidStreetAddress
              else
                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "invalid_value_other")
                  then AccountRequirementsErrorCode'EnumStringInvalidValueOther
                  else
                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_address_mismatch")
                      then AccountRequirementsErrorCode'EnumStringVerificationDocumentAddressMismatch
                      else
                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_address_missing")
                          then AccountRequirementsErrorCode'EnumStringVerificationDocumentAddressMissing
                          else
                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_corrupt")
                              then AccountRequirementsErrorCode'EnumStringVerificationDocumentCorrupt
                              else
                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_country_not_supported")
                                  then AccountRequirementsErrorCode'EnumStringVerificationDocumentCountryNotSupported
                                  else
                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_dob_mismatch")
                                      then AccountRequirementsErrorCode'EnumStringVerificationDocumentDobMismatch
                                      else
                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_duplicate_type")
                                          then AccountRequirementsErrorCode'EnumStringVerificationDocumentDuplicateType
                                          else
                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_expired")
                                              then AccountRequirementsErrorCode'EnumStringVerificationDocumentExpired
                                              else
                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_failed_copy")
                                                  then AccountRequirementsErrorCode'EnumStringVerificationDocumentFailedCopy
                                                  else
                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_failed_greyscale")
                                                      then AccountRequirementsErrorCode'EnumStringVerificationDocumentFailedGreyscale
                                                      else
                                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_failed_other")
                                                          then AccountRequirementsErrorCode'EnumStringVerificationDocumentFailedOther
                                                          else
                                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_failed_test_mode")
                                                              then AccountRequirementsErrorCode'EnumStringVerificationDocumentFailedTestMode
                                                              else
                                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_fraudulent")
                                                                  then AccountRequirementsErrorCode'EnumStringVerificationDocumentFraudulent
                                                                  else
                                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_id_number_mismatch")
                                                                      then AccountRequirementsErrorCode'EnumStringVerificationDocumentIdNumberMismatch
                                                                      else
                                                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_id_number_missing")
                                                                          then AccountRequirementsErrorCode'EnumStringVerificationDocumentIdNumberMissing
                                                                          else
                                                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_incomplete")
                                                                              then AccountRequirementsErrorCode'EnumStringVerificationDocumentIncomplete
                                                                              else
                                                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_invalid")
                                                                                  then AccountRequirementsErrorCode'EnumStringVerificationDocumentInvalid
                                                                                  else
                                                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_manipulated")
                                                                                      then AccountRequirementsErrorCode'EnumStringVerificationDocumentManipulated
                                                                                      else
                                                                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_missing_back")
                                                                                          then AccountRequirementsErrorCode'EnumStringVerificationDocumentMissingBack
                                                                                          else
                                                                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_missing_front")
                                                                                              then AccountRequirementsErrorCode'EnumStringVerificationDocumentMissingFront
                                                                                              else
                                                                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_name_mismatch")
                                                                                                  then AccountRequirementsErrorCode'EnumStringVerificationDocumentNameMismatch
                                                                                                  else
                                                                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_name_missing")
                                                                                                      then AccountRequirementsErrorCode'EnumStringVerificationDocumentNameMissing
                                                                                                      else
                                                                                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_nationality_mismatch")
                                                                                                          then AccountRequirementsErrorCode'EnumStringVerificationDocumentNationalityMismatch
                                                                                                          else
                                                                                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_not_readable")
                                                                                                              then AccountRequirementsErrorCode'EnumStringVerificationDocumentNotReadable
                                                                                                              else
                                                                                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_not_uploaded")
                                                                                                                  then AccountRequirementsErrorCode'EnumStringVerificationDocumentNotUploaded
                                                                                                                  else
                                                                                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_photo_mismatch")
                                                                                                                      then AccountRequirementsErrorCode'EnumStringVerificationDocumentPhotoMismatch
                                                                                                                      else
                                                                                                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_too_large")
                                                                                                                          then AccountRequirementsErrorCode'EnumStringVerificationDocumentTooLarge
                                                                                                                          else
                                                                                                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_document_type_not_supported")
                                                                                                                              then AccountRequirementsErrorCode'EnumStringVerificationDocumentTypeNotSupported
                                                                                                                              else
                                                                                                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_failed_address_match")
                                                                                                                                  then AccountRequirementsErrorCode'EnumStringVerificationFailedAddressMatch
                                                                                                                                  else
                                                                                                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_failed_business_iec_number")
                                                                                                                                      then AccountRequirementsErrorCode'EnumStringVerificationFailedBusinessIecNumber
                                                                                                                                      else
                                                                                                                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_failed_document_match")
                                                                                                                                          then AccountRequirementsErrorCode'EnumStringVerificationFailedDocumentMatch
                                                                                                                                          else
                                                                                                                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_failed_id_number_match")
                                                                                                                                              then AccountRequirementsErrorCode'EnumStringVerificationFailedIdNumberMatch
                                                                                                                                              else
                                                                                                                                                if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_failed_keyed_identity")
                                                                                                                                                  then AccountRequirementsErrorCode'EnumStringVerificationFailedKeyedIdentity
                                                                                                                                                  else
                                                                                                                                                    if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_failed_keyed_match")
                                                                                                                                                      then AccountRequirementsErrorCode'EnumStringVerificationFailedKeyedMatch
                                                                                                                                                      else
                                                                                                                                                        if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_failed_name_match")
                                                                                                                                                          then AccountRequirementsErrorCode'EnumStringVerificationFailedNameMatch
                                                                                                                                                          else
                                                                                                                                                            if val GHC.Classes.== (Data.Aeson.Types.Internal.String GHC.Base.$ Data.Text.pack "verification_failed_other")
