...
getClimateReservations ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  GetClimateReservationsParameters ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetClimateReservationsResponse)
getClimateReservations parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetClimateReservationsResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if
                                 | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetClimateReservationsResponse200
                                 ...
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetClimateReservationsResponseDefault
                                       Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                            Data.Either.Either
                                                              GHC.Base.String
                                                              Error
    ...
    ( StripeAPI.Common.doCallWithConfigurationM
        ...
        [ StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getClimateReservationsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetClimateReservationsParameters where
...
mkGetClimateReservationsParameters =
  GetClimateReservationsParameters
    { getClimateReservationsParametersQueryEndingBefore = GHC.Maybe.Nothing,
...
data GetClimateReservationsResponse
  = -- | Means either no matching case available or a parse error
    GetClimateReservationsResponseError GHC.Base.String
  | -- | Successful response.
    GetClimateReservationsResponse200 GetClimateReservationsResponseBody200
  | -- | Error response.
    GetClimateReservationsResponseDefault Error
...
instance Data.Aeson.Types.ToJSON.ToJSON GetClimateReservationsResponseBody200 where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getClimateReservationsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getClimateReservationsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getClimateReservationsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetClimateReservationsResponseBody200 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetClimateReservationsResponseBody200" (\obj -> ((GHC.Base.pure GetClimateReservationsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))

-- | Create a new 'GetClimateReservationsResponseBody200' with all required fields.
mkGetClimateReservationsResponseBody200 ::
  -- | 'getClimateReservationsResponseBody200Data'
  [Climate'order] ->
  -- | 'getClimateReservationsResponseBody200HasMore'
  GHC.Types.Bool ->
  -- | 'getClimateReservationsResponseBody200Url'
  Data.Text.Internal.Text ->
  GetClimateReservationsResponseBody200
mkGetClimateReservationsResponseBody200 getClimateReservationsResponseBody200Data getClimateReservationsResponseBody200HasMore getClimateReservationsResponseBody200Url =
  GetClimateReservationsResponseBody200
    { getClimateReservationsResponseBody200Data = getClimateReservationsResponseBody200Data,
