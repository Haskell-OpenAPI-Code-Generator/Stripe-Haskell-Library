...
postOrdersIdReturns ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response PostOrdersIdReturnsResponse)
postOrdersIdReturns
  id
  body =
    GHC.Base.fmap
...
data PostOrdersIdReturnsRequestBodyItems'OneOf2
  = PostOrdersIdReturnsRequestBodyItems'OneOf2
      { -- | amount
        postOrdersIdReturnsRequestBodyItems'OneOf2Amount :: (GHC.Maybe.Maybe GHC.Types.Int),
        -- | description
        --
        -- Constraints:
        --
        ...
        -- | quantity
        postOrdersIdReturnsRequestBodyItems'OneOf2Quantity :: (GHC.Maybe.Maybe GHC.Types.Int),
        -- | type
        --
        -- Constraints:
        --
...
instance Data.Aeson.Types.FromJSON.FromJSON PostOrdersIdReturnsRequestBodyItems'OneOf2 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostOrdersIdReturnsRequestBodyItems'OneOf2" (\obj -> ((((GHC.Base.pure PostOrdersIdReturnsRequestBodyItems'OneOf2 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "parent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "type"))
