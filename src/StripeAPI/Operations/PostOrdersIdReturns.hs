...
instance Data.Aeson.Types.ToJSON.ToJSON PostOrdersIdReturnsRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object ("expand" Data.Aeson.Types.ToJSON..= postOrdersIdReturnsRequestBodyExpand obj : "items" Data.Aeson.Types.ToJSON..= postOrdersIdReturnsRequestBodyItems obj : [])
...
instance Data.Aeson.Types.FromJSON.FromJSON PostOrdersIdReturnsRequestBodyItems'OneOf1Type' where
  parseJSON val =
    GHC.Base.pure
      ( if  | val GHC.Classes.== "discount" -> PostOrdersIdReturnsRequestBodyItems'OneOf1Type'EnumDiscount
...
instance Data.Aeson.Types.FromJSON.FromJSON PostOrdersIdReturnsRequestBodyItems'Variants where
  parseJSON val =
    if  | val GHC.Classes.== "" -> GHC.Base.pure PostOrdersIdReturnsRequestBodyItems'EmptyString
