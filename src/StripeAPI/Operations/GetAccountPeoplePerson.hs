...
getAccountPeoplePerson :: forall m . StripeAPI.Common.MonadHTTP m => GetAccountPeoplePersonParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetAccountPeoplePersonResponse) -- ^ Monadic computation which returns the result of the operation
getAccountPeoplePerson parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetAccountPeoplePersonResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetAccountPeoplePersonResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                           Person)
...
data GetAccountPeoplePersonParameters = GetAccountPeoplePersonParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAccountPeoplePersonParameters
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathPerson" Data.Aeson.Types.ToJSON..= getAccountPeoplePersonParametersPathPerson obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getAccountPeoplePersonParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetAccountPeoplePersonParameters
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountPeoplePersonParameters" (\obj -> (GHC.Base.pure GetAccountPeoplePersonParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathPerson")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))
-- | Create a new 'GetAccountPeoplePersonParameters' with all required fields.
mkGetAccountPeoplePersonParameters :: Data.Text.Internal.Text -- ^ 'getAccountPeoplePersonParametersPathPerson'
  -> GetAccountPeoplePersonParameters
mkGetAccountPeoplePersonParameters getAccountPeoplePersonParametersPathPerson = GetAccountPeoplePersonParameters{getAccountPeoplePersonParametersPathPerson = getAccountPeoplePersonParametersPathPerson,
