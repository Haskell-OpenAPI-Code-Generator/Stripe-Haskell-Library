...
getAccountPeoplePerson ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetAccountPeoplePersonResponse))
getAccountPeoplePerson
  config
  expand
  person
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/account/people/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel person)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetAccountPeoplePersonRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetAccountPeoplePersonRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountPeoplePersonRequestBody" (\obj -> GHC.Base.pure GetAccountPeoplePersonRequestBody)
