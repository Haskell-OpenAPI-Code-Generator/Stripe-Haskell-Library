...
deleteSkusId :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id | Constraints: Maximum length of 5000
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteSkusIdResponse) -- ^ Monadic computation which returns the result of the operation
deleteSkusId id = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteSkusIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteSkusIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                     DeletedSku)
