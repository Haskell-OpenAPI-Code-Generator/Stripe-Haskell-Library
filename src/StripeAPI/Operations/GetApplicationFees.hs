...
instance Data.Aeson.ToJSON GetApplicationFeesParameters where
...
instance Data.Aeson.ToJSON GetApplicationFeesParametersQueryCreated'OneOf2 where
...
instance Data.Aeson.ToJSON GetApplicationFeesParametersQueryCreated'Variants where
  toJSON = Data.Aeson.Types.ToJSON.genericToJSON Data.Aeson.Types.Internal.defaultOptions {Data.Aeson.Types.Internal.sumEncoding = Data.Aeson.Types.Internal.UntaggedValue}

instance Data.Aeson.FromJSON GetApplicationFeesParametersQueryCreated'Variants where
...
-- | > GET /v1/application_fees
--
-- The same as 'getApplicationFees' but accepts an explicit configuration.
getApplicationFeesWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetApplicationFeesParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetApplicationFeesResponse)
getApplicationFeesWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getApplicationFeesRaw parameters =
  GHC.Base.id
    ( StripeAPI.Common.doCallWithConfigurationM
        (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET")
        (Data.Text.pack "/v1/application_fees")
...
-- | > GET /v1/application_fees
--
-- The same as 'getApplicationFees' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getApplicationFeesWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
