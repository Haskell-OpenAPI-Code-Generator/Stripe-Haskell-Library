...
postReviewsReviewApprove ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostReviewsReviewApproveResponse)
postReviewsReviewApprove
  review
  body =
    GHC.Base.fmap
...
instance Data.Aeson.Types.ToJSON.ToJSON PostReviewsReviewApproveRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postReviewsReviewApproveRequestBodyExpand obj) : GHC.Base.mempty))
