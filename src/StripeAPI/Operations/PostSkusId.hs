...
postSkusId :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostSkusIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSkusIdResponse) -- ^ Monadic computation which returns the result of the operation
postSkusId id
           body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSkusIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSkusIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                 Sku)
...
data PostSkusIdRequestBody = PostSkusIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSkusIdRequestBody
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("active" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyActive obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("attributes" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyAttributes obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyExpand obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("image" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyImage obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("inventory" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyInventory obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyMetadata obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("package_dimensions" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyPackageDimensions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("price" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyPrice obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("product" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyProduct obj) : GHC.Base.mempty))
...
mkPostSkusIdRequestBody = PostSkusIdRequestBody{postSkusIdRequestBodyActive = GHC.Maybe.Nothing,
...
data PostSkusIdRequestBodyInventory' = PostSkusIdRequestBodyInventory' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSkusIdRequestBodyInventory'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("quantity" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyInventory'Quantity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyInventory'Type obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("value" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyInventory'Value obj) : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("quantity" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyInventory'Quantity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyInventory'Type obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("value" Data.Aeson.Types.ToJSON..=)) (postSkusIdRequestBodyInventory'Value obj) : GHC.Base.mempty)))
...
mkPostSkusIdRequestBodyInventory' = PostSkusIdRequestBodyInventory'{postSkusIdRequestBodyInventory'Quantity = GHC.Maybe.Nothing,
...
data PostSkusIdRequestBodyInventory'Type' =
   PostSkusIdRequestBodyInventory'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostSkusIdRequestBodyInventory'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostSkusIdRequestBodyInventory'Type'EnumBucket -- ^ Represents the JSON value @"bucket"@
  | PostSkusIdRequestBodyInventory'Type'EnumFinite -- ^ Represents the JSON value @"finite"@
  | PostSkusIdRequestBodyInventory'Type'EnumInfinite -- ^ Represents the JSON value @"infinite"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSkusIdRequestBodyInventory'Type'
    where toJSON (PostSkusIdRequestBodyInventory'Type'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostSkusIdRequestBodyInventory'Type'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bucket" -> PostSkusIdRequestBodyInventory'Type'EnumBucket
...
data PostSkusIdRequestBodyInventory'Value' =
   PostSkusIdRequestBodyInventory'Value'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostSkusIdRequestBodyInventory'Value'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostSkusIdRequestBodyInventory'Value'EnumEmptyString -- ^ Represents the JSON value @""@
  | PostSkusIdRequestBodyInventory'Value'EnumInStock -- ^ Represents the JSON value @"in_stock"@
  | PostSkusIdRequestBodyInventory'Value'EnumLimited -- ^ Represents the JSON value @"limited"@
  | PostSkusIdRequestBodyInventory'Value'EnumOutOfStock -- ^ Represents the JSON value @"out_of_stock"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSkusIdRequestBodyInventory'Value'
    where toJSON (PostSkusIdRequestBodyInventory'Value'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostSkusIdRequestBodyInventory'Value'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> PostSkusIdRequestBodyInventory'Value'EnumEmptyString
...
data PostSkusIdRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSkusIdRequestBodyMetadata'Variants
    where toJSON (PostSkusIdRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostSkusIdRequestBodyMetadata'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostSkusIdRequestBodyMetadata'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostSkusIdRequestBodyMetadata'EmptyString
...
data PostSkusIdRequestBodyPackageDimensions'OneOf1 = PostSkusIdRequestBodyPackageDimensions'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSkusIdRequestBodyPackageDimensions'OneOf1
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["height" Data.Aeson.Types.ToJSON..= postSkusIdRequestBodyPackageDimensions'OneOf1Height obj] : ["length" Data.Aeson.Types.ToJSON..= postSkusIdRequestBodyPackageDimensions'OneOf1Length obj] : ["weight" Data.Aeson.Types.ToJSON..= postSkusIdRequestBodyPackageDimensions'OneOf1Weight obj] : ["width" Data.Aeson.Types.ToJSON..= postSkusIdRequestBodyPackageDimensions'OneOf1Width obj] : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["height" Data.Aeson.Types.ToJSON..= postSkusIdRequestBodyPackageDimensions'OneOf1Height obj] : ["length" Data.Aeson.Types.ToJSON..= postSkusIdRequestBodyPackageDimensions'OneOf1Length obj] : ["weight" Data.Aeson.Types.ToJSON..= postSkusIdRequestBodyPackageDimensions'OneOf1Weight obj] : ["width" Data.Aeson.Types.ToJSON..= postSkusIdRequestBodyPackageDimensions'OneOf1Width obj] : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON PostSkusIdRequestBodyPackageDimensions'OneOf1
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostSkusIdRequestBodyPackageDimensions'OneOf1" (\obj -> (((GHC.Base.pure PostSkusIdRequestBodyPackageDimensions'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "height")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "length")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "weight")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "width"))
-- | Create a new 'PostSkusIdRequestBodyPackageDimensions'OneOf1' with all required fields.
mkPostSkusIdRequestBodyPackageDimensions'OneOf1 :: GHC.Types.Double -- ^ 'postSkusIdRequestBodyPackageDimensions'OneOf1Height'
  -> GHC.Types.Double -- ^ 'postSkusIdRequestBodyPackageDimensions'OneOf1Length'
  -> GHC.Types.Double -- ^ 'postSkusIdRequestBodyPackageDimensions'OneOf1Weight'
  -> GHC.Types.Double -- ^ 'postSkusIdRequestBodyPackageDimensions'OneOf1Width'
  -> PostSkusIdRequestBodyPackageDimensions'OneOf1
mkPostSkusIdRequestBodyPackageDimensions'OneOf1 postSkusIdRequestBodyPackageDimensions'OneOf1Height postSkusIdRequestBodyPackageDimensions'OneOf1Length postSkusIdRequestBodyPackageDimensions'OneOf1Weight postSkusIdRequestBodyPackageDimensions'OneOf1Width = PostSkusIdRequestBodyPackageDimensions'OneOf1{postSkusIdRequestBodyPackageDimensions'OneOf1Height = postSkusIdRequestBodyPackageDimensions'OneOf1Height,
...
data PostSkusIdRequestBodyPackageDimensions'Variants =
   PostSkusIdRequestBodyPackageDimensions'EmptyString -- ^ Represents the JSON value @""@
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSkusIdRequestBodyPackageDimensions'Variants
    where toJSON (PostSkusIdRequestBodyPackageDimensions'PostSkusIdRequestBodyPackageDimensions'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostSkusIdRequestBodyPackageDimensions'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostSkusIdRequestBodyPackageDimensions'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostSkusIdRequestBodyPackageDimensions'EmptyString
