...
getSigmaScheduledQueryRuns ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetSigmaScheduledQueryRunsResponse))
getSigmaScheduledQueryRuns
  config
  endingBefore
  expand
...
getSigmaScheduledQueryRunsRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetSigmaScheduledQueryRunsRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetSigmaScheduledQueryRunsRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSigmaScheduledQueryRunsRequestBody" (\obj -> GHC.Base.pure GetSigmaScheduledQueryRunsRequestBody)
