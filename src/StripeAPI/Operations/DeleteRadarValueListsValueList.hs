...
deleteRadarValueListsValueList ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response DeleteRadarValueListsValueListResponse)
deleteRadarValueListsValueList valueList =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either DeleteRadarValueListsValueListResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if  | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                   DeleteRadarValueListsValueListResponse200
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            DeletedRadar'valueList
                                                      )
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                   DeleteRadarValueListsValueListResponseDefault
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            Error
                                                      )
...
-- | > DELETE /v1/radar/value_lists/{value_list}
--
-- The same as 'deleteRadarValueListsValueList' but accepts an explicit configuration.
deleteRadarValueListsValueListWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  Data.Text.Internal.Text ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response DeleteRadarValueListsValueListResponse)
deleteRadarValueListsValueListWithConfiguration
  config
  valueList =
    GHC.Base.fmap
...
deleteRadarValueListsValueListRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | value_list | Constraints: Maximum length of 5000
  Data.Text.Internal.Text ->
...
deleteRadarValueListsValueListRaw valueList = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/v1/radar/value_lists/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel valueList)) GHC.Base.++ ""))) [])

-- | > DELETE /v1/radar/value_lists/{value_list}
--
-- The same as 'deleteRadarValueListsValueList' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
deleteRadarValueListsValueListWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
...
deleteRadarValueListsValueListWithConfigurationRaw
  config
  valueList = GHC.Base.id (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/v1/radar/value_lists/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel valueList)) GHC.Base.++ ""))) [])
