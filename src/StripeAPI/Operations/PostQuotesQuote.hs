...
postQuotesQuote ::
  ...
  GHC.Maybe.Maybe PostQuotesQuoteRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostQuotesQuoteResponse)
postQuotesQuote
  quote
  body =
    GHC.Base.fmap
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBody where
...
data PostQuotesQuoteRequestBodyApplicationFeeAmount'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyApplicationFeeAmount'EmptyString
  | PostQuotesQuoteRequestBodyApplicationFeeAmount'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyApplicationFeeAmount'Variants where
  toJSON (PostQuotesQuoteRequestBodyApplicationFeeAmount'Int a) = Data.Aeson.Types.ToJSON.toJSON a
...
data PostQuotesQuoteRequestBodyApplicationFeePercent'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyApplicationFeePercent'EmptyString
  | PostQuotesQuoteRequestBodyApplicationFeePercent'Double GHC.Types.Double
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyApplicationFeePercent'Variants where
  toJSON (PostQuotesQuoteRequestBodyApplicationFeePercent'Double a) = Data.Aeson.Types.ToJSON.toJSON a
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyAutomaticTax' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postQuotesQuoteRequestBodyAutomaticTax'Enabled obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyAutomaticTax' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyAutomaticTax'" (\obj -> GHC.Base.pure PostQuotesQuoteRequestBodyAutomaticTax' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled"))

-- | Create a new 'PostQuotesQuoteRequestBodyAutomaticTax'' with all required fields.
mkPostQuotesQuoteRequestBodyAutomaticTax' ::
  -- | 'postQuotesQuoteRequestBodyAutomaticTax'Enabled'
  GHC.Types.Bool ->
...
data PostQuotesQuoteRequestBodyCollectionMethod'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PostQuotesQuoteRequestBodyCollectionMethod'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostQuotesQuoteRequestBodyCollectionMethod'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"charge_automatically"@
    PostQuotesQuoteRequestBodyCollectionMethod'EnumChargeAutomatically
  | -- | Represents the JSON value @"send_invoice"@
    PostQuotesQuoteRequestBodyCollectionMethod'EnumSendInvoice
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyCollectionMethod' where
  toJSON (PostQuotesQuoteRequestBodyCollectionMethod'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyCollectionMethod' where
  parseJSON val =
    GHC.Base.pure
      ( if
...
data PostQuotesQuoteRequestBodyDefaultTaxRates'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyDefaultTaxRates'EmptyString
  | PostQuotesQuoteRequestBodyDefaultTaxRates'ListTText ([Data.Text.Internal.Text])
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyDefaultTaxRates'Variants where
  toJSON (PostQuotesQuoteRequestBodyDefaultTaxRates'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a
...
data PostQuotesQuoteRequestBodyDescription'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyDescription'EmptyString
  | PostQuotesQuoteRequestBodyDescription'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyDescription'Variants where
  toJSON (PostQuotesQuoteRequestBodyDescription'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesQuoteRequestBodyDescription'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyDescription'Variants where
  parseJSON val =
    if
        | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyDescription'EmptyString
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyDiscounts'OneOf1 where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyDiscounts'OneOf1 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyDiscounts'OneOf1" (\obj -> (GHC.Base.pure PostQuotesQuoteRequestBodyDiscounts'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount"))
...
mkPostQuotesQuoteRequestBodyDiscounts'OneOf1 =
  PostQuotesQuoteRequestBodyDiscounts'OneOf1
    { postQuotesQuoteRequestBodyDiscounts'OneOf1Coupon = GHC.Maybe.Nothing,
...
data PostQuotesQuoteRequestBodyDiscounts'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyDiscounts'EmptyString
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyDiscounts'Variants where
  toJSON (PostQuotesQuoteRequestBodyDiscounts'ListTPostQuotesQuoteRequestBodyDiscounts'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a
...
data PostQuotesQuoteRequestBodyFooter'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyFooter'EmptyString
  | PostQuotesQuoteRequestBodyFooter'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyFooter'Variants where
  toJSON (PostQuotesQuoteRequestBodyFooter'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesQuoteRequestBodyFooter'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyFooter'Variants where
  parseJSON val =
    if
        | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyFooter'EmptyString
...
data PostQuotesQuoteRequestBodyHeader'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyHeader'EmptyString
  | PostQuotesQuoteRequestBodyHeader'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyHeader'Variants where
  toJSON (PostQuotesQuoteRequestBodyHeader'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesQuoteRequestBodyHeader'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyHeader'Variants where
  parseJSON val =
    if
        | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyHeader'EmptyString
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyInvoiceSettings' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("days_until_due" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyInvoiceSettings'DaysUntilDue obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyInvoiceSettings' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyInvoiceSettings'" (\obj -> GHC.Base.pure PostQuotesQuoteRequestBodyInvoiceSettings' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "days_until_due"))
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyLineItems' where
...
mkPostQuotesQuoteRequestBodyLineItems' =
  PostQuotesQuoteRequestBodyLineItems'
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyLineItems'PriceData' where
...
mkPostQuotesQuoteRequestBodyLineItems'PriceData' ::
  -- | 'postQuotesQuoteRequestBodyLineItems'PriceData'Currency'
  Data.Text.Internal.Text ->
  -- | 'postQuotesQuoteRequestBodyLineItems'PriceData'Product'
  Data.Text.Internal.Text ->
  PostQuotesQuoteRequestBodyLineItems'PriceData'
mkPostQuotesQuoteRequestBodyLineItems'PriceData' postQuotesQuoteRequestBodyLineItems'PriceData'Currency postQuotesQuoteRequestBodyLineItems'PriceData'Product =
  PostQuotesQuoteRequestBodyLineItems'PriceData'
    { postQuotesQuoteRequestBodyLineItems'PriceData'Currency = postQuotesQuoteRequestBodyLineItems'PriceData'Currency,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["interval" Data.Aeson.Types.ToJSON..= postQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyLineItems'PriceData'Recurring'IntervalCount obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'" (\obj -> (GHC.Base.pure PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count"))

-- | Create a new 'PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'' with all required fields.
mkPostQuotesQuoteRequestBodyLineItems'PriceData'Recurring' ::
  -- | 'postQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'
  PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval' ->
  PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'
mkPostQuotesQuoteRequestBodyLineItems'PriceData'Recurring' postQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval =
  PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'
    { postQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval = postQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval,
...
data PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"day"@
    PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'EnumDay
  | -- | Represents the JSON value @"month"@
    PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'EnumMonth
  | -- | Represents the JSON value @"week"@
    PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'EnumWeek
  | -- | Represents the JSON value @"year"@
    PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'EnumYear
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval' where
  toJSON (PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyLineItems'PriceData'Recurring'Interval' where
  parseJSON val =
    GHC.Base.pure
      ( if
...
data PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"exclusive"@
    PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior'EnumExclusive
  | -- | Represents the JSON value @"inclusive"@
    PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior'EnumInclusive
  | -- | Represents the JSON value @"unspecified"@
    PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior'EnumUnspecified
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior' where
  toJSON (PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyLineItems'PriceData'TaxBehavior' where
  parseJSON val =
    GHC.Base.pure
      ( if
...
data PostQuotesQuoteRequestBodyLineItems'TaxRates'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyLineItems'TaxRates'EmptyString
  | PostQuotesQuoteRequestBodyLineItems'TaxRates'ListTText ([Data.Text.Internal.Text])
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyLineItems'TaxRates'Variants where
  toJSON (PostQuotesQuoteRequestBodyLineItems'TaxRates'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a
...
data PostQuotesQuoteRequestBodyOnBehalfOf'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyOnBehalfOf'EmptyString
  | PostQuotesQuoteRequestBodyOnBehalfOf'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyOnBehalfOf'Variants where
  toJSON (PostQuotesQuoteRequestBodyOnBehalfOf'Text a) = Data.Aeson.Types.ToJSON.toJSON a
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodySubscriptionData' where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodySubscriptionData' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodySubscriptionData'" (\obj -> (((GHC.Base.pure PostQuotesQuoteRequestBodySubscriptionData' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "effective_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "trial_period_days"))
...
mkPostQuotesQuoteRequestBodySubscriptionData' =
  PostQuotesQuoteRequestBodySubscriptionData'
    { postQuotesQuoteRequestBodySubscriptionData'Description = GHC.Maybe.Nothing,
...
data PostQuotesQuoteRequestBodySubscriptionData'Description'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodySubscriptionData'Description'EmptyString
  | PostQuotesQuoteRequestBodySubscriptionData'Description'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodySubscriptionData'Description'Variants where
  toJSON (PostQuotesQuoteRequestBodySubscriptionData'Description'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesQuoteRequestBodySubscriptionData'Description'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodySubscriptionData'Description'Variants where
  parseJSON val =
    if
        | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodySubscriptionData'Description'EmptyString
...
data PostQuotesQuoteRequestBodySubscriptionData'EffectiveDate'Variants
  = -- | Represents the JSON value @"current_period_end"@
    PostQuotesQuoteRequestBodySubscriptionData'EffectiveDate'CurrentPeriodEnd
  | -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodySubscriptionData'EffectiveDate'EmptyString
  | PostQuotesQuoteRequestBodySubscriptionData'EffectiveDate'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodySubscriptionData'EffectiveDate'Variants where
  toJSON (PostQuotesQuoteRequestBodySubscriptionData'EffectiveDate'Int a) = Data.Aeson.Types.ToJSON.toJSON a
...
data PostQuotesQuoteRequestBodySubscriptionData'TrialPeriodDays'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodySubscriptionData'TrialPeriodDays'EmptyString
  | PostQuotesQuoteRequestBodySubscriptionData'TrialPeriodDays'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodySubscriptionData'TrialPeriodDays'Variants where
  toJSON (PostQuotesQuoteRequestBodySubscriptionData'TrialPeriodDays'Int a) = Data.Aeson.Types.ToJSON.toJSON a
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyTransferData'OneOf1 where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyTransferData'OneOf1 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyTransferData'OneOf1" (\obj -> ((GHC.Base.pure PostQuotesQuoteRequestBodyTransferData'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_percent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "destination"))

-- | Create a new 'PostQuotesQuoteRequestBodyTransferData'OneOf1' with all required fields.
mkPostQuotesQuoteRequestBodyTransferData'OneOf1 ::
  -- | 'postQuotesQuoteRequestBodyTransferData'OneOf1Destination'
  Data.Text.Internal.Text ->
  PostQuotesQuoteRequestBodyTransferData'OneOf1
mkPostQuotesQuoteRequestBodyTransferData'OneOf1 postQuotesQuoteRequestBodyTransferData'OneOf1Destination =
  PostQuotesQuoteRequestBodyTransferData'OneOf1
    { postQuotesQuoteRequestBodyTransferData'OneOf1Amount = GHC.Maybe.Nothing,
...
data PostQuotesQuoteRequestBodyTransferData'Variants
  = -- | Represents the JSON value @""@
    PostQuotesQuoteRequestBodyTransferData'EmptyString
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyTransferData'Variants where
  toJSON (PostQuotesQuoteRequestBodyTransferData'PostQuotesQuoteRequestBodyTransferData'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a
...
data PostQuotesQuoteResponse
  = -- | Means either no matching case available or a parse error
    PostQuotesQuoteResponseError GHC.Base.String
  | -- | Successful response.
    PostQuotesQuoteResponse200 Quote
  | -- | Error response.
    PostQuotesQuoteResponseDefault Error
  deriving (GHC.Show.Show, GHC.Classes.Eq)
