...
getAccountsAccountPersons ::
  ...
  GHC.Maybe.Maybe GetAccountsAccountPersonsRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetAccountsAccountPersonsResponse))
getAccountsAccountPersons
  config
  account
  endingBefore
  ...
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/accounts/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel account)) GHC.Base.++ "/persons")))
...
instance Data.Aeson.ToJSON GetAccountsAccountPersonsRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetAccountsAccountPersonsRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountsAccountPersonsRequestBody" (\obj -> GHC.Base.pure GetAccountsAccountPersonsRequestBody)
...
instance Data.Aeson.ToJSON GetAccountsAccountPersonsResponseBody200 where
...
instance Data.Aeson.ToJSON GetAccountsAccountPersonsResponseBody200Object' where
...
instance Data.Aeson.FromJSON GetAccountsAccountPersonsResponseBody200Object' where
  parseJSON val =
    GHC.Base.pure
