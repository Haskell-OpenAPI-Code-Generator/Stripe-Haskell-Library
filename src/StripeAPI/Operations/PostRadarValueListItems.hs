...
postRadarValueListItems :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostRadarValueListItemsRequestBody
    = PostRadarValueListItemsRequestBody {postRadarValueListItemsRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
