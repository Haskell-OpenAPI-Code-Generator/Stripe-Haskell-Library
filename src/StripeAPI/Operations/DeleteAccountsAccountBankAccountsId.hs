...
instance Data.Aeson.ToJSON DeleteAccountsAccountBankAccountsIdParameters where
...
-- | > DELETE /v1/accounts/{account}/bank_accounts/{id}
--
-- The same as 'deleteAccountsAccountBankAccountsId' but accepts an explicit configuration.
deleteAccountsAccountBankAccountsIdWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  DeleteAccountsAccountBankAccountsIdParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response DeleteAccountsAccountBankAccountsIdResponse)
deleteAccountsAccountBankAccountsIdWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
deleteAccountsAccountBankAccountsIdRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/v1/accounts/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (deleteAccountsAccountBankAccountsIdParametersPathAccount parameters))) GHC.Base.++ ("/bank_accounts/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (deleteAccountsAccountBankAccountsIdParametersPathId parameters))) GHC.Base.++ ""))))) [])

-- | > DELETE /v1/accounts/{account}/bank_accounts/{id}
--
-- The same as 'deleteAccountsAccountBankAccountsId' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
deleteAccountsAccountBankAccountsIdWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
