...
postAccountBankAccountsId :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id
  -> GHC.Maybe.Maybe PostAccountBankAccountsIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostAccountBankAccountsIdResponse) -- ^ Monadic computation which returns the result of the operation
postAccountBankAccountsId id
                          body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountBankAccountsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountBankAccountsIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                              ExternalAccount)
...
data PostAccountBankAccountsIdRequestBody = PostAccountBankAccountsIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountBankAccountsIdRequestBody
...
mkPostAccountBankAccountsIdRequestBody = PostAccountBankAccountsIdRequestBody{postAccountBankAccountsIdRequestBodyAccountHolderName = GHC.Maybe.Nothing,
...
data PostAccountBankAccountsIdRequestBodyAccountHolderType' =
   PostAccountBankAccountsIdRequestBodyAccountHolderType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostAccountBankAccountsIdRequestBodyAccountHolderType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostAccountBankAccountsIdRequestBodyAccountHolderType'EnumEmptyString -- ^ Represents the JSON value @""@
  | PostAccountBankAccountsIdRequestBodyAccountHolderType'EnumCompany -- ^ Represents the JSON value @"company"@
  | PostAccountBankAccountsIdRequestBodyAccountHolderType'EnumIndividual -- ^ Represents the JSON value @"individual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountBankAccountsIdRequestBodyAccountHolderType'
    where toJSON (PostAccountBankAccountsIdRequestBodyAccountHolderType'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountBankAccountsIdRequestBodyAccountHolderType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> PostAccountBankAccountsIdRequestBodyAccountHolderType'EnumEmptyString
...
data PostAccountBankAccountsIdRequestBodyAccountType' =
   PostAccountBankAccountsIdRequestBodyAccountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostAccountBankAccountsIdRequestBodyAccountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostAccountBankAccountsIdRequestBodyAccountType'EnumChecking -- ^ Represents the JSON value @"checking"@
  | PostAccountBankAccountsIdRequestBodyAccountType'EnumFutsu -- ^ Represents the JSON value @"futsu"@
  | PostAccountBankAccountsIdRequestBodyAccountType'EnumSavings -- ^ Represents the JSON value @"savings"@
  | PostAccountBankAccountsIdRequestBodyAccountType'EnumToza -- ^ Represents the JSON value @"toza"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountBankAccountsIdRequestBodyAccountType'
    where toJSON (PostAccountBankAccountsIdRequestBodyAccountType'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountBankAccountsIdRequestBodyAccountType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "checking" -> PostAccountBankAccountsIdRequestBodyAccountType'EnumChecking
...
data PostAccountBankAccountsIdRequestBodyMetadata'Variants =
   PostAccountBankAccountsIdRequestBodyMetadata'EmptyString -- ^ Represents the JSON value @""@
  | PostAccountBankAccountsIdRequestBodyMetadata'Object Data.Aeson.Types.Internal.Object
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountBankAccountsIdRequestBodyMetadata'Variants
    where toJSON (PostAccountBankAccountsIdRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostAccountBankAccountsIdRequestBodyMetadata'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountBankAccountsIdRequestBodyMetadata'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostAccountBankAccountsIdRequestBodyMetadata'EmptyString
