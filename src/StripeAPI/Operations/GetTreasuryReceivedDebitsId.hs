...
getTreasuryReceivedDebitsId ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTreasuryReceivedDebitsIdResponse)
getTreasuryReceivedDebitsId parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetTreasuryReceivedDebitsIdResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if
                                 | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetTreasuryReceivedDebitsIdResponse200
                                 ...
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetTreasuryReceivedDebitsIdResponseDefault
                                       Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                            Data.Either.Either
                                                              GHC.Base.String
                                                              Error
...
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryReceivedDebitsIdParameters where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathId" Data.Aeson.Types.ToJSON..= getTreasuryReceivedDebitsIdParametersPathId obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getTreasuryReceivedDebitsIdParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryReceivedDebitsIdParameters where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTreasuryReceivedDebitsIdParameters" (\obj -> (GHC.Base.pure GetTreasuryReceivedDebitsIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))

-- | Create a new 'GetTreasuryReceivedDebitsIdParameters' with all required fields.
mkGetTreasuryReceivedDebitsIdParameters ::
  -- | 'getTreasuryReceivedDebitsIdParametersPathId'
  Data.Text.Internal.Text ->
  GetTreasuryReceivedDebitsIdParameters
mkGetTreasuryReceivedDebitsIdParameters getTreasuryReceivedDebitsIdParametersPathId =
  GetTreasuryReceivedDebitsIdParameters
    { getTreasuryReceivedDebitsIdParametersPathId = getTreasuryReceivedDebitsIdParametersPathId,
...
data GetTreasuryReceivedDebitsIdResponse
  = -- | Means either no matching case available or a parse error
    GetTreasuryReceivedDebitsIdResponseError GHC.Base.String
  | -- | Successful response.
    GetTreasuryReceivedDebitsIdResponse200 Treasury'receivedDebit
  | -- | Error response.
    GetTreasuryReceivedDebitsIdResponseDefault Error
