...
instance Data.Aeson.Types.ToJSON.ToJSON GetAccountsParameters where
  toJSON obj = Data.Aeson.Types.Internal.object ("queryCreated" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated obj : "queryEnding_before" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryEndingBefore obj : "queryExpand" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryExpand obj : "queryLimit" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryLimit obj : "queryStarting_after" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryStartingAfter obj : [])
...
instance Data.Aeson.Types.ToJSON.ToJSON GetAccountsParametersQueryCreated'OneOf2 where
  toJSON obj = Data.Aeson.Types.Internal.object ("gt" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated'OneOf2Gt obj : "gte" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated'OneOf2Gte obj : "lt" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated'OneOf2Lt obj : "lte" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated'OneOf2Lte obj : [])
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("gt" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated'OneOf2Gt obj) GHC.Base.<> (("gte" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated'OneOf2Gte obj) GHC.Base.<> (("lt" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated'OneOf2Lt obj) GHC.Base.<> ("lte" Data.Aeson.Types.ToJSON..= getAccountsParametersQueryCreated'OneOf2Lte obj))))
...
-- | Create a new 'GetAccountsParametersQueryCreated'OneOf2' with all required fields.
mkGetAccountsParametersQueryCreated'OneOf2 :: GetAccountsParametersQueryCreated'OneOf2
mkGetAccountsParametersQueryCreated'OneOf2 =
  GetAccountsParametersQueryCreated'OneOf2
    { getAccountsParametersQueryCreated'OneOf2Gt = GHC.Maybe.Nothing,
      getAccountsParametersQueryCreated'OneOf2Gte = GHC.Maybe.Nothing,
      getAccountsParametersQueryCreated'OneOf2Lt = GHC.Maybe.Nothing,
      getAccountsParametersQueryCreated'OneOf2Lte = GHC.Maybe.Nothing
    }
...
instance Data.Aeson.Types.ToJSON.ToJSON GetAccountsParametersQueryCreated'Variants where
  ...
  toJSON (GetAccountsParametersQueryCreated'GetAccountsParametersQueryCreated'OneOf2 a) = Data.Aeson.Types.ToJSON.toJSON a

instance Data.Aeson.Types.FromJSON.FromJSON GetAccountsParametersQueryCreated'Variants where
  parseJSON val = case (GetAccountsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetAccountsParametersQueryCreated'GetAccountsParametersQueryCreated'OneOf2 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
