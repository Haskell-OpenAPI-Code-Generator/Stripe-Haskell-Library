...
getAccountsAccount ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetAccountsAccountResponse)
...
-- | Defines the data type for the schema getAccountsAccountParameters
data GetAccountsAccountParameters
  = GetAccountsAccountParameters
...
instance Data.Aeson.ToJSON GetAccountsAccountParameters where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "pathAccount" (getAccountsAccountParametersPathAccount obj) : (Data.Aeson..=) "queryExpand" (getAccountsAccountParametersQueryExpand obj) : [])
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "pathAccount" (getAccountsAccountParametersPathAccount obj) GHC.Base.<> (Data.Aeson..=) "queryExpand" (getAccountsAccountParametersQueryExpand obj))
...
-- | > GET /v1/accounts/{account}
--
-- The same as 'getAccountsAccount' but accepts an explicit configuration.
getAccountsAccountWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetAccountsAccountParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetAccountsAccountResponse)
getAccountsAccountWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getAccountsAccountRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/accounts/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getAccountsAccountParametersPathAccount parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getAccountsAccountParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/accounts/{account}
--
-- The same as 'getAccountsAccount' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getAccountsAccountWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
