...
instance Data.Aeson.ToJSON GetReportingReportRunsReportRunParameters where
...
-- | > GET /v1/reporting/report_runs/{report_run}
--
-- The same as 'getReportingReportRunsReportRun' but accepts an explicit configuration.
getReportingReportRunsReportRunWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetReportingReportRunsReportRunParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetReportingReportRunsReportRunResponse)
getReportingReportRunsReportRunWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/reporting/report_runs/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getReportingReportRunsReportRunParametersPathReportRun parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getReportingReportRunsReportRunParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/reporting/report_runs/{report_run}
--
-- The same as 'getReportingReportRunsReportRun' but returns the raw 'Data.ByteString.Char8.ByteString'.
getReportingReportRunsReportRunRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  GetReportingReportRunsReportRunParameters ->
...
getReportingReportRunsReportRunRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/reporting/report_runs/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getReportingReportRunsReportRunParametersPathReportRun parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getReportingReportRunsReportRunParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/reporting/report_runs/{report_run}
--
-- The same as 'getReportingReportRunsReportRun' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getReportingReportRunsReportRunWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
