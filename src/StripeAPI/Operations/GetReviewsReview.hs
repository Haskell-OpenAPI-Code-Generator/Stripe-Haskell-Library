...
getReviewsReview ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetReviewsReviewResponse))
getReviewsReview
  config
  expand
  review
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/reviews/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel review)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetReviewsReviewRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetReviewsReviewRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetReviewsReviewRequestBody" (\obj -> GHC.Base.pure GetReviewsReviewRequestBody)
