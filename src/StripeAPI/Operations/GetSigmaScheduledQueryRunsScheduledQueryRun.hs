...
getSigmaScheduledQueryRunsScheduledQueryRun ::
  ...
  -- | scheduled_query_run | Constraints: Maximum length of 5000
  Data.Text.Internal.Text ->
  -- | The request body to send
  GHC.Maybe.Maybe GetSigmaScheduledQueryRunsScheduledQueryRunRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetSigmaScheduledQueryRunsScheduledQueryRunResponse))
getSigmaScheduledQueryRunsScheduledQueryRun
  config
  expand
  scheduledQueryRun
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/sigma/scheduled_query_runs/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel scheduledQueryRun)) GHC.Base.++ "")))
...
getSigmaScheduledQueryRunsScheduledQueryRunM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
getSigmaScheduledQueryRunsScheduledQueryRunRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetSigmaScheduledQueryRunsScheduledQueryRunRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetSigmaScheduledQueryRunsScheduledQueryRunRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSigmaScheduledQueryRunsScheduledQueryRunRequestBody" (\obj -> GHC.Base.pure GetSigmaScheduledQueryRunsScheduledQueryRunRequestBody)
