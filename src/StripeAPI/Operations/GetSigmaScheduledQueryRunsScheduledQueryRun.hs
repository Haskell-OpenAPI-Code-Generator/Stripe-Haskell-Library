...
getSigmaScheduledQueryRunsScheduledQueryRun ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetSigmaScheduledQueryRunsScheduledQueryRunResponse)
getSigmaScheduledQueryRunsScheduledQueryRun parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetSigmaScheduledQueryRunsScheduledQueryRunResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if  | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                   GetSigmaScheduledQueryRunsScheduledQueryRunResponse200
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            ScheduledQueryRun
                                                      )
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                   GetSigmaScheduledQueryRunsScheduledQueryRunResponseDefault
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            Error
                                                      )
...
instance Data.Aeson.ToJSON GetSigmaScheduledQueryRunsScheduledQueryRunParameters where
...
-- | > GET /v1/sigma/scheduled_query_runs/{scheduled_query_run}
--
-- The same as 'getSigmaScheduledQueryRunsScheduledQueryRun' but accepts an explicit configuration.
getSigmaScheduledQueryRunsScheduledQueryRunWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetSigmaScheduledQueryRunsScheduledQueryRunParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetSigmaScheduledQueryRunsScheduledQueryRunResponse)
getSigmaScheduledQueryRunsScheduledQueryRunWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/sigma/scheduled_query_runs/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getSigmaScheduledQueryRunsScheduledQueryRunParametersPathScheduledQueryRun parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSigmaScheduledQueryRunsScheduledQueryRunParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])
...
getSigmaScheduledQueryRunsScheduledQueryRunRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/sigma/scheduled_query_runs/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getSigmaScheduledQueryRunsScheduledQueryRunParametersPathScheduledQueryRun parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSigmaScheduledQueryRunsScheduledQueryRunParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/sigma/scheduled_query_runs/{scheduled_query_run}
--
-- The same as 'getSigmaScheduledQueryRunsScheduledQueryRun' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getSigmaScheduledQueryRunsScheduledQueryRunWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
