...
instance Data.Aeson.ToJSON GetSourcesSourceSourceTransactionsSourceTransactionParameters where
...
-- | > GET /v1/sources/{source}/source_transactions/{source_transaction}
--
-- The same as 'getSourcesSourceSourceTransactionsSourceTransaction' but accepts an explicit configuration.
getSourcesSourceSourceTransactionsSourceTransactionWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetSourcesSourceSourceTransactionsSourceTransactionParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetSourcesSourceSourceTransactionsSourceTransactionResponse)
getSourcesSourceSourceTransactionsSourceTransactionWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getSourcesSourceSourceTransactionsSourceTransactionRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  GetSourcesSourceSourceTransactionsSourceTransactionParameters ->
...
-- | > GET /v1/sources/{source}/source_transactions/{source_transaction}
--
-- The same as 'getSourcesSourceSourceTransactionsSourceTransaction' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getSourcesSourceSourceTransactionsSourceTransactionWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
