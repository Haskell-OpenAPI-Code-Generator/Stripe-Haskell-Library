...
postTerminalConnectionTokens ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTerminalConnectionTokensResponse)
postTerminalConnectionTokens body =
  GHC.Base.fmap
    ...
    (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/v1/terminal/connection_tokens") GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalConnectionTokensRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object ("expand" Data.Aeson.Types.ToJSON..= postTerminalConnectionTokensRequestBodyExpand obj : "location" Data.Aeson.Types.ToJSON..= postTerminalConnectionTokensRequestBodyLocation obj : GHC.Base.mempty)
