...
postTerminalConnectionTokens body =
  GHC.Base.fmap
    ...
    (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/terminal/connection_tokens" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
