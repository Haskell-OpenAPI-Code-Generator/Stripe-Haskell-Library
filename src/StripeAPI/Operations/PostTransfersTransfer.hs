...
postTransfersTransfer :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostTransfersTransferRequestBody
    = PostTransfersTransferRequestBody {postTransfersTransferRequestBodyDescription :: (GHC.Maybe.Maybe GHC.Base.String),
...
data PostTransfersTransferResponse
    = PostTransfersTransferResponseError GHC.Base.String
