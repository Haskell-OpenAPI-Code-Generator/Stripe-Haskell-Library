...
data PostTransfersTransferRequestBody
  = PostTransfersTransferRequestBody
      { -- | description: An arbitrary string attached to the object. Often useful for displaying to users.
        ...
        postTransfersTransferRequestBodyMetadata :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
      }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
-- | > POST /v1/transfers/{transfer}
--
-- The same as 'postTransfersTransfer' but accepts an explicit configuration.
postTransfersTransferWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GHC.Maybe.Maybe PostTransfersTransferRequestBody ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response PostTransfersTransferResponse)
postTransfersTransferWithConfiguration
  config
  transfer
  body =
...
-- | > POST /v1/transfers/{transfer}
--
-- The same as 'postTransfersTransfer' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
postTransfersTransferWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
