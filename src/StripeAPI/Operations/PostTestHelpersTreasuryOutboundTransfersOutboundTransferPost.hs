...
postTestHelpersTreasuryOutboundTransfersOutboundTransferPost ::
  ...
  GHC.Maybe.Maybe PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostResponse)
postTestHelpersTreasuryOutboundTransfersOutboundTransferPost
  outboundTransfer
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostResponseError GHC.Base.id
                GHC.Base.. ( \response body ->
                               if
                                   | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostResponse200
                                   ...
                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostResponseDefault
                                         Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                              Data.Either.Either
                                                                GHC.Base.String
                                                                Error
...
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postTestHelpersTreasuryOutboundTransfersOutboundTransferPostRequestBodyExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostRequestBody" (\obj -> GHC.Base.pure PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))
...
data PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostResponse
  = -- | Means either no matching case available or a parse error
    PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostResponseError GHC.Base.String
  | -- | Successful response.
    PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostResponse200 Treasury'outboundTransfer
  | -- | Error response.
    PostTestHelpersTreasuryOutboundTransfersOutboundTransferPostResponseDefault Error
