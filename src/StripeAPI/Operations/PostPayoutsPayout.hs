...
postPayoutsPayout :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostPayoutsPayoutRequestBody
    = PostPayoutsPayoutRequestBody {postPayoutsPayoutRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
