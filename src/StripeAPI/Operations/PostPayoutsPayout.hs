...
postPayoutsPayout
  ...
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostPayoutsPayoutResponseError GHC.Base.id
...
instance Data.Aeson.Types.ToJSON.ToJSON PostPayoutsPayoutRequestBodyMetadata'Variants where
  toJSON (PostPayoutsPayoutRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPayoutsPayoutRequestBodyMetadata'Variants where
  parseJSON val =
    if
        | val GHC.Classes.== "" -> GHC.Base.pure PostPayoutsPayoutRequestBodyMetadata'EmptyString
