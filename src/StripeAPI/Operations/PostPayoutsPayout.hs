...
data PostPayoutsPayoutRequestBody
  = PostPayoutsPayoutRequestBody
      { -- | expand: Specifies which fields in the response should be expanded.
        ...
        postPayoutsPayoutRequestBodyMetadata :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
      }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
-- | > POST /v1/payouts/{payout}
--
-- The same as 'postPayoutsPayout' but accepts an explicit configuration.
postPayoutsPayoutWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GHC.Maybe.Maybe PostPayoutsPayoutRequestBody ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response PostPayoutsPayoutResponse)
postPayoutsPayoutWithConfiguration
  config
  payout
  body =
...
-- | > POST /v1/payouts/{payout}
--
-- The same as 'postPayoutsPayout' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
postPayoutsPayoutWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
