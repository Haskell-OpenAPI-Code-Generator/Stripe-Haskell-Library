...
postCreditNotesIdVoid ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostCreditNotesIdVoidResponse)
postCreditNotesIdVoid
  id
  body =
    GHC.Base.fmap
...
instance Data.Aeson.Types.ToJSON.ToJSON PostCreditNotesIdVoidRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object ("expand" Data.Aeson.Types.ToJSON..= postCreditNotesIdVoidRequestBodyExpand obj : GHC.Base.mempty)
