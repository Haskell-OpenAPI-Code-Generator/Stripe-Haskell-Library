...
postInvoicesInvoicePay ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostInvoicesInvoicePayResponse))
postInvoicesInvoicePay
  config
  invoice
  body =
