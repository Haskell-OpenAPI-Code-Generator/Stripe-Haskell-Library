...
postTopupsTopup :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostTopupsTopupRequestBody
    = PostTopupsTopupRequestBody {postTopupsTopupRequestBodyDescription :: (GHC.Maybe.Maybe GHC.Base.String),
