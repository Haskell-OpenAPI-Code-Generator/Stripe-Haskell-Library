...
getCustomersCustomerTaxIds ::
  ...
  GHC.Maybe.Maybe GetCustomersCustomerTaxIdsRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetCustomersCustomerTaxIdsResponse))
getCustomersCustomerTaxIds
  config
  customer
  endingBefore
  ...
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/customers/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel customer)) GHC.Base.++ "/tax_ids")))
...
getCustomersCustomerTaxIdsRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetCustomersCustomerTaxIdsRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerTaxIdsRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerTaxIdsRequestBody" (\obj -> GHC.Base.pure GetCustomersCustomerTaxIdsRequestBody)
...
instance Data.Aeson.ToJSON GetCustomersCustomerTaxIdsResponseBody200 where
...
instance Data.Aeson.ToJSON GetCustomersCustomerTaxIdsResponseBody200Object' where
...
instance Data.Aeson.FromJSON GetCustomersCustomerTaxIdsResponseBody200Object' where
  parseJSON val =
    GHC.Base.pure
