...
data PostAccountPersonsRequestBody = PostAccountPersonsRequestBody {
  ...
  postAccountPersonsRequestBodyAccount :: (GHC.Maybe.Maybe GHC.Base.String)
...
data PostAccountPersonsRequestBodyAddress' = PostAccountPersonsRequestBodyAddress' {
  ...
  postAccountPersonsRequestBodyAddress'City :: (GHC.Maybe.Maybe GHC.Base.String)
  -- | country
  -- 
  -- Constraints:
  -- 
...
data PostAccountPersonsRequestBodyAddressKana' = PostAccountPersonsRequestBodyAddressKana' {
  ...
  -- 
  -- * Maximum length of 5000
  postAccountPersonsRequestBodyAddressKana'City :: (GHC.Maybe.Maybe GHC.Base.String)
  -- | country
  -- 
  -- Constraints:
  -- 
...
data PostAccountPersonsRequestBodyAddressKanji' = PostAccountPersonsRequestBodyAddressKanji' {
  ...
  -- 
  -- * Maximum length of 5000
  postAccountPersonsRequestBodyAddressKanji'City :: (GHC.Maybe.Maybe GHC.Base.String)
  -- | country
  -- 
  -- Constraints:
  -- 
...
data PostAccountPersonsRequestBodyVerification'AdditionalDocument' = PostAccountPersonsRequestBodyVerification'AdditionalDocument' {
  ...
  postAccountPersonsRequestBodyVerification'AdditionalDocument'Back :: (GHC.Maybe.Maybe GHC.Base.String)
  -- | front
  -- 
  -- Constraints:
  -- 
...
data PostAccountPersonsRequestBodyVerification'Document' = PostAccountPersonsRequestBodyVerification'Document' {
  ...
  -- 
  -- * Maximum length of 500
  postAccountPersonsRequestBodyVerification'Document'Back :: (GHC.Maybe.Maybe GHC.Base.String)
  -- | front
  -- 
  -- Constraints:
  -- 
