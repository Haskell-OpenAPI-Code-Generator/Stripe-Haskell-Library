...
getCustomersCustomerCards ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetCustomersCustomerCardsResponse)
...
instance Data.Aeson.ToJSON GetCustomersCustomerCardsParameters where
...
-- | > GET /v1/customers/{customer}/cards
--
-- The same as 'getCustomersCustomerCards' but accepts an explicit configuration.
getCustomersCustomerCardsWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetCustomersCustomerCardsParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetCustomersCustomerCardsResponse)
getCustomersCustomerCardsWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getCustomersCustomerCardsRaw parameters =
  GHC.Base.id
    ( StripeAPI.Common.doCallWithConfigurationM
        (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET")
        (Data.Text.pack ("/v1/customers/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getCustomersCustomerCardsParametersPathCustomer parameters))) GHC.Base.++ "/cards")))
...
-- | > GET /v1/customers/{customer}/cards
--
-- The same as 'getCustomersCustomerCards' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getCustomersCustomerCardsWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
