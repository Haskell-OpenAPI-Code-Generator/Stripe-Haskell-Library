...
getSubscriptionItemsSubscriptionItemUsageRecordSummaries :: forall m . StripeAPI.Common.MonadHTTP m => GetSubscriptionItemsSubscriptionItemUsageRecordSummariesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponse) -- ^ Monadic computation which returns the result of the operation
getSubscriptionItemsSubscriptionItemUsageRecordSummaries parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Error)
                                                                                                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/subscription_items/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getSubscriptionItemsSubscriptionItemUsageRecordSummariesParametersPathSubscriptionItem parameters))) GHC.Base.++ "/usage_record_summaries"))) [StripeAPI.Common.QueryParameter (Data.Text.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSubscriptionItemsSubscriptionItemUsageRecordSummariesParametersQueryEndingBefore parameters) (Data.Text.pack "form") GHC.Types.True,
...
data GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200 = GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
...
mkGetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200 :: [UsageRecordSummary] -- ^ 'getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200Url'
  -> GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200
mkGetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200 getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200Data getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200HasMore getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200Url = GetSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200{getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200Data = getSubscriptionItemsSubscriptionItemUsageRecordSummariesResponseBody200Data,
