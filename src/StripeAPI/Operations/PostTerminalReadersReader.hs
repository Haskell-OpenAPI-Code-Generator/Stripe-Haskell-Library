...
postTerminalReadersReader ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostTerminalReadersReaderResponse))
postTerminalReadersReader
  config
  reader
  body =
...
instance Data.Aeson.ToJSON PostTerminalReadersReaderRequestBody where
...
instance Data.Aeson.ToJSON PostTerminalReadersReaderRequestBodyMetadata' where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderRequestBodyMetadata' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTerminalReadersReaderRequestBodyMetadata'" (\obj -> GHC.Base.pure PostTerminalReadersReaderRequestBodyMetadata')
