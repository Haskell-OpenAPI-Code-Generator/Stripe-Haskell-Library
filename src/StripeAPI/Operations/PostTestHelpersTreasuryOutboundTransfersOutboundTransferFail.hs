...
postTestHelpersTreasuryOutboundTransfersOutboundTransferFail ::
  ...
  GHC.Maybe.Maybe PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailResponse)
postTestHelpersTreasuryOutboundTransfersOutboundTransferFail
  outboundTransfer
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailResponseError GHC.Base.id
                GHC.Base.. ( \response body ->
                               if
                                   | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailResponse200
                                   ...
                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailResponseDefault
                                         Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                              Data.Either.Either
                                                                GHC.Base.String
                                                                Error
...
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postTestHelpersTreasuryOutboundTransfersOutboundTransferFailRequestBodyExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailRequestBody" (\obj -> GHC.Base.pure PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))
...
data PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailResponse
  = -- | Means either no matching case available or a parse error
    PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailResponseError GHC.Base.String
  | -- | Successful response.
    PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailResponse200 Treasury'outboundTransfer
  | -- | Error response.
    PostTestHelpersTreasuryOutboundTransfersOutboundTransferFailResponseDefault Error
