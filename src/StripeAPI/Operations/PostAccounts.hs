...
postAccounts ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response PostAccountsResponse)
postAccounts body =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
