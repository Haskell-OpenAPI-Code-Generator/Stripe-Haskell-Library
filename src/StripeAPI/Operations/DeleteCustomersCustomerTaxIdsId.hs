...
deleteCustomersCustomerTaxIdsId ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response DeleteCustomersCustomerTaxIdsIdResponse))
deleteCustomersCustomerTaxIdsId
  config
  customer
  id
...
deleteCustomersCustomerTaxIdsIdM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
deleteCustomersCustomerTaxIdsIdRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON DeleteCustomersCustomerTaxIdsIdRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON DeleteCustomersCustomerTaxIdsIdRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "DeleteCustomersCustomerTaxIdsIdRequestBody" (\obj -> GHC.Base.pure DeleteCustomersCustomerTaxIdsIdRequestBody)
