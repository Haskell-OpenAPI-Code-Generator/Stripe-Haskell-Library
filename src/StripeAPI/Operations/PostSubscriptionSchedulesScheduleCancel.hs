...
postSubscriptionSchedulesScheduleCancel ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostSubscriptionSchedulesScheduleCancelResponse))
postSubscriptionSchedulesScheduleCancel
  config
  schedule
  body =
...
postSubscriptionSchedulesScheduleCancelM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
postSubscriptionSchedulesScheduleCancelRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
