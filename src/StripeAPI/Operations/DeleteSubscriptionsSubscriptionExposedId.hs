...
deleteSubscriptionsSubscriptionExposedId :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data DeleteSubscriptionsSubscriptionExposedIdRequestBody
    = DeleteSubscriptionsSubscriptionExposedIdRequestBody {deleteSubscriptionsSubscriptionExposedIdRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
