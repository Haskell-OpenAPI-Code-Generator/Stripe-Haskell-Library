...
postSubscriptionSchedules body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSubscriptionSchedulesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSubscriptionSchedulesResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                     ...
                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSubscriptionSchedulesResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                Error)
                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/v1/subscription_schedules") GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
mkPostSubscriptionSchedulesRequestBody = PostSubscriptionSchedulesRequestBody{postSubscriptionSchedulesRequestBodyCustomer = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSubscriptionSchedulesRequestBodyDefaultSettings'AutomaticTax'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postSubscriptionSchedulesRequestBodyDefaultSettings'AutomaticTax'Enabled obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostSubscriptionSchedulesRequestBodyDefaultSettings'AutomaticTax'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostSubscriptionSchedulesRequestBodyDefaultSettings'AutomaticTax'" (\obj -> GHC.Base.pure PostSubscriptionSchedulesRequestBodyDefaultSettings'AutomaticTax' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled"))
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSubscriptionSchedulesRequestBodyDefaultSettings'InvoiceSettings'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("days_until_due" Data.Aeson.Types.ToJSON..=)) (postSubscriptionSchedulesRequestBodyDefaultSettings'InvoiceSettings'DaysUntilDue obj) : GHC.Base.mempty))
...
mkPostSubscriptionSchedulesRequestBodyPhases'AddInvoiceItems' = PostSubscriptionSchedulesRequestBodyPhases'AddInvoiceItems'{postSubscriptionSchedulesRequestBodyPhases'AddInvoiceItems'Price = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSubscriptionSchedulesRequestBodyPhases'AutomaticTax'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postSubscriptionSchedulesRequestBodyPhases'AutomaticTax'Enabled obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostSubscriptionSchedulesRequestBodyPhases'AutomaticTax'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostSubscriptionSchedulesRequestBodyPhases'AutomaticTax'" (\obj -> GHC.Base.pure PostSubscriptionSchedulesRequestBodyPhases'AutomaticTax' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled"))
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSubscriptionSchedulesRequestBodyPhases'InvoiceSettings'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("days_until_due" Data.Aeson.Types.ToJSON..=)) (postSubscriptionSchedulesRequestBodyPhases'InvoiceSettings'DaysUntilDue obj) : GHC.Base.mempty))
...
data PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1 = PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["usage_gte" Data.Aeson.Types.ToJSON..= postSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1UsageGte obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1" (\obj -> GHC.Base.pure PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "usage_gte"))
-- | Create a new 'PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1' with all required fields.
mkPostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1 :: GHC.Types.Int -- ^ 'postSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1UsageGte'
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'Variants
    where toJSON (PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'PostSubscriptionSchedulesRequestBodyPhases'Items'BillingThresholds'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a
