...
postInvoicesInvoiceSend ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostInvoicesInvoiceSendResponse))
postInvoicesInvoiceSend
  config
  invoice
  body =
