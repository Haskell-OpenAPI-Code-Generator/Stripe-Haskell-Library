...
postInvoicesInvoiceSend :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostInvoicesInvoiceSendRequestBody
    = PostInvoicesInvoiceSendRequestBody {postInvoicesInvoiceSendRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String))}
