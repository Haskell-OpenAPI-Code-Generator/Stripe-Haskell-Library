...
postCreditNotesId :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostCreditNotesIdRequestBody
    = PostCreditNotesIdRequestBody {postCreditNotesIdRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
...
data PostCreditNotesIdResponse
    = PostCreditNotesIdResponseError GHC.Base.String
