...
postTestHelpersIssuingCardsCardShippingDeliver ::
  ...
  GHC.Maybe.Maybe PostTestHelpersIssuingCardsCardShippingDeliverRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTestHelpersIssuingCardsCardShippingDeliverResponse)
postTestHelpersIssuingCardsCardShippingDeliver
  card
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostTestHelpersIssuingCardsCardShippingDeliverResponseError GHC.Base.id
                GHC.Base.. ( \response body ->
                               if
                                   | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostTestHelpersIssuingCardsCardShippingDeliverResponse200
                                   ...
                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostTestHelpersIssuingCardsCardShippingDeliverResponseDefault
                                         Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                              Data.Either.Either
                                                                GHC.Base.String
                                                                Error
...
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersIssuingCardsCardShippingDeliverRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postTestHelpersIssuingCardsCardShippingDeliverRequestBodyExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersIssuingCardsCardShippingDeliverRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersIssuingCardsCardShippingDeliverRequestBody" (\obj -> GHC.Base.pure PostTestHelpersIssuingCardsCardShippingDeliverRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))
...
data PostTestHelpersIssuingCardsCardShippingDeliverResponse
  = -- | Means either no matching case available or a parse error
    PostTestHelpersIssuingCardsCardShippingDeliverResponseError GHC.Base.String
  | -- | Successful response.
    PostTestHelpersIssuingCardsCardShippingDeliverResponse200 Issuing'card
  | -- | Error response.
    PostTestHelpersIssuingCardsCardShippingDeliverResponseDefault Error
