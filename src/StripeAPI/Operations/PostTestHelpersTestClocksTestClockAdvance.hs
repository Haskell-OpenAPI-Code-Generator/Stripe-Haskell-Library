...
postTestHelpersTestClocksTestClockAdvance ::
  ...
  -- | test_clock | Constraints: Maximum length of 5000
  Data.Text.Internal.Text ->
  -- | The request body to send
  PostTestHelpersTestClocksTestClockAdvanceRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTestHelpersTestClocksTestClockAdvanceResponse)
postTestHelpersTestClocksTestClockAdvance
  testClock
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostTestHelpersTestClocksTestClockAdvanceResponseError GHC.Base.id
                GHC.Base.. ( \response body ->
                               if
                                   | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostTestHelpersTestClocksTestClockAdvanceResponse200
                                   ...
                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostTestHelpersTestClocksTestClockAdvanceResponseDefault
                                         Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                              Data.Either.Either
                                                                GHC.Base.String
                                                                Error
...
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTestClocksTestClockAdvanceRequestBody where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTestClocksTestClockAdvanceRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersTestClocksTestClockAdvanceRequestBody" (\obj -> (GHC.Base.pure PostTestHelpersTestClocksTestClockAdvanceRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "frozen_time"))

-- | Create a new 'PostTestHelpersTestClocksTestClockAdvanceRequestBody' with all required fields.
mkPostTestHelpersTestClocksTestClockAdvanceRequestBody ::
  -- | 'postTestHelpersTestClocksTestClockAdvanceRequestBodyFrozenTime'
  GHC.Types.Int ->
  PostTestHelpersTestClocksTestClockAdvanceRequestBody
mkPostTestHelpersTestClocksTestClockAdvanceRequestBody postTestHelpersTestClocksTestClockAdvanceRequestBodyFrozenTime =
  PostTestHelpersTestClocksTestClockAdvanceRequestBody
    { postTestHelpersTestClocksTestClockAdvanceRequestBodyExpand = GHC.Maybe.Nothing,
...
data PostTestHelpersTestClocksTestClockAdvanceResponse
  = -- | Means either no matching case available or a parse error
    PostTestHelpersTestClocksTestClockAdvanceResponseError GHC.Base.String
  | -- | Successful response.
    PostTestHelpersTestClocksTestClockAdvanceResponse200 TestHelpers'testClock
  | -- | Error response.
    PostTestHelpersTestClocksTestClockAdvanceResponseDefault Error
