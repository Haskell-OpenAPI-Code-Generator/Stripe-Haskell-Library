...
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountBankAccountsRequestBodyBankAccount'OneOf2 where
  toJSON obj = Data.Aeson.Types.Internal.object ("account_holder_name" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderName obj : "account_holder_type" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType obj : "account_number" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountNumber obj : "country" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2Country obj : "currency" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2Currency obj : "routing_number" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2RoutingNumber obj : "object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "bank_account" : [])
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("account_holder_name" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderName obj) GHC.Base.<> (("account_holder_type" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType obj) GHC.Base.<> (("account_number" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountNumber obj) GHC.Base.<> (("country" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2Country obj) GHC.Base.<> (("currency" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2Currency obj) GHC.Base.<> (("routing_number" Data.Aeson.Types.ToJSON..= postAccountBankAccountsRequestBodyBankAccount'OneOf2RoutingNumber obj) GHC.Base.<> ("object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "bank_account")))))))
...
-- | Create a new 'PostAccountBankAccountsRequestBodyBankAccount'OneOf2' with all required fields.
mkPostAccountBankAccountsRequestBodyBankAccount'OneOf2 ::
  -- | 'postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountNumber'
  Data.Text.Internal.Text ->
  -- | 'postAccountBankAccountsRequestBodyBankAccount'OneOf2Country'
  Data.Text.Internal.Text ->
  PostAccountBankAccountsRequestBodyBankAccount'OneOf2
mkPostAccountBankAccountsRequestBodyBankAccount'OneOf2 postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountNumber postAccountBankAccountsRequestBodyBankAccount'OneOf2Country =
  PostAccountBankAccountsRequestBodyBankAccount'OneOf2
    { postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderName = GHC.Maybe.Nothing,
      postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType = GHC.Maybe.Nothing,
      postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountNumber = postAccountBankAccountsRequestBodyBankAccount'OneOf2AccountNumber,
      postAccountBankAccountsRequestBodyBankAccount'OneOf2Country = postAccountBankAccountsRequestBodyBankAccount'OneOf2Country,
      postAccountBankAccountsRequestBodyBankAccount'OneOf2Currency = GHC.Maybe.Nothing,
      postAccountBankAccountsRequestBodyBankAccount'OneOf2RoutingNumber = GHC.Maybe.Nothing
    }
...
data PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"company"@
    PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'EnumCompany
  | -- | Represents the JSON value @"individual"@
    PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'EnumIndividual
...
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType' where
  toJSON (PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'Other val) = val
  toJSON (PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
  toJSON (PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'EnumCompany) = "company"
  toJSON (PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'EnumIndividual) = "individual"

instance Data.Aeson.Types.FromJSON.FromJSON PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType' where
  parseJSON val =
    GHC.Base.pure
      ( if  | val GHC.Classes.== "company" -> PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'EnumCompany
            | val GHC.Classes.== "individual" -> PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'EnumIndividual
            | GHC.Base.otherwise -> PostAccountBankAccountsRequestBodyBankAccount'OneOf2AccountHolderType'Other val
      )
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountBankAccountsRequestBodyBankAccount'Variants where
  parseJSON val = case (PostAccountBankAccountsRequestBodyBankAccount'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostAccountBankAccountsRequestBodyBankAccount'PostAccountBankAccountsRequestBodyBankAccount'OneOf2 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
