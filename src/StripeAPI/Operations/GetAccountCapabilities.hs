...
getAccountCapabilities :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe ([Data.Text.Internal.Text]) -- ^ expand: Specifies which fields in the response should be expanded.
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetAccountCapabilitiesResponse) -- ^ Monadic computation which returns the result of the operation
getAccountCapabilities expand = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetAccountCapabilitiesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetAccountCapabilitiesResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
data GetAccountCapabilitiesResponseBody200 = GetAccountCapabilitiesResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAccountCapabilitiesResponseBody200
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getAccountCapabilitiesResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getAccountCapabilitiesResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getAccountCapabilitiesResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getAccountCapabilitiesResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getAccountCapabilitiesResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getAccountCapabilitiesResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON GetAccountCapabilitiesResponseBody200
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountCapabilitiesResponseBody200" (\obj -> ((GHC.Base.pure GetAccountCapabilitiesResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'GetAccountCapabilitiesResponseBody200' with all required fields.
mkGetAccountCapabilitiesResponseBody200 :: [Capability] -- ^ 'getAccountCapabilitiesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getAccountCapabilitiesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getAccountCapabilitiesResponseBody200Url'
  -> GetAccountCapabilitiesResponseBody200
mkGetAccountCapabilitiesResponseBody200 getAccountCapabilitiesResponseBody200Data getAccountCapabilitiesResponseBody200HasMore getAccountCapabilitiesResponseBody200Url = GetAccountCapabilitiesResponseBody200{getAccountCapabilitiesResponseBody200Data = getAccountCapabilitiesResponseBody200Data,
