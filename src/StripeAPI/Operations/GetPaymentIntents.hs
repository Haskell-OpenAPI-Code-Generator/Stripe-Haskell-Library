...
instance Data.Aeson.ToJSON GetPaymentIntentsParameters where
...
instance Data.Aeson.ToJSON GetPaymentIntentsParametersQueryCreated'OneOf2 where
...
instance Data.Aeson.ToJSON GetPaymentIntentsParametersQueryCreated'Variants where
  toJSON = Data.Aeson.Types.ToJSON.genericToJSON Data.Aeson.Types.Internal.defaultOptions {Data.Aeson.Types.Internal.sumEncoding = Data.Aeson.Types.Internal.UntaggedValue}

instance Data.Aeson.FromJSON GetPaymentIntentsParametersQueryCreated'Variants where
...
instance Data.Aeson.ToJSON GetPaymentIntentsResponseBody200 where
...
instance Data.Aeson.ToJSON GetPaymentIntentsResponseBody200Object' where
...
instance Data.Aeson.FromJSON GetPaymentIntentsResponseBody200Object' where
  parseJSON val =
    GHC.Base.pure
...
-- | > GET /v1/payment_intents
--
-- The same as 'getPaymentIntents' but accepts an explicit configuration.
getPaymentIntentsWithConfiguration ::
  ...
  GetPaymentIntentsParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetPaymentIntentsResponse)
getPaymentIntentsWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getPaymentIntentsRaw parameters =
  GHC.Base.id
    ( StripeAPI.Common.doCallWithConfigurationM
        (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET")
        (Data.Text.pack "/v1/payment_intents")
...
-- | > GET /v1/payment_intents
--
-- The same as 'getPaymentIntents' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getPaymentIntentsWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
