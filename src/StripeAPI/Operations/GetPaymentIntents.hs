...
getPaymentIntents ::
  ...
  -- | customer: Only return PaymentIntents for the customer specified by this customer ID. | Constraints: Maximum length of 5000
  GHC.Maybe.Maybe Data.Text.Internal.Text ->
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetPaymentIntentsResponse))
getPaymentIntents
  config
  created
  customer
...
instance Data.Aeson.ToJSON GetPaymentIntentsRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetPaymentIntentsRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetPaymentIntentsRequestBody" (\obj -> GHC.Base.pure GetPaymentIntentsRequestBody)
