...
getPaymentMethodsPaymentMethod ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetPaymentMethodsPaymentMethodResponse)
...
instance Data.Aeson.ToJSON GetPaymentMethodsPaymentMethodParameters where
...
-- | > GET /v1/payment_methods/{payment_method}
--
-- The same as 'getPaymentMethodsPaymentMethod' but accepts an explicit configuration.
getPaymentMethodsPaymentMethodWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetPaymentMethodsPaymentMethodParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetPaymentMethodsPaymentMethodResponse)
getPaymentMethodsPaymentMethodWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/payment_methods/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getPaymentMethodsPaymentMethodParametersPathPaymentMethod parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getPaymentMethodsPaymentMethodParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])
...
getPaymentMethodsPaymentMethodRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/payment_methods/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getPaymentMethodsPaymentMethodParametersPathPaymentMethod parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getPaymentMethodsPaymentMethodParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/payment_methods/{payment_method}
--
-- The same as 'getPaymentMethodsPaymentMethod' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getPaymentMethodsPaymentMethodWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
