...
instance Data.Aeson.ToJSON GetInvoiceitemsParameters where
...
instance Data.Aeson.ToJSON GetInvoiceitemsParametersQueryCreated'OneOf2 where
...
instance Data.Aeson.ToJSON GetInvoiceitemsParametersQueryCreated'Variants where
  toJSON = Data.Aeson.Types.ToJSON.genericToJSON Data.Aeson.Types.Internal.defaultOptions {Data.Aeson.Types.Internal.sumEncoding = Data.Aeson.Types.Internal.UntaggedValue}

instance Data.Aeson.FromJSON GetInvoiceitemsParametersQueryCreated'Variants where
...
instance Data.Aeson.ToJSON GetInvoiceitemsResponseBody200 where
...
instance Data.Aeson.ToJSON GetInvoiceitemsResponseBody200Object' where
...
instance Data.Aeson.FromJSON GetInvoiceitemsResponseBody200Object' where
  parseJSON val =
    GHC.Base.pure
...
-- | > GET /v1/invoiceitems
--
-- The same as 'getInvoiceitems' but accepts an explicit configuration.
getInvoiceitemsWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetInvoiceitemsParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetInvoiceitemsResponse)
getInvoiceitemsWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
-- | > GET /v1/invoiceitems
--
-- The same as 'getInvoiceitems' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getInvoiceitemsWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
