...
getSkusId :: forall m . StripeAPI.Common.MonadHTTP m => GetSkusIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetSkusIdResponse) -- ^ Monadic computation which returns the result of the operation
getSkusId parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetSkusIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetSkusIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
data GetSkusIdParameters = GetSkusIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSkusIdParameters
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathId" Data.Aeson.Types.ToJSON..= getSkusIdParametersPathId obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getSkusIdParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSkusIdParameters
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSkusIdParameters" (\obj -> (GHC.Base.pure GetSkusIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))
-- | Create a new 'GetSkusIdParameters' with all required fields.
mkGetSkusIdParameters :: Data.Text.Internal.Text -- ^ 'getSkusIdParametersPathId'
  -> GetSkusIdParameters
mkGetSkusIdParameters getSkusIdParametersPathId = GetSkusIdParameters{getSkusIdParametersPathId = getSkusIdParametersPathId,
...
data GetSkusIdResponseBody200 = GetSkusIdResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSkusIdResponseBody200
...
mkGetSkusIdResponseBody200 = GetSkusIdResponseBody200{getSkusIdResponseBody200Active = GHC.Maybe.Nothing,
...
data GetSkusIdResponseBody200Deleted' =
   GetSkusIdResponseBody200Deleted'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetSkusIdResponseBody200Deleted'Typed GHC.Types.Bool -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetSkusIdResponseBody200Deleted'EnumTrue -- ^ Represents the JSON value @true@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSkusIdResponseBody200Deleted'
    where toJSON (GetSkusIdResponseBody200Deleted'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSkusIdResponseBody200Deleted'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== Data.Aeson.Types.Internal.Bool GHC.Types.True -> GetSkusIdResponseBody200Deleted'EnumTrue
...
data GetSkusIdResponseBody200Object' =
   GetSkusIdResponseBody200Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetSkusIdResponseBody200Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetSkusIdResponseBody200Object'EnumSku -- ^ Represents the JSON value @"sku"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSkusIdResponseBody200Object'
    where toJSON (GetSkusIdResponseBody200Object'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSkusIdResponseBody200Object'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "sku" -> GetSkusIdResponseBody200Object'EnumSku
...
data GetSkusIdResponseBody200PackageDimensions'NonNullable = GetSkusIdResponseBody200PackageDimensions'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSkusIdResponseBody200PackageDimensions'NonNullable
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("height" Data.Aeson.Types.ToJSON..=)) (getSkusIdResponseBody200PackageDimensions'NonNullableHeight obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("length" Data.Aeson.Types.ToJSON..=)) (getSkusIdResponseBody200PackageDimensions'NonNullableLength obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("weight" Data.Aeson.Types.ToJSON..=)) (getSkusIdResponseBody200PackageDimensions'NonNullableWeight obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("width" Data.Aeson.Types.ToJSON..=)) (getSkusIdResponseBody200PackageDimensions'NonNullableWidth obj) : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("height" Data.Aeson.Types.ToJSON..=)) (getSkusIdResponseBody200PackageDimensions'NonNullableHeight obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("length" Data.Aeson.Types.ToJSON..=)) (getSkusIdResponseBody200PackageDimensions'NonNullableLength obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("weight" Data.Aeson.Types.ToJSON..=)) (getSkusIdResponseBody200PackageDimensions'NonNullableWeight obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("width" Data.Aeson.Types.ToJSON..=)) (getSkusIdResponseBody200PackageDimensions'NonNullableWidth obj) : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON GetSkusIdResponseBody200PackageDimensions'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSkusIdResponseBody200PackageDimensions'NonNullable" (\obj -> (((GHC.Base.pure GetSkusIdResponseBody200PackageDimensions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "height")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "length")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "weight")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "width"))
...
mkGetSkusIdResponseBody200PackageDimensions'NonNullable = GetSkusIdResponseBody200PackageDimensions'NonNullable{getSkusIdResponseBody200PackageDimensions'NonNullableHeight = GHC.Maybe.Nothing,
...
data GetSkusIdResponseBody200Product'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSkusIdResponseBody200Product'Variants
    where toJSON (GetSkusIdResponseBody200Product'Text a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (GetSkusIdResponseBody200Product'Product a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON GetSkusIdResponseBody200Product'Variants
    where parseJSON val = case (GetSkusIdResponseBody200Product'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetSkusIdResponseBody200Product'Product Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
