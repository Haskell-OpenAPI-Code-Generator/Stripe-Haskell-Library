...
postFileLinks ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostFileLinksResponse))
postFileLinks
  config
  body =
    GHC.Base.fmap
...
instance Data.Aeson.ToJSON PostFileLinksRequestBodyMetadata' where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON PostFileLinksRequestBodyMetadata' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostFileLinksRequestBodyMetadata'" (\obj -> GHC.Base.pure PostFileLinksRequestBodyMetadata')
