...
getAccountsAccountCapabilities ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetAccountsAccountCapabilitiesResponse))
getAccountsAccountCapabilities
  config
  account
  expand
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/accounts/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel account)) GHC.Base.++ "/capabilities")))
...
getAccountsAccountCapabilitiesM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
getAccountsAccountCapabilitiesRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetAccountsAccountCapabilitiesRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetAccountsAccountCapabilitiesRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountsAccountCapabilitiesRequestBody" (\obj -> GHC.Base.pure GetAccountsAccountCapabilitiesRequestBody)
