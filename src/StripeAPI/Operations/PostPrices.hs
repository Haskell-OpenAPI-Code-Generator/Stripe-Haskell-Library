...
postPrices body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPricesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPricesResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                 Price)
                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPricesResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                   Error)
                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/v1/prices") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBody
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPricesRequestBody" (\obj -> (((((((((((((((((GHC.Base.pure PostPricesRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "active")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "billing_scheme")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "custom_unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lookup_key")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "nickname")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product_data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "recurring")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tiers")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tiers_mode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transfer_lookup_key")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transform_quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount_decimal"))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyRecurring'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPricesRequestBodyRecurring'" (\obj -> (((GHC.Base.pure PostPricesRequestBodyRecurring' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "aggregate_usage")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "usage_type"))
...
mkPostPricesRequestBodyRecurring' postPricesRequestBodyRecurring'Interval = PostPricesRequestBodyRecurring'{postPricesRequestBodyRecurring'AggregateUsage = GHC.Maybe.Nothing,
                                                                                                            postPricesRequestBodyRecurring'Interval = postPricesRequestBodyRecurring'Interval,
...
data PostPricesRequestBodyRecurring'AggregateUsage' =
   PostPricesRequestBodyRecurring'AggregateUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPricesRequestBodyRecurring'AggregateUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPricesRequestBodyRecurring'AggregateUsage'EnumLastDuringPeriod -- ^ Represents the JSON value @"last_during_period"@
  | PostPricesRequestBodyRecurring'AggregateUsage'EnumLastEver -- ^ Represents the JSON value @"last_ever"@
  | PostPricesRequestBodyRecurring'AggregateUsage'EnumMax -- ^ Represents the JSON value @"max"@
  | PostPricesRequestBodyRecurring'AggregateUsage'EnumSum -- ^ Represents the JSON value @"sum"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyRecurring'AggregateUsage'
    where toJSON (PostPricesRequestBodyRecurring'AggregateUsage'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyRecurring'AggregateUsage'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "last_during_period" -> PostPricesRequestBodyRecurring'AggregateUsage'EnumLastDuringPeriod
