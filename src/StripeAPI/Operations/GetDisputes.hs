...
instance Data.Aeson.ToJSON GetDisputesParameters where
...
instance Data.Aeson.ToJSON GetDisputesParametersQueryCreated'OneOf2 where
...
instance Data.Aeson.ToJSON GetDisputesParametersQueryCreated'Variants where
  toJSON = Data.Aeson.Types.ToJSON.genericToJSON Data.Aeson.Types.Internal.defaultOptions {Data.Aeson.Types.Internal.sumEncoding = Data.Aeson.Types.Internal.UntaggedValue}

instance Data.Aeson.FromJSON GetDisputesParametersQueryCreated'Variants where
...
-- | > GET /v1/disputes
--
-- The same as 'getDisputes' but accepts an explicit configuration.
getDisputesWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetDisputesParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetDisputesResponse)
getDisputesWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
-- | > GET /v1/disputes
--
-- The same as 'getDisputes' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getDisputesWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
