...
getCustomers ::
  ...
  GHC.Maybe.Maybe GetCustomersRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetCustomersResponse))
getCustomers
  config
  created
  email
...
instance Data.Aeson.ToJSON GetCustomersRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersRequestBody" (\obj -> GHC.Base.pure GetCustomersRequestBody)
