...
getBitcoinTransactions :: forall m . StripeAPI.Common.MonadHTTP m => GetBitcoinTransactionsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetBitcoinTransactionsResponse) -- ^ Monadic computation which returns the result of the operation
getBitcoinTransactions parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetBitcoinTransactionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetBitcoinTransactionsResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                     ...
                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetBitcoinTransactionsResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                             Error)
                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack "/v1/bitcoin/transactions") [StripeAPI.Common.QueryParameter (Data.Text.pack "customer") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getBitcoinTransactionsParametersQueryCustomer parameters) (Data.Text.pack "form") GHC.Types.True,
...
data GetBitcoinTransactionsParameters = GetBitcoinTransactionsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetBitcoinTransactionsParameters
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryCustomer" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryEnding_before" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryEndingBefore obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryExpand obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryLimit" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryLimit obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryReceiver" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryReceiver obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryStarting_after" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryStartingAfter obj) : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryCustomer" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryEnding_before" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryEndingBefore obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryExpand obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryLimit" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryLimit obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryReceiver" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryReceiver obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryStarting_after" Data.Aeson.Types.ToJSON..=)) (getBitcoinTransactionsParametersQueryStartingAfter obj) : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON GetBitcoinTransactionsParameters
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetBitcoinTransactionsParameters" (\obj -> (((((GHC.Base.pure GetBitcoinTransactionsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryReceiver")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))
...
mkGetBitcoinTransactionsParameters = GetBitcoinTransactionsParameters{getBitcoinTransactionsParametersQueryCustomer = GHC.Maybe.Nothing,
...
data GetBitcoinTransactionsResponseBody200 = GetBitcoinTransactionsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetBitcoinTransactionsResponseBody200
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getBitcoinTransactionsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getBitcoinTransactionsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getBitcoinTransactionsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getBitcoinTransactionsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getBitcoinTransactionsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getBitcoinTransactionsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON GetBitcoinTransactionsResponseBody200
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetBitcoinTransactionsResponseBody200" (\obj -> ((GHC.Base.pure GetBitcoinTransactionsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'GetBitcoinTransactionsResponseBody200' with all required fields.
mkGetBitcoinTransactionsResponseBody200 :: [BitcoinTransaction] -- ^ 'getBitcoinTransactionsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getBitcoinTransactionsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getBitcoinTransactionsResponseBody200Url'
  -> GetBitcoinTransactionsResponseBody200
mkGetBitcoinTransactionsResponseBody200 getBitcoinTransactionsResponseBody200Data getBitcoinTransactionsResponseBody200HasMore getBitcoinTransactionsResponseBody200Url = GetBitcoinTransactionsResponseBody200{getBitcoinTransactionsResponseBody200Data = getBitcoinTransactionsResponseBody200Data,
