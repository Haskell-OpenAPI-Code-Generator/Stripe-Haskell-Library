...
getPlansPlan ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetPlansPlanResponse))
getPlansPlan
  config
  expand
  plan
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/plans/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel plan)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetPlansPlanRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetPlansPlanRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetPlansPlanRequestBody" (\obj -> GHC.Base.pure GetPlansPlanRequestBody)
