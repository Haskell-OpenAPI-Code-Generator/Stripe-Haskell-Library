...
getRecipients ::
  ...
  GHC.Maybe.Maybe Data.Text.Internal.Text ->
  -- | type | Constraints: Maximum length of 5000
  GHC.Maybe.Maybe Data.Text.Internal.Text ->
  -- | verified: Only return recipients that are verified or unverified.
  GHC.Maybe.Maybe GHC.Types.Bool ->
  -- | The request body to send
  GHC.Maybe.Maybe GetRecipientsRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetRecipientsResponse))
getRecipients
  config
  created
  endingBefore
                          ...
                          : ( ( Data.Text.pack "limit",
                                ...
                                : ( ( Data.Text.pack "starting_after",
                                      ...
                                      : ( ( Data.Text.pack "type",
                                            ...
                                            : ( ( Data.Text.pack "verified",
                                                  StripeAPI.Common.stringifyModel Data.Functor.<$> verified
                                                )
                                                  : []
                                              )
                                        )
...
instance Data.Aeson.ToJSON GetRecipientsRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRecipientsRequestBody" (\obj -> GHC.Base.pure GetRecipientsRequestBody)
