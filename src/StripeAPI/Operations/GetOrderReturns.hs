...
instance Data.Aeson.Types.ToJSON.ToJSON GetOrderReturnsParametersQueryCreated'OneOf2 where
  toJSON obj = Data.Aeson.Types.Internal.object ("gt" Data.Aeson.Types.ToJSON..= getOrderReturnsParametersQueryCreated'OneOf2Gt obj : "gte" Data.Aeson.Types.ToJSON..= getOrderReturnsParametersQueryCreated'OneOf2Gte obj : "lt" Data.Aeson.Types.ToJSON..= getOrderReturnsParametersQueryCreated'OneOf2Lt obj : "lte" Data.Aeson.Types.ToJSON..= getOrderReturnsParametersQueryCreated'OneOf2Lte obj : [])
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("gt" Data.Aeson.Types.ToJSON..= getOrderReturnsParametersQueryCreated'OneOf2Gt obj) GHC.Base.<> (("gte" Data.Aeson.Types.ToJSON..= getOrderReturnsParametersQueryCreated'OneOf2Gte obj) GHC.Base.<> (("lt" Data.Aeson.Types.ToJSON..= getOrderReturnsParametersQueryCreated'OneOf2Lt obj) GHC.Base.<> ("lte" Data.Aeson.Types.ToJSON..= getOrderReturnsParametersQueryCreated'OneOf2Lte obj))))
...
-- | Create a new 'GetOrderReturnsParametersQueryCreated'OneOf2' with all required fields.
mkGetOrderReturnsParametersQueryCreated'OneOf2 :: GetOrderReturnsParametersQueryCreated'OneOf2
mkGetOrderReturnsParametersQueryCreated'OneOf2 =
  GetOrderReturnsParametersQueryCreated'OneOf2
    { getOrderReturnsParametersQueryCreated'OneOf2Gt = GHC.Maybe.Nothing,
      getOrderReturnsParametersQueryCreated'OneOf2Gte = GHC.Maybe.Nothing,
      getOrderReturnsParametersQueryCreated'OneOf2Lt = GHC.Maybe.Nothing,
      getOrderReturnsParametersQueryCreated'OneOf2Lte = GHC.Maybe.Nothing
    }
...
instance Data.Aeson.Types.FromJSON.FromJSON GetOrderReturnsParametersQueryCreated'Variants where
  parseJSON val = case (GetOrderReturnsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetOrderReturnsParametersQueryCreated'GetOrderReturnsParametersQueryCreated'OneOf2 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
