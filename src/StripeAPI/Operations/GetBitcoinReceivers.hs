...
getBitcoinReceivers :: forall m . StripeAPI.Common.MonadHTTP m => GetBitcoinReceiversParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetBitcoinReceiversResponse) -- ^ Monadic computation which returns the result of the operation
getBitcoinReceivers parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetBitcoinReceiversResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetBitcoinReceiversResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                               ...
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetBitcoinReceiversResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack "/v1/bitcoin/receivers") [StripeAPI.Common.QueryParameter (Data.Text.pack "active") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getBitcoinReceiversParametersQueryActive parameters) (Data.Text.pack "form") GHC.Types.True,
...
data GetBitcoinReceiversParameters = GetBitcoinReceiversParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetBitcoinReceiversParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetBitcoinReceiversParameters
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetBitcoinReceiversParameters" (\obj -> ((((((GHC.Base.pure GetBitcoinReceiversParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryActive")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryFilled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryUncaptured_funds"))
...
mkGetBitcoinReceiversParameters = GetBitcoinReceiversParameters{getBitcoinReceiversParametersQueryActive = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetBitcoinReceiversResponseBody200
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetBitcoinReceiversResponseBody200" (\obj -> ((GHC.Base.pure GetBitcoinReceiversResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'GetBitcoinReceiversResponseBody200' with all required fields.
mkGetBitcoinReceiversResponseBody200 :: [BitcoinReceiver] -- ^ 'getBitcoinReceiversResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getBitcoinReceiversResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getBitcoinReceiversResponseBody200Url'
  -> GetBitcoinReceiversResponseBody200
mkGetBitcoinReceiversResponseBody200 getBitcoinReceiversResponseBody200Data getBitcoinReceiversResponseBody200HasMore getBitcoinReceiversResponseBody200Url = GetBitcoinReceiversResponseBody200{getBitcoinReceiversResponseBody200Data = getBitcoinReceiversResponseBody200Data,
