...
getChargesChargeRefunds ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetChargesChargeRefundsResponse)
getChargesChargeRefunds parameters =
  GHC.Base.fmap
    ...
    ( StripeAPI.Common.doCallWithConfigurationM
        ...
        ("/v1/charges/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getChargesChargeRefundsParametersPathCharge parameters))) GHC.Base.<> "/refunds"))
        [ StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getChargesChargeRefundsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
