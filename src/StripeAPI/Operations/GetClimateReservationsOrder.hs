...
getClimateReservationsOrder ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  GetClimateReservationsOrderParameters ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetClimateReservationsOrderResponse)
getClimateReservationsOrder parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetClimateReservationsOrderResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if
                                 | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetClimateReservationsOrderResponse200
                                 ...
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetClimateReservationsOrderResponseDefault
                                       Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                            Data.Either.Either
                                                              GHC.Base.String
                                                              Error
...
instance Data.Aeson.Types.ToJSON.ToJSON GetClimateReservationsOrderParameters where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathOrder" Data.Aeson.Types.ToJSON..= getClimateReservationsOrderParametersPathOrder obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getClimateReservationsOrderParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetClimateReservationsOrderParameters where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetClimateReservationsOrderParameters" (\obj -> (GHC.Base.pure GetClimateReservationsOrderParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathOrder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))

-- | Create a new 'GetClimateReservationsOrderParameters' with all required fields.
mkGetClimateReservationsOrderParameters ::
  -- | 'getClimateReservationsOrderParametersPathOrder'
  Data.Text.Internal.Text ->
  GetClimateReservationsOrderParameters
mkGetClimateReservationsOrderParameters getClimateReservationsOrderParametersPathOrder =
  GetClimateReservationsOrderParameters
    { getClimateReservationsOrderParametersPathOrder = getClimateReservationsOrderParametersPathOrder,
...
data GetClimateReservationsOrderResponse
  = -- | Means either no matching case available or a parse error
    GetClimateReservationsOrderResponseError GHC.Base.String
  | -- | Successful response.
    GetClimateReservationsOrderResponse200 Climate'order
  | -- | Error response.
    GetClimateReservationsOrderResponseDefault Error
