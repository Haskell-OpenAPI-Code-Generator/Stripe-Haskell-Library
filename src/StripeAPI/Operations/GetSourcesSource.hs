...
getSourcesSource ::
  ...
  -- | client_secret: The client secret of the source. Required if a publishable key is used to retrieve the source. | Constraints: Maximum length of 5000
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetSourcesSourceResponse))
getSourcesSource
  config
  clientSecret
  expand
  ...
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/sources/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel source)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetSourcesSourceRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetSourcesSourceRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSourcesSourceRequestBody" (\obj -> GHC.Base.pure GetSourcesSourceRequestBody)
