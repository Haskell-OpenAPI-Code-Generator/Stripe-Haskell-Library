...
getSourcesSource ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetSourcesSourceResponse)
getSourcesSource parameters =
  GHC.Base.fmap
    ...
    ( StripeAPI.Common.doCallWithConfigurationM
        ...
        ("/v1/sources/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getSourcesSourceParametersPathSource parameters))) GHC.Base.<> ""))
        [ StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "client_secret") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSourcesSourceParametersQueryClientSecret parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
