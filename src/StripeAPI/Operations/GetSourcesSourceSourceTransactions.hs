...
getSourcesSourceSourceTransactions ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetSourcesSourceSourceTransactionsResponse)
...
instance Data.Aeson.ToJSON GetSourcesSourceSourceTransactionsParameters where
...
-- | > GET /v1/sources/{source}/source_transactions
--
-- The same as 'getSourcesSourceSourceTransactions' but accepts an explicit configuration.
getSourcesSourceSourceTransactionsWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetSourcesSourceSourceTransactionsParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetSourcesSourceSourceTransactionsResponse)
getSourcesSourceSourceTransactionsWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getSourcesSourceSourceTransactionsRaw parameters =
  GHC.Base.id
    ( StripeAPI.Common.doCallWithConfigurationM
        (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET")
        (Data.Text.pack ("/v1/sources/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getSourcesSourceSourceTransactionsParametersPathSource parameters))) GHC.Base.++ "/source_transactions")))
...
-- | > GET /v1/sources/{source}/source_transactions
--
-- The same as 'getSourcesSourceSourceTransactions' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getSourcesSourceSourceTransactionsWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
