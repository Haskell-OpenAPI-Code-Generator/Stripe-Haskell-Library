...
getSourcesSourceSourceTransactions ::
  ...
  GHC.Maybe.Maybe GetSourcesSourceSourceTransactionsRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetSourcesSourceSourceTransactionsResponse))
getSourcesSourceSourceTransactions
  config
  endingBefore
  expand
  ...
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/sources/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel source)) GHC.Base.++ "/source_transactions")))
...
getSourcesSourceSourceTransactionsRaw ::
  forall m s.
...
getSourcesSourceSourceTransactionsM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
getSourcesSourceSourceTransactionsRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetSourcesSourceSourceTransactionsRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetSourcesSourceSourceTransactionsRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSourcesSourceSourceTransactionsRequestBody" (\obj -> GHC.Base.pure GetSourcesSourceSourceTransactionsRequestBody)
...
instance Data.Aeson.ToJSON GetSourcesSourceSourceTransactionsResponseBody200 where
...
instance Data.Aeson.ToJSON GetSourcesSourceSourceTransactionsResponseBody200Object' where
...
instance Data.Aeson.FromJSON GetSourcesSourceSourceTransactionsResponseBody200Object' where
  parseJSON val =
    GHC.Base.pure
