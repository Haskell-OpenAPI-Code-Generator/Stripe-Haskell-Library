...
getSourcesSourceSourceTransactions parameters =
  GHC.Base.fmap
    ...
    ( StripeAPI.Common.doCallWithConfigurationM
        ...
        ("/v1/sources/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getSourcesSourceSourceTransactionsParametersPathSource parameters))) GHC.Base.<> "/source_transactions"))
        [ StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSourcesSourceSourceTransactionsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
