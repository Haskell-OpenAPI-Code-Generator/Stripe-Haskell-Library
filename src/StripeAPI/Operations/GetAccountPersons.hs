...
getAccountPersons ::
  ...
  GHC.Maybe.Maybe GetAccountPersonsRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetAccountPersonsResponse))
getAccountPersons
  config
  endingBefore
  expand
...
instance Data.Aeson.ToJSON GetAccountPersonsRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetAccountPersonsRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountPersonsRequestBody" (\obj -> GHC.Base.pure GetAccountPersonsRequestBody)
