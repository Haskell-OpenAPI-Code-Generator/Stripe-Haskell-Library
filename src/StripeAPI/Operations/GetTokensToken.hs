...
getTokensToken ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetTokensTokenResponse))
getTokensToken
  config
  expand
  token
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/tokens/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel token)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetTokensTokenRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetTokensTokenRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTokensTokenRequestBody" (\obj -> GHC.Base.pure GetTokensTokenRequestBody)
