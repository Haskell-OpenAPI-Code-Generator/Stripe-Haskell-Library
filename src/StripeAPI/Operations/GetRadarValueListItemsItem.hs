...
instance Data.Aeson.ToJSON GetRadarValueListItemsItemParameters where
...
-- | > GET /v1/radar/value_list_items/{item}
--
-- The same as 'getRadarValueListItemsItem' but accepts an explicit configuration.
getRadarValueListItemsItemWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetRadarValueListItemsItemParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetRadarValueListItemsItemResponse)
getRadarValueListItemsItemWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/radar/value_list_items/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getRadarValueListItemsItemParametersPathItem parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getRadarValueListItemsItemParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])
...
getRadarValueListItemsItemRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/radar/value_list_items/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getRadarValueListItemsItemParametersPathItem parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getRadarValueListItemsItemParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/radar/value_list_items/{item}
--
-- The same as 'getRadarValueListItemsItem' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getRadarValueListItemsItemWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
