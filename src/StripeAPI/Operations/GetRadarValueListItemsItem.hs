...
getRadarValueListItemsItem ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetRadarValueListItemsItemResponse))
getRadarValueListItemsItem
  config
  expand
  item
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/radar/value_list_items/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel item)) GHC.Base.++ "")))
...
getRadarValueListItemsItemRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetRadarValueListItemsItemRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetRadarValueListItemsItemRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRadarValueListItemsItemRequestBody" (\obj -> GHC.Base.pure GetRadarValueListItemsItemRequestBody)
