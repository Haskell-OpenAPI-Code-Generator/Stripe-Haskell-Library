...
postAccountsAccountLoginLinks :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostAccountsAccountLoginLinksRequestBody
    = PostAccountsAccountLoginLinksRequestBody {postAccountsAccountLoginLinksRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
...
data PostAccountsAccountLoginLinksResponse
    = PostAccountsAccountLoginLinksResponseError GHC.Base.String
    | PostAccountsAccountLoginLinksResponse200 LoginLink
