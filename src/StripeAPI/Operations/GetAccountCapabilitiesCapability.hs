...
getAccountCapabilitiesCapability ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetAccountCapabilitiesCapabilityResponse)
getAccountCapabilitiesCapability parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetAccountCapabilitiesCapabilityResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if  | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                   GetAccountCapabilitiesCapabilityResponse200
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            Capability
                                                      )
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                   GetAccountCapabilitiesCapabilityResponseDefault
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            Error
                                                      )
...
instance Data.Aeson.ToJSON GetAccountCapabilitiesCapabilityParameters where
...
-- | > GET /v1/account/capabilities/{capability}
--
-- The same as 'getAccountCapabilitiesCapability' but accepts an explicit configuration.
getAccountCapabilitiesCapabilityWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetAccountCapabilitiesCapabilityParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetAccountCapabilitiesCapabilityResponse)
getAccountCapabilitiesCapabilityWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/account/capabilities/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getAccountCapabilitiesCapabilityParametersPathCapability parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getAccountCapabilitiesCapabilityParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/account/capabilities/{capability}
--
-- The same as 'getAccountCapabilitiesCapability' but returns the raw 'Data.ByteString.Char8.ByteString'.
getAccountCapabilitiesCapabilityRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  GetAccountCapabilitiesCapabilityParameters ->
...
-- | > GET /v1/account/capabilities/{capability}
--
-- The same as 'getAccountCapabilitiesCapability' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getAccountCapabilitiesCapabilityWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
