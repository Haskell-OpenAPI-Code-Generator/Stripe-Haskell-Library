...
getAccountCapabilitiesCapability :: forall m . StripeAPI.Common.MonadHTTP m => GetAccountCapabilitiesCapabilityParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetAccountCapabilitiesCapabilityResponse) -- ^ Monadic computation which returns the result of the operation
...
data GetAccountCapabilitiesCapabilityParameters = GetAccountCapabilitiesCapabilityParameters {
  ...
  , getAccountCapabilitiesCapabilityParametersQueryExpand :: (GHC.Maybe.Maybe ([Data.Text.Internal.Text]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAccountCapabilitiesCapabilityParameters
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathCapability" Data.Aeson.Types.ToJSON..= getAccountCapabilitiesCapabilityParametersPathCapability obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getAccountCapabilitiesCapabilityParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetAccountCapabilitiesCapabilityParameters
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountCapabilitiesCapabilityParameters" (\obj -> (GHC.Base.pure GetAccountCapabilitiesCapabilityParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCapability")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))
-- | Create a new 'GetAccountCapabilitiesCapabilityParameters' with all required fields.
mkGetAccountCapabilitiesCapabilityParameters :: Data.Text.Internal.Text -- ^ 'getAccountCapabilitiesCapabilityParametersPathCapability'
  -> GetAccountCapabilitiesCapabilityParameters
mkGetAccountCapabilitiesCapabilityParameters getAccountCapabilitiesCapabilityParametersPathCapability = GetAccountCapabilitiesCapabilityParameters{getAccountCapabilitiesCapabilityParametersPathCapability = getAccountCapabilitiesCapabilityParametersPathCapability,
