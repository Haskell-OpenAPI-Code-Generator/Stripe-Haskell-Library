...
getAccountCapabilitiesCapability ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetAccountCapabilitiesCapabilityResponse))
getAccountCapabilitiesCapability
  config
  capability
  expand
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/account/capabilities/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel capability)) GHC.Base.++ "")))
...
getAccountCapabilitiesCapabilityM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
getAccountCapabilitiesCapabilityRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetAccountCapabilitiesCapabilityRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetAccountCapabilitiesCapabilityRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountCapabilitiesCapabilityRequestBody" (\obj -> GHC.Base.pure GetAccountCapabilitiesCapabilityRequestBody)
