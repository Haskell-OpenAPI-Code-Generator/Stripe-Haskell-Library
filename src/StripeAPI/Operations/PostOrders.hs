...
--
-- POST /v1/orders
postOrders :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostOrdersRequestBody
    = PostOrdersRequestBody {postOrdersRequestBodyCoupon :: (GHC.Maybe.Maybe GHC.Base.String),
...
data PostOrdersRequestBodyItems'
    = PostOrdersRequestBodyItems' {postOrdersRequestBodyItems'Amount :: (GHC.Maybe.Maybe GHC.Integer.Type.Integer),
...
data PostOrdersRequestBodyShipping'
    = PostOrdersRequestBodyShipping' {postOrdersRequestBodyShipping'Address :: PostOrdersRequestBodyShipping'Address',
...
data PostOrdersRequestBodyShipping'Address'
    = PostOrdersRequestBodyShipping'Address' {postOrdersRequestBodyShipping'Address'City :: (GHC.Maybe.Maybe GHC.Base.String),
