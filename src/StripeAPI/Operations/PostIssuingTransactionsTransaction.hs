...
postIssuingTransactionsTransaction ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostIssuingTransactionsTransactionResponse)
postIssuingTransactionsTransaction
  transaction
  body =
    GHC.Base.fmap
...
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingTransactionsTransactionRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object ("expand" Data.Aeson.Types.ToJSON..= postIssuingTransactionsTransactionRequestBodyExpand obj : "metadata" Data.Aeson.Types.ToJSON..= postIssuingTransactionsTransactionRequestBodyMetadata obj : GHC.Base.mempty)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingTransactionsTransactionRequestBodyMetadata'Variants where
  parseJSON val =
    if
        | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingTransactionsTransactionRequestBodyMetadata'EmptyString
