...
postPaymentMethodsPaymentMethodDetach ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostPaymentMethodsPaymentMethodDetachResponse))
postPaymentMethodsPaymentMethodDetach
  config
  paymentMethod
  body =
...
postPaymentMethodsPaymentMethodDetachM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
