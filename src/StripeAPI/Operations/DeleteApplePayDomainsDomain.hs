...
deleteApplePayDomainsDomain ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response DeleteApplePayDomainsDomainResponse))
deleteApplePayDomainsDomain
  config
  domain
  body =
...
deleteApplePayDomainsDomainRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON DeleteApplePayDomainsDomainRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON DeleteApplePayDomainsDomainRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "DeleteApplePayDomainsDomainRequestBody" (\obj -> GHC.Base.pure DeleteApplePayDomainsDomainRequestBody)
