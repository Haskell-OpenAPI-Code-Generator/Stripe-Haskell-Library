...
postTerminalReadersReaderProcessSetupIntent ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTerminalReadersReaderProcessSetupIntentResponse)
postTerminalReadersReaderProcessSetupIntent
  reader
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostTerminalReadersReaderProcessSetupIntentResponseError GHC.Base.id
...
mkPostTerminalReadersReaderProcessSetupIntentRequestBody ::
  ...
  Data.Text.Internal.Text ->
  PostTerminalReadersReaderProcessSetupIntentRequestBody
mkPostTerminalReadersReaderProcessSetupIntentRequestBody postTerminalReadersReaderProcessSetupIntentRequestBodyCustomerConsentCollected postTerminalReadersReaderProcessSetupIntentRequestBodySetupIntent =
  PostTerminalReadersReaderProcessSetupIntentRequestBody
...
data PostTerminalReadersReaderProcessSetupIntentResponse
  = -- | Means either no matching case available or a parse error
    PostTerminalReadersReaderProcessSetupIntentResponseError GHC.Base.String
  | -- | Successful response.
    PostTerminalReadersReaderProcessSetupIntentResponse200 Terminal'reader
  | -- | Error response.
    PostTerminalReadersReaderProcessSetupIntentResponseDefault Error
