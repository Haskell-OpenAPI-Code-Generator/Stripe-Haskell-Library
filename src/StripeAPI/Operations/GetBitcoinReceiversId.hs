...
getBitcoinReceiversId :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data GetBitcoinReceiversIdResponse
    = GetBitcoinReceiversIdResponseError GHC.Base.String
    | GetBitcoinReceiversIdResponse200 BitcoinReceiver
