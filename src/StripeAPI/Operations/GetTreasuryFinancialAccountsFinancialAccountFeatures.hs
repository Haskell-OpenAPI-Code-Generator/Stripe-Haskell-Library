...
getTreasuryFinancialAccountsFinancialAccountFeatures ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTreasuryFinancialAccountsFinancialAccountFeaturesResponse)
getTreasuryFinancialAccountsFinancialAccountFeatures parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetTreasuryFinancialAccountsFinancialAccountFeaturesResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if
                                 | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetTreasuryFinancialAccountsFinancialAccountFeaturesResponse200
                                 ...
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetTreasuryFinancialAccountsFinancialAccountFeaturesResponseDefault
                                       Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                            Data.Either.Either
                                                              GHC.Base.String
                                                              Error
...
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryFinancialAccountsFinancialAccountFeaturesParameters where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathFinancial_account" Data.Aeson.Types.ToJSON..= getTreasuryFinancialAccountsFinancialAccountFeaturesParametersPathFinancialAccount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getTreasuryFinancialAccountsFinancialAccountFeaturesParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryFinancialAccountsFinancialAccountFeaturesParameters where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTreasuryFinancialAccountsFinancialAccountFeaturesParameters" (\obj -> (GHC.Base.pure GetTreasuryFinancialAccountsFinancialAccountFeaturesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathFinancial_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))

-- | Create a new 'GetTreasuryFinancialAccountsFinancialAccountFeaturesParameters' with all required fields.
mkGetTreasuryFinancialAccountsFinancialAccountFeaturesParameters ::
  -- | 'getTreasuryFinancialAccountsFinancialAccountFeaturesParametersPathFinancialAccount'
  Data.Text.Internal.Text ->
  GetTreasuryFinancialAccountsFinancialAccountFeaturesParameters
mkGetTreasuryFinancialAccountsFinancialAccountFeaturesParameters getTreasuryFinancialAccountsFinancialAccountFeaturesParametersPathFinancialAccount =
  GetTreasuryFinancialAccountsFinancialAccountFeaturesParameters
    { getTreasuryFinancialAccountsFinancialAccountFeaturesParametersPathFinancialAccount = getTreasuryFinancialAccountsFinancialAccountFeaturesParametersPathFinancialAccount,
...
data GetTreasuryFinancialAccountsFinancialAccountFeaturesResponse
  = -- | Means either no matching case available or a parse error
    GetTreasuryFinancialAccountsFinancialAccountFeaturesResponseError GHC.Base.String
  | -- | Successful response.
    GetTreasuryFinancialAccountsFinancialAccountFeaturesResponse200 Treasury'financialAccountFeatures
  | -- | Error response.
    GetTreasuryFinancialAccountsFinancialAccountFeaturesResponseDefault Error
