...
postRecipients :: forall m . StripeAPI.Common.MonadHTTP m => PostRecipientsRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostRecipientsResponse) -- ^ Monadic computation which returns the result of the operation
postRecipients body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostRecipientsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostRecipientsResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                             Recipient)
                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostRecipientsResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                               Error)
                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/v1/recipients") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostRecipientsRequestBody = PostRecipientsRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostRecipientsRequestBody
...
mkPostRecipientsRequestBody :: Data.Text.Internal.Text -- ^ 'postRecipientsRequestBodyName'
  -> Data.Text.Internal.Text -- ^ 'postRecipientsRequestBodyType'
  -> PostRecipientsRequestBody
mkPostRecipientsRequestBody postRecipientsRequestBodyName postRecipientsRequestBodyType = PostRecipientsRequestBody{postRecipientsRequestBodyBankAccount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostRecipientsRequestBodyMetadata'Variants
    where toJSON (PostRecipientsRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostRecipientsRequestBodyMetadata'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostRecipientsRequestBodyMetadata'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostRecipientsRequestBodyMetadata'EmptyString
