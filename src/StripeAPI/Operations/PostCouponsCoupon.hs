...
postCouponsCoupon :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostCouponsCouponRequestBody
    = PostCouponsCouponRequestBody {postCouponsCouponRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
