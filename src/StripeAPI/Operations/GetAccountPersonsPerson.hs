...
getAccountPersonsPerson ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetAccountPersonsPersonResponse)
...
-- | Defines the data type for the schema getAccountPersonsPersonParameters
data GetAccountPersonsPersonParameters
  = GetAccountPersonsPersonParameters
...
instance Data.Aeson.ToJSON GetAccountPersonsPersonParameters where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "pathPerson" (getAccountPersonsPersonParametersPathPerson obj) : (Data.Aeson..=) "queryExpand" (getAccountPersonsPersonParametersQueryExpand obj) : [])
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "pathPerson" (getAccountPersonsPersonParametersPathPerson obj) GHC.Base.<> (Data.Aeson..=) "queryExpand" (getAccountPersonsPersonParametersQueryExpand obj))
...
-- | > GET /v1/account/persons/{person}
--
-- The same as 'getAccountPersonsPerson' but accepts an explicit configuration.
getAccountPersonsPersonWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetAccountPersonsPersonParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetAccountPersonsPersonResponse)
getAccountPersonsPersonWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/account/persons/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getAccountPersonsPersonParametersPathPerson parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getAccountPersonsPersonParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])
...
getAccountPersonsPersonRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/account/persons/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getAccountPersonsPersonParametersPathPerson parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getAccountPersonsPersonParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/account/persons/{person}
--
-- The same as 'getAccountPersonsPerson' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getAccountPersonsPersonWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
