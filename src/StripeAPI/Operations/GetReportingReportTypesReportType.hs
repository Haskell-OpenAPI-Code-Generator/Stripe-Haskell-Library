...
getReportingReportTypesReportType ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetReportingReportTypesReportTypeResponse))
getReportingReportTypesReportType
  config
  expand
  reportType
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/reporting/report_types/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel reportType)) GHC.Base.++ "")))
...
getReportingReportTypesReportTypeM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
getReportingReportTypesReportTypeRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetReportingReportTypesReportTypeRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetReportingReportTypesReportTypeRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetReportingReportTypesReportTypeRequestBody" (\obj -> GHC.Base.pure GetReportingReportTypesReportTypeRequestBody)
