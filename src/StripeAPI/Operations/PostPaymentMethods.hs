...
postPaymentMethods :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostPaymentMethodsRequestBody
    = PostPaymentMethodsRequestBody {postPaymentMethodsRequestBodyBillingDetails :: (GHC.Maybe.Maybe PostPaymentMethodsRequestBodyBillingDetails'),
...
data PostPaymentMethodsRequestBodyBillingDetails'
    = PostPaymentMethodsRequestBodyBillingDetails' {postPaymentMethodsRequestBodyBillingDetails'Address :: (GHC.Maybe.Maybe PostPaymentMethodsRequestBodyBillingDetails'Address'),
...
data PostPaymentMethodsRequestBodyBillingDetails'Address'
    = PostPaymentMethodsRequestBodyBillingDetails'Address' {postPaymentMethodsRequestBodyBillingDetails'Address'City :: (GHC.Maybe.Maybe GHC.Base.String),
...
data PostPaymentMethodsRequestBodyCard'
    = PostPaymentMethodsRequestBodyCard' {postPaymentMethodsRequestBodyCard'Cvc :: (GHC.Maybe.Maybe GHC.Base.String),
...
data PostPaymentMethodsRequestBodyIdeal'
    = PostPaymentMethodsRequestBodyIdeal' {postPaymentMethodsRequestBodyIdeal'Bank :: (GHC.Maybe.Maybe PostPaymentMethodsRequestBodyIdeal'Bank')}
    deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data PostPaymentMethodsRequestBodySepaDebit'
    = PostPaymentMethodsRequestBodySepaDebit' {postPaymentMethodsRequestBodySepaDebit'Iban :: GHC.Base.String}
    deriving (GHC.Show.Show, GHC.Classes.Eq)
