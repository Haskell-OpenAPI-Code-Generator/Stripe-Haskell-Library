...
mkGetTerminalReadersReaderResponseBody200Action'NonNullable = GetTerminalReadersReaderResponseBody200Action'NonNullable{getTerminalReadersReaderResponseBody200Action'NonNullableFailureCode = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200Action'NonNullableType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "process_payment_intent" -> GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumProcessPaymentIntent
