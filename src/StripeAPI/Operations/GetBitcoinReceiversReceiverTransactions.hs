...
getBitcoinReceiversReceiverTransactions :: forall m s . (StripeAPI.Common.MonadHTTP m, StripeAPI.Common.SecurityScheme s) => StripeAPI.Common.Configuration s  -- ^ The configuration to use in the request
  ...
  -> GetBitcoinReceiversReceiverTransactionsRequestBody                                                                                                  -- ^ The request body to send
...
-- 
-- 
data GetBitcoinReceiversReceiverTransactionsRequestBody = GetBitcoinReceiversReceiverTransactionsRequestBody {
...
data GetBitcoinReceiversReceiverTransactionsResponse =                                                         
   GetBitcoinReceiversReceiverTransactionsResponseError GHC.Base.String                                        -- ^ Means either no matching case available or a parse error
