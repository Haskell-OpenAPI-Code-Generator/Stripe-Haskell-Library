...
deleteAccountsAccount ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response DeleteAccountsAccountResponse)
deleteAccountsAccount account =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either DeleteAccountsAccountResponseError GHC.Base.id
    ...
    (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/v1/accounts/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel account)) GHC.Base.++ ""))) [])
...
-- | > DELETE /v1/accounts/{account}
--
-- The same as 'deleteAccountsAccount' but accepts an explicit configuration.
deleteAccountsAccountWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  Data.Text.Internal.Text ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response DeleteAccountsAccountResponse)
deleteAccountsAccountWithConfiguration
  config
  account =
    GHC.Base.fmap
...
deleteAccountsAccountRaw account = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/v1/accounts/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel account)) GHC.Base.++ ""))) [])

-- | > DELETE /v1/accounts/{account}
--
-- The same as 'deleteAccountsAccount' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
deleteAccountsAccountWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
...
deleteAccountsAccountWithConfigurationRaw
  config
  account = GHC.Base.id (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/v1/accounts/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel account)) GHC.Base.++ ""))) [])
