...
getAccount ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetAccountResponse)
getAccount expand =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
    ...
    (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/account" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> expand) (Data.Text.Internal.pack "deepObject") GHC.Types.True])
