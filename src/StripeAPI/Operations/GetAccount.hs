...
getAccount ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetAccountResponse))
getAccount
  config
  expand
  body =
...
instance Data.Aeson.ToJSON GetAccountRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetAccountRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountRequestBody" (\obj -> GHC.Base.pure GetAccountRequestBody)
