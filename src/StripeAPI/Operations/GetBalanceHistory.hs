...
getBalanceHistory ::
  ...
  GHC.Maybe.Maybe GetBalanceHistoryRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetBalanceHistoryResponse))
getBalanceHistory
  config
  availableOn
  created
...
instance Data.Aeson.ToJSON GetBalanceHistoryRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetBalanceHistoryRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetBalanceHistoryRequestBody" (\obj -> GHC.Base.pure GetBalanceHistoryRequestBody)
