...
postTerminalReadersReaderProcessPaymentIntent reader
                                              body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTerminalReadersReaderProcessPaymentIntentResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalReadersReaderProcessPaymentIntentResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Terminal'reader)
                                                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalReadersReaderProcessPaymentIntentResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                            Error)
...
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderProcessPaymentIntentRequestBodyProcessConfig'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("skip_tipping" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderProcessPaymentIntentRequestBodyProcessConfig'SkipTipping obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderProcessPaymentIntentRequestBodyProcessConfig'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTerminalReadersReaderProcessPaymentIntentRequestBodyProcessConfig'" (\obj -> GHC.Base.pure PostTerminalReadersReaderProcessPaymentIntentRequestBodyProcessConfig' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "skip_tipping"))
