...
getCustomersCustomerSubscriptions ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetCustomersCustomerSubscriptionsResponse)
...
instance Data.Aeson.ToJSON GetCustomersCustomerSubscriptionsParameters where
...
-- | > GET /v1/customers/{customer}/subscriptions
--
-- The same as 'getCustomersCustomerSubscriptions' but accepts an explicit configuration.
getCustomersCustomerSubscriptionsWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetCustomersCustomerSubscriptionsParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetCustomersCustomerSubscriptionsResponse)
getCustomersCustomerSubscriptionsWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getCustomersCustomerSubscriptionsRaw parameters =
  GHC.Base.id
    ( StripeAPI.Common.doCallWithConfigurationM
        (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET")
        (Data.Text.pack ("/v1/customers/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getCustomersCustomerSubscriptionsParametersPathCustomer parameters))) GHC.Base.++ "/subscriptions")))
...
-- | > GET /v1/customers/{customer}/subscriptions
--
-- The same as 'getCustomersCustomerSubscriptions' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getCustomersCustomerSubscriptionsWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
