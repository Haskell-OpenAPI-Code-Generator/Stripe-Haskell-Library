...
instance Data.Aeson.ToJSON DeleteAccountsAccountExternalAccountsIdParameters where
...
-- | > DELETE /v1/accounts/{account}/external_accounts/{id}
--
-- The same as 'deleteAccountsAccountExternalAccountsId' but accepts an explicit configuration.
deleteAccountsAccountExternalAccountsIdWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  DeleteAccountsAccountExternalAccountsIdParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response DeleteAccountsAccountExternalAccountsIdResponse)
deleteAccountsAccountExternalAccountsIdWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
-- | > DELETE /v1/accounts/{account}/external_accounts/{id}
--
-- The same as 'deleteAccountsAccountExternalAccountsId' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
deleteAccountsAccountExternalAccountsIdWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
