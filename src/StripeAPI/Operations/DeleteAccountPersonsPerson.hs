...
deleteAccountPersonsPerson :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ person | Constraints: Maximum length of 5000
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteAccountPersonsPersonResponse) -- ^ Monadic computation which returns the result of the operation
deleteAccountPersonsPerson person = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteAccountPersonsPersonResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteAccountPersonsPersonResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                   DeletedPerson)
