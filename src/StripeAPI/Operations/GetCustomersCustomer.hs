...
getCustomersCustomer parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCustomersCustomerResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerResponseBody200Discount'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerResponseBody200Discount'NonNullable" (\obj -> ((((((((((GHC.Base.pure GetCustomersCustomerResponseBody200Discount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "checkout_session")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "end")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice_item")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "object")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotion_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "start")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "subscription"))
...
data GetCustomersCustomerResponseBody200Sources'Data'Object' =
  ...
  | GetCustomersCustomerResponseBody200Sources'Data'Object'EnumAlipayAccount -- ^ Represents the JSON value @"alipay_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerResponseBody200Sources'Data'Object'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "alipay_account" -> GetCustomersCustomerResponseBody200Sources'Data'Object'EnumAlipayAccount
...
data GetCustomersCustomerResponseBody200Sources'Data'Recipient'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCustomersCustomerResponseBody200Sources'Data'Recipient'NonNullableVariants
    where toJSON (GetCustomersCustomerResponseBody200Sources'Data'Recipient'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (GetCustomersCustomerResponseBody200Sources'Data'Recipient'NonNullableRecipient a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerResponseBody200Sources'Data'Recipient'NonNullableVariants
    where parseJSON val = case (GetCustomersCustomerResponseBody200Sources'Data'Recipient'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetCustomersCustomerResponseBody200Sources'Data'Recipient'NonNullableRecipient Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
data GetCustomersCustomerResponseBody200Sources'Data'Transactions' = GetCustomersCustomerResponseBody200Sources'Data'Transactions' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCustomersCustomerResponseBody200Sources'Data'Transactions'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getCustomersCustomerResponseBody200Sources'Data'Transactions'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getCustomersCustomerResponseBody200Sources'Data'Transactions'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getCustomersCustomerResponseBody200Sources'Data'Transactions'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
...
mkGetCustomersCustomerResponseBody200Sources'Data'Transactions' :: [BitcoinTransaction] -- ^ 'getCustomersCustomerResponseBody200Sources'Data'Transactions'Data'
  -> GHC.Types.Bool -- ^ 'getCustomersCustomerResponseBody200Sources'Data'Transactions'HasMore'
  -> Data.Text.Internal.Text -- ^ 'getCustomersCustomerResponseBody200Sources'Data'Transactions'Url'
  -> GetCustomersCustomerResponseBody200Sources'Data'Transactions'
mkGetCustomersCustomerResponseBody200Sources'Data'Transactions' getCustomersCustomerResponseBody200Sources'Data'Transactions'Data getCustomersCustomerResponseBody200Sources'Data'Transactions'HasMore getCustomersCustomerResponseBody200Sources'Data'Transactions'Url = GetCustomersCustomerResponseBody200Sources'Data'Transactions'{getCustomersCustomerResponseBody200Sources'Data'Transactions'Data = getCustomersCustomerResponseBody200Sources'Data'Transactions'Data,
