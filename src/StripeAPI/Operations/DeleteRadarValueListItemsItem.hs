...
deleteRadarValueListItemsItem :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data DeleteRadarValueListItemsItemResponse
    = DeleteRadarValueListItemsItemResponseError GHC.Base.String
    | DeleteRadarValueListItemsItemResponse200 DeletedRadar'valueListItem
