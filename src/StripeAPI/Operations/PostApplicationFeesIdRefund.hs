...
postApplicationFeesIdRefund ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostApplicationFeesIdRefundResponse))
postApplicationFeesIdRefund
  config
  id
  body =
...
postApplicationFeesIdRefundRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
