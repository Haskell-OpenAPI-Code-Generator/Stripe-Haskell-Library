...
instance Data.Aeson.ToJSON PostApplicationFeesIdRefundRequestBody where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "amount" (postApplicationFeesIdRefundRequestBodyAmount obj) : (Data.Aeson..=) "directive" (postApplicationFeesIdRefundRequestBodyDirective obj) : (Data.Aeson..=) "expand" (postApplicationFeesIdRefundRequestBodyExpand obj) : [])
...
-- | > POST /v1/application_fees/{id}/refund
--
-- The same as 'postApplicationFeesIdRefund' but accepts an explicit configuration.
postApplicationFeesIdRefundWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GHC.Maybe.Maybe PostApplicationFeesIdRefundRequestBody ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response PostApplicationFeesIdRefundResponse)
postApplicationFeesIdRefundWithConfiguration
  config
  id
  body =
...
postApplicationFeesIdRefundRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | id | Constraints: Maximum length of 5000
  Data.Text.Internal.Text ->
...
-- | > POST /v1/application_fees/{id}/refund
--
-- The same as 'postApplicationFeesIdRefund' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
postApplicationFeesIdRefundWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
