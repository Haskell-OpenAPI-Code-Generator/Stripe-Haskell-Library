...
getIssuingTransactionsTransaction ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetIssuingTransactionsTransactionResponse))
getIssuingTransactionsTransaction
  config
  expand
  transaction
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/issuing/transactions/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel transaction)) GHC.Base.++ "")))
...
getIssuingTransactionsTransactionRaw ::
  forall m s.
...
getIssuingTransactionsTransactionM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
getIssuingTransactionsTransactionRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetIssuingTransactionsTransactionRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingTransactionsTransactionRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuingTransactionsTransactionRequestBody" (\obj -> GHC.Base.pure GetIssuingTransactionsTransactionRequestBody)
