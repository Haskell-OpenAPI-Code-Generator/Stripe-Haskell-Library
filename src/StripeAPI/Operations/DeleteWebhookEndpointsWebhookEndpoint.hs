...
deleteWebhookEndpointsWebhookEndpoint ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response DeleteWebhookEndpointsWebhookEndpointResponse)
deleteWebhookEndpointsWebhookEndpoint webhookEndpoint =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either DeleteWebhookEndpointsWebhookEndpointResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if  | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                   DeleteWebhookEndpointsWebhookEndpointResponse200
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            DeletedWebhookEndpoint
                                                      )
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                   DeleteWebhookEndpointsWebhookEndpointResponseDefault
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            Error
                                                      )
...
-- | > DELETE /v1/webhook_endpoints/{webhook_endpoint}
--
-- The same as 'deleteWebhookEndpointsWebhookEndpoint' but accepts an explicit configuration.
deleteWebhookEndpointsWebhookEndpointWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  Data.Text.Internal.Text ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response DeleteWebhookEndpointsWebhookEndpointResponse)
deleteWebhookEndpointsWebhookEndpointWithConfiguration
  config
  webhookEndpoint =
    GHC.Base.fmap
...
deleteWebhookEndpointsWebhookEndpointRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | webhook_endpoint | Constraints: Maximum length of 5000
  Data.Text.Internal.Text ->
...
deleteWebhookEndpointsWebhookEndpointRaw webhookEndpoint = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/v1/webhook_endpoints/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel webhookEndpoint)) GHC.Base.++ ""))) [])

-- | > DELETE /v1/webhook_endpoints/{webhook_endpoint}
--
-- The same as 'deleteWebhookEndpointsWebhookEndpoint' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
deleteWebhookEndpointsWebhookEndpointWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
