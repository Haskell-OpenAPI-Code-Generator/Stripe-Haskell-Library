...
postInvoicesInvoiceMarkUncollectible ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostInvoicesInvoiceMarkUncollectibleResponse))
postInvoicesInvoiceMarkUncollectible
  config
  invoice
  body =
...
postInvoicesInvoiceMarkUncollectibleM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
postInvoicesInvoiceMarkUncollectibleRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
