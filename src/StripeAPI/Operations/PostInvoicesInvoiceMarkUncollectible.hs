...
postInvoicesInvoiceMarkUncollectible :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostInvoicesInvoiceMarkUncollectibleRequestBody
    = PostInvoicesInvoiceMarkUncollectibleRequestBody {postInvoicesInvoiceMarkUncollectibleRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String))}
