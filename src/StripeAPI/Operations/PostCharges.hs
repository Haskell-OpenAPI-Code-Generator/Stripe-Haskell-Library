...
postCharges body =
  GHC.Base.fmap
    ...
    (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/charges" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostChargesRequestBody = PostChargesRequestBody
  { -- | amount: Amount intended to be collected by this payment. A positive integer representing how much to charge in the [smallest currency unit](https:\/\/stripe.com\/docs\/currencies\#zero-decimal) (e.g., 100 cents to charge \$1.00 or 100 to charge ¥100, a zero-decimal currency). The minimum amount is \$0.50 US or [equivalent in charge currency](https:\/\/stripe.com\/docs\/currencies\#minimum-and-maximum-charge-amounts). The amount value supports up to eight digits (e.g., a value of 99999999 for a USD charge of \$999,999.99).
    ...
    -- | on_behalf_of: The Stripe account ID for which these funds are intended. Automatically set if you use the \`destination\` parameter. For details, see [Creating Separate Charges and Transfers](https:\/\/stripe.com\/docs\/connect\/separate-charges-and-transfers\#on-behalf-of).
    --
    -- Constraints:
    --
...
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyRadarOptions' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("session" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyRadarOptions'Session obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesRequestBodyRadarOptions' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostChargesRequestBodyRadarOptions'" (\obj -> GHC.Base.pure PostChargesRequestBodyRadarOptions' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "session"))
...
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyTransferData' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyTransferData'Amount obj) : ["destination" Data.Aeson.Types.ToJSON..= postChargesRequestBodyTransferData'Destination obj] : GHC.Base.mempty))
