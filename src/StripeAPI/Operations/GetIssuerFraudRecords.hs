...
getIssuerFraudRecords :: forall m . StripeAPI.Common.MonadHTTP m => GetIssuerFraudRecordsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetIssuerFraudRecordsResponse) -- ^ Monadic computation which returns the result of the operation
getIssuerFraudRecords parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetIssuerFraudRecordsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetIssuerFraudRecordsResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
data GetIssuerFraudRecordsParameters = GetIssuerFraudRecordsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuerFraudRecordsParameters
...
mkGetIssuerFraudRecordsParameters = GetIssuerFraudRecordsParameters{getIssuerFraudRecordsParametersQueryCharge = GHC.Maybe.Nothing,
...
data GetIssuerFraudRecordsResponseBody200 = GetIssuerFraudRecordsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuerFraudRecordsResponseBody200
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getIssuerFraudRecordsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getIssuerFraudRecordsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getIssuerFraudRecordsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuerFraudRecordsResponseBody200
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuerFraudRecordsResponseBody200" (\obj -> ((GHC.Base.pure GetIssuerFraudRecordsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'GetIssuerFraudRecordsResponseBody200' with all required fields.
mkGetIssuerFraudRecordsResponseBody200 :: [IssuerFraudRecord] -- ^ 'getIssuerFraudRecordsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getIssuerFraudRecordsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getIssuerFraudRecordsResponseBody200Url'
  -> GetIssuerFraudRecordsResponseBody200
mkGetIssuerFraudRecordsResponseBody200 getIssuerFraudRecordsResponseBody200Data getIssuerFraudRecordsResponseBody200HasMore getIssuerFraudRecordsResponseBody200Url = GetIssuerFraudRecordsResponseBody200{getIssuerFraudRecordsResponseBody200Data = getIssuerFraudRecordsResponseBody200Data,
