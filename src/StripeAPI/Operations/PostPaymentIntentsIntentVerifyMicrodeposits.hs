...
postPaymentIntentsIntentVerifyMicrodeposits ::
  ...
  GHC.Maybe.Maybe PostPaymentIntentsIntentVerifyMicrodepositsRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostPaymentIntentsIntentVerifyMicrodepositsResponse)
postPaymentIntentsIntentVerifyMicrodeposits
  intent
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostPaymentIntentsIntentVerifyMicrodepositsResponseError GHC.Base.id
                GHC.Base.. ( \response body ->
                               if
                                   | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostPaymentIntentsIntentVerifyMicrodepositsResponse200
                                   ...
                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                       PostPaymentIntentsIntentVerifyMicrodepositsResponseDefault
                                         Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                              Data.Either.Either
                                                                GHC.Base.String
                                                                Error
...
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentIntentsIntentVerifyMicrodepositsRequestBody where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentIntentsIntentVerifyMicrodepositsRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPaymentIntentsIntentVerifyMicrodepositsRequestBody" (\obj -> (((GHC.Base.pure PostPaymentIntentsIntentVerifyMicrodepositsRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "client_secret")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "descriptor_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))
...
mkPostPaymentIntentsIntentVerifyMicrodepositsRequestBody =
  PostPaymentIntentsIntentVerifyMicrodepositsRequestBody
    { postPaymentIntentsIntentVerifyMicrodepositsRequestBodyAmounts = GHC.Maybe.Nothing,
...
data PostPaymentIntentsIntentVerifyMicrodepositsResponse
  = -- | Means either no matching case available or a parse error
    PostPaymentIntentsIntentVerifyMicrodepositsResponseError GHC.Base.String
  | -- | Successful response.
    PostPaymentIntentsIntentVerifyMicrodepositsResponse200 PaymentIntent
  | -- | Error response.
    PostPaymentIntentsIntentVerifyMicrodepositsResponseDefault Error
