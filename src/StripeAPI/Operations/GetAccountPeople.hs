...
getAccountPeople :: forall m s . (StripeAPI.Common.MonadHTTP m, StripeAPI.Common.SecurityScheme s) => StripeAPI.Common.Configuration s  -- ^ The configuration to use in the request
  ...
  -> m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetAccountPeopleResponse)) -- ^ Monad containing the result of the operation
...
-- | > GET /v1/account/people
-- 
-- Monadic version of 'getAccountPeople' (use with 'StripeAPI.Common.runWithConfiguration')
...
-- | > GET /v1/account/people
-- 
-- Monadic version of 'getAccountPeopleRaw' (use with 'StripeAPI.Common.runWithConfiguration')
