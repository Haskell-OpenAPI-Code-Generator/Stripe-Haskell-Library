...
-- | > POST /v1/invoices/{invoice}/void
--
-- The same as 'postInvoicesInvoiceVoid' but accepts an explicit configuration.
postInvoicesInvoiceVoidWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GHC.Maybe.Maybe PostInvoicesInvoiceVoidRequestBody ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response PostInvoicesInvoiceVoidResponse)
postInvoicesInvoiceVoidWithConfiguration
  config
  invoice
  body =
...
-- | > POST /v1/invoices/{invoice}/void
--
-- The same as 'postInvoicesInvoiceVoid' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
postInvoicesInvoiceVoidWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
