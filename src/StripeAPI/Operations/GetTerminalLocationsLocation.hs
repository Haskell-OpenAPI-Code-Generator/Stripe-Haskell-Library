...
getTerminalLocationsLocation ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetTerminalLocationsLocationResponse)
...
-- | Defines the data type for the schema getTerminalLocationsLocationParameters
data GetTerminalLocationsLocationParameters
  = GetTerminalLocationsLocationParameters
...
instance Data.Aeson.ToJSON GetTerminalLocationsLocationParameters where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "pathLocation" (getTerminalLocationsLocationParametersPathLocation obj) : (Data.Aeson..=) "queryExpand" (getTerminalLocationsLocationParametersQueryExpand obj) : [])
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "pathLocation" (getTerminalLocationsLocationParametersPathLocation obj) GHC.Base.<> (Data.Aeson..=) "queryExpand" (getTerminalLocationsLocationParametersQueryExpand obj))
...
-- | > GET /v1/terminal/locations/{location}
--
-- The same as 'getTerminalLocationsLocation' but accepts an explicit configuration.
getTerminalLocationsLocationWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetTerminalLocationsLocationParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetTerminalLocationsLocationResponse)
getTerminalLocationsLocationWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/terminal/locations/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getTerminalLocationsLocationParametersPathLocation parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTerminalLocationsLocationParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/terminal/locations/{location}
--
-- The same as 'getTerminalLocationsLocation' but returns the raw 'Data.ByteString.Char8.ByteString'.
getTerminalLocationsLocationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  GetTerminalLocationsLocationParameters ->
...
getTerminalLocationsLocationRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/terminal/locations/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getTerminalLocationsLocationParametersPathLocation parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTerminalLocationsLocationParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/terminal/locations/{location}
--
-- The same as 'getTerminalLocationsLocation' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getTerminalLocationsLocationWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
