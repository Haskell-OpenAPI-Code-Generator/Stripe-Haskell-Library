...
postLinkAccountSessions ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostLinkAccountSessionsResponse)
postLinkAccountSessions body =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either PostLinkAccountSessionsResponseError GHC.Base.id
...
mkPostLinkAccountSessionsRequestBody ::
  ...
  PostLinkAccountSessionsRequestBodyAccountHolder' ->
  -- | 'postLinkAccountSessionsRequestBodyPermissions'
  [PostLinkAccountSessionsRequestBodyPermissions'] ->
  PostLinkAccountSessionsRequestBody
mkPostLinkAccountSessionsRequestBody postLinkAccountSessionsRequestBodyAccountHolder postLinkAccountSessionsRequestBodyPermissions =
  PostLinkAccountSessionsRequestBody
    { postLinkAccountSessionsRequestBodyAccountHolder = postLinkAccountSessionsRequestBodyAccountHolder,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostLinkAccountSessionsRequestBodyAccountHolder' where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostLinkAccountSessionsRequestBodyAccountHolder' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostLinkAccountSessionsRequestBodyAccountHolder'" (\obj -> ((GHC.Base.pure PostLinkAccountSessionsRequestBodyAccountHolder' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))

-- | Create a new 'PostLinkAccountSessionsRequestBodyAccountHolder'' with all required fields.
mkPostLinkAccountSessionsRequestBodyAccountHolder' ::
  -- | 'postLinkAccountSessionsRequestBodyAccountHolder'Type'
  PostLinkAccountSessionsRequestBodyAccountHolder'Type' ->
  PostLinkAccountSessionsRequestBodyAccountHolder'
mkPostLinkAccountSessionsRequestBodyAccountHolder' postLinkAccountSessionsRequestBodyAccountHolder'Type =
  PostLinkAccountSessionsRequestBodyAccountHolder'
    { postLinkAccountSessionsRequestBodyAccountHolder'Account = GHC.Maybe.Nothing,
...
data PostLinkAccountSessionsRequestBodyAccountHolder'Type'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PostLinkAccountSessionsRequestBodyAccountHolder'Type'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostLinkAccountSessionsRequestBodyAccountHolder'Type'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"account"@
    PostLinkAccountSessionsRequestBodyAccountHolder'Type'EnumAccount
  | -- | Represents the JSON value @"customer"@
    PostLinkAccountSessionsRequestBodyAccountHolder'Type'EnumCustomer
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostLinkAccountSessionsRequestBodyAccountHolder'Type' where
  toJSON (PostLinkAccountSessionsRequestBodyAccountHolder'Type'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostLinkAccountSessionsRequestBodyAccountHolder'Type' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "account" -> PostLinkAccountSessionsRequestBodyAccountHolder'Type'EnumAccount
...
instance Data.Aeson.Types.ToJSON.ToJSON PostLinkAccountSessionsRequestBodyFilters' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["countries" Data.Aeson.Types.ToJSON..= postLinkAccountSessionsRequestBodyFilters'Countries obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostLinkAccountSessionsRequestBodyFilters' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostLinkAccountSessionsRequestBodyFilters'" (\obj -> GHC.Base.pure PostLinkAccountSessionsRequestBodyFilters' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "countries"))

-- | Create a new 'PostLinkAccountSessionsRequestBodyFilters'' with all required fields.
mkPostLinkAccountSessionsRequestBodyFilters' ::
  -- | 'postLinkAccountSessionsRequestBodyFilters'Countries'
...
data PostLinkAccountSessionsRequestBodyPermissions'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PostLinkAccountSessionsRequestBodyPermissions'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostLinkAccountSessionsRequestBodyPermissions'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"balances"@
    PostLinkAccountSessionsRequestBodyPermissions'EnumBalances
  | -- | Represents the JSON value @"ownership"@
    PostLinkAccountSessionsRequestBodyPermissions'EnumOwnership
  | -- | Represents the JSON value @"payment_method"@
    PostLinkAccountSessionsRequestBodyPermissions'EnumPaymentMethod
  | -- | Represents the JSON value @"transactions"@
    PostLinkAccountSessionsRequestBodyPermissions'EnumTransactions
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostLinkAccountSessionsRequestBodyPermissions' where
  toJSON (PostLinkAccountSessionsRequestBodyPermissions'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostLinkAccountSessionsRequestBodyPermissions' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "balances" -> PostLinkAccountSessionsRequestBodyPermissions'EnumBalances
...
data PostLinkAccountSessionsResponse
  = -- | Means either no matching case available or a parse error
    PostLinkAccountSessionsResponseError GHC.Base.String
  | -- | Successful response.
    PostLinkAccountSessionsResponse200 FinancialConnections'session
  | -- | Error response.
    PostLinkAccountSessionsResponseDefault Error
  deriving (GHC.Show.Show, GHC.Classes.Eq)
