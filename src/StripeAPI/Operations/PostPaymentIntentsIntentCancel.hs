...
postPaymentIntentsIntentCancel ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostPaymentIntentsIntentCancelResponse))
postPaymentIntentsIntentCancel
  config
  intent
  body =
...
postPaymentIntentsIntentCancelM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
postPaymentIntentsIntentCancelRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
