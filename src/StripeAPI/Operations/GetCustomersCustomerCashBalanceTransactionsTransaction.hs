...
getCustomersCustomerCashBalanceTransactionsTransaction ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCustomersCustomerCashBalanceTransactionsTransactionResponse)
getCustomersCustomerCashBalanceTransactionsTransaction parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetCustomersCustomerCashBalanceTransactionsTransactionResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if
                                 | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetCustomersCustomerCashBalanceTransactionsTransactionResponse200
                                 ...
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetCustomersCustomerCashBalanceTransactionsTransactionResponseDefault
                                       Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                            Data.Either.Either
                                                              GHC.Base.String
                                                              Error
...
instance Data.Aeson.Types.ToJSON.ToJSON GetCustomersCustomerCashBalanceTransactionsTransactionParameters where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathCustomer" Data.Aeson.Types.ToJSON..= getCustomersCustomerCashBalanceTransactionsTransactionParametersPathCustomer obj] : ["pathTransaction" Data.Aeson.Types.ToJSON..= getCustomersCustomerCashBalanceTransactionsTransactionParametersPathTransaction obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getCustomersCustomerCashBalanceTransactionsTransactionParametersQueryExpand obj) : GHC.Base.mempty))
...
mkGetCustomersCustomerCashBalanceTransactionsTransactionParameters ::
  ...
  -- | 'getCustomersCustomerCashBalanceTransactionsTransactionParametersPathTransaction'
  Data.Text.Internal.Text ->
  GetCustomersCustomerCashBalanceTransactionsTransactionParameters
mkGetCustomersCustomerCashBalanceTransactionsTransactionParameters getCustomersCustomerCashBalanceTransactionsTransactionParametersPathCustomer getCustomersCustomerCashBalanceTransactionsTransactionParametersPathTransaction =
  GetCustomersCustomerCashBalanceTransactionsTransactionParameters
    { getCustomersCustomerCashBalanceTransactionsTransactionParametersPathCustomer = getCustomersCustomerCashBalanceTransactionsTransactionParametersPathCustomer,
...
data GetCustomersCustomerCashBalanceTransactionsTransactionResponse
  = -- | Means either no matching case available or a parse error
    GetCustomersCustomerCashBalanceTransactionsTransactionResponseError GHC.Base.String
  | -- | Successful response.
    GetCustomersCustomerCashBalanceTransactionsTransactionResponse200 CustomerCashBalanceTransaction
  | -- | Error response.
    GetCustomersCustomerCashBalanceTransactionsTransactionResponseDefault Error
