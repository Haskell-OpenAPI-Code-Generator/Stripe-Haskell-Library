...
postTopupsTopupCancel ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response PostTopupsTopupCancelResponse)
postTopupsTopupCancel
  topup
  body =
    GHC.Base.fmap
...
instance Data.Aeson.ToJSON PostTopupsTopupCancelRequestBody where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "expand" (postTopupsTopupCancelRequestBodyExpand obj) : [])
...
-- | > POST /v1/topups/{topup}/cancel
--
-- The same as 'postTopupsTopupCancel' but accepts an explicit configuration.
postTopupsTopupCancelWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GHC.Maybe.Maybe PostTopupsTopupCancelRequestBody ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response PostTopupsTopupCancelResponse)
postTopupsTopupCancelWithConfiguration
  config
  topup
  body =
...
-- | > POST /v1/topups/{topup}/cancel
--
-- The same as 'postTopupsTopupCancel' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
postTopupsTopupCancelWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
