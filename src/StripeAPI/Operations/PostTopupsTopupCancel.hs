...
postTopupsTopupCancel ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostTopupsTopupCancelResponse))
postTopupsTopupCancel
  config
  topup
  body =
