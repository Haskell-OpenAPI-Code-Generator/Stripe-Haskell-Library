...
getExchangeRatesCurrency ::
  ...
  -- | currency | Constraints: Maximum length of 3
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetExchangeRatesCurrencyResponse))
getExchangeRatesCurrency
  config
  currency
  expand
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/exchange_rates/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel currency)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetExchangeRatesCurrencyRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetExchangeRatesCurrencyRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetExchangeRatesCurrencyRequestBody" (\obj -> GHC.Base.pure GetExchangeRatesCurrencyRequestBody)
