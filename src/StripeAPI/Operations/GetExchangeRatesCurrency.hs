...
instance Data.Aeson.ToJSON GetExchangeRatesCurrencyParameters where
...
-- | > GET /v1/exchange_rates/{currency}
--
-- The same as 'getExchangeRatesCurrency' but accepts an explicit configuration.
getExchangeRatesCurrencyWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetExchangeRatesCurrencyParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetExchangeRatesCurrencyResponse)
getExchangeRatesCurrencyWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/exchange_rates/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getExchangeRatesCurrencyParametersPathCurrency parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getExchangeRatesCurrencyParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/exchange_rates/{currency}
--
-- The same as 'getExchangeRatesCurrency' but returns the raw 'Data.ByteString.Char8.ByteString'.
getExchangeRatesCurrencyRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  GetExchangeRatesCurrencyParameters ->
...
-- | > GET /v1/exchange_rates/{currency}
--
-- The same as 'getExchangeRatesCurrency' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getExchangeRatesCurrencyWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
