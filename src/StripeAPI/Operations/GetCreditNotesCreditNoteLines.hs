...
getCreditNotesCreditNoteLines ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCreditNotesCreditNoteLinesResponse)
getCreditNotesCreditNoteLines parameters =
  GHC.Base.fmap
    ...
    ( StripeAPI.Common.doCallWithConfigurationM
        ...
        ("/v1/credit_notes/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getCreditNotesCreditNoteLinesParametersPathCreditNote parameters))) GHC.Base.<> "/lines"))
        [ StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCreditNotesCreditNoteLinesParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
