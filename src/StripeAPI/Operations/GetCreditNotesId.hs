...
-- | Defines the data type for the schema getCreditNotesIdParameters
...
instance Data.Aeson.ToJSON GetCreditNotesIdParameters where
  toJSON obj = Data.Aeson.object ((Data.Aeson..=) "pathId" (getCreditNotesIdParametersPathId obj) : (Data.Aeson..=) "queryExpand" (getCreditNotesIdParametersQueryExpand obj) : [])
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "pathId" (getCreditNotesIdParametersPathId obj) GHC.Base.<> (Data.Aeson..=) "queryExpand" (getCreditNotesIdParametersQueryExpand obj))
...
-- | > GET /v1/credit_notes/{id}
--
-- The same as 'getCreditNotesId' but accepts an explicit configuration.
getCreditNotesIdWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetCreditNotesIdParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetCreditNotesIdResponse)
getCreditNotesIdWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/credit_notes/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getCreditNotesIdParametersPathId parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCreditNotesIdParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])
...
getCreditNotesIdRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/credit_notes/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getCreditNotesIdParametersPathId parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCreditNotesIdParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/credit_notes/{id}
--
-- The same as 'getCreditNotesId' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getCreditNotesIdWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
