...
postSources body =
  GHC.Base.fmap
    ...
    (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/sources" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSourcesRequestBodyMandate'Acceptance'Offline' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["contact_email" Data.Aeson.Types.ToJSON..= postSourcesRequestBodyMandate'Acceptance'Offline'ContactEmail obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSourcesRequestBodyReceiver' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund_attributes_method" Data.Aeson.Types.ToJSON..=)) (postSourcesRequestBodyReceiver'RefundAttributesMethod obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSourcesRequestBodyRedirect' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["return_url" Data.Aeson.Types.ToJSON..= postSourcesRequestBodyRedirect'ReturnUrl obj] : GHC.Base.mempty))
