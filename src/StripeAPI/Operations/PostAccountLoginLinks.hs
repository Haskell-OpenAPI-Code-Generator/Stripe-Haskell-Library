...
postAccountLoginLinks :: forall m . StripeAPI.Common.MonadHTTP m => PostAccountLoginLinksRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostAccountLoginLinksResponse) -- ^ Monadic computation which returns the result of the operation
postAccountLoginLinks body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountLoginLinksResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountLoginLinksResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                  LoginLink)
                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostAccountLoginLinksResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/v1/account/login_links") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostAccountLoginLinksRequestBody = PostAccountLoginLinksRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountLoginLinksRequestBody
...
mkPostAccountLoginLinksRequestBody :: Data.Text.Internal.Text -- ^ 'postAccountLoginLinksRequestBodyAccount'
  -> PostAccountLoginLinksRequestBody
mkPostAccountLoginLinksRequestBody postAccountLoginLinksRequestBodyAccount = PostAccountLoginLinksRequestBody{postAccountLoginLinksRequestBodyAccount = postAccountLoginLinksRequestBodyAccount,
