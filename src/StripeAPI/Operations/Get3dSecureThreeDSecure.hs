...
instance Data.Aeson.ToJSON Get3dSecureThreeDSecureParameters where
...
-- | > GET /v1/3d_secure/{three_d_secure}
--
-- The same as 'get3dSecureThreeDSecure' but accepts an explicit configuration.
get3dSecureThreeDSecureWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  Get3dSecureThreeDSecureParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response Get3dSecureThreeDSecureResponse)
get3dSecureThreeDSecureWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/3d_secure/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (get3dSecureThreeDSecureParametersPathThreeDSecure parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> get3dSecureThreeDSecureParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/3d_secure/{three_d_secure}
--
-- The same as 'get3dSecureThreeDSecure' but returns the raw 'Data.ByteString.Char8.ByteString'.
get3dSecureThreeDSecureRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  Get3dSecureThreeDSecureParameters ->
...
get3dSecureThreeDSecureRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/3d_secure/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (get3dSecureThreeDSecureParametersPathThreeDSecure parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> get3dSecureThreeDSecureParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/3d_secure/{three_d_secure}
--
-- The same as 'get3dSecureThreeDSecure' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
get3dSecureThreeDSecureWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
