...
get3dSecureThreeDSecure :: forall m . StripeAPI.Common.MonadHTTP m => Get3dSecureThreeDSecureParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response Get3dSecureThreeDSecureResponse) -- ^ Monadic computation which returns the result of the operation
get3dSecureThreeDSecure parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either Get3dSecureThreeDSecureResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> Get3dSecureThreeDSecureResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                              ThreeDSecure)
...
data Get3dSecureThreeDSecureParameters = Get3dSecureThreeDSecureParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Get3dSecureThreeDSecureParameters
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathThree_d_secure" Data.Aeson.Types.ToJSON..= get3dSecureThreeDSecureParametersPathThreeDSecure obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (get3dSecureThreeDSecureParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON Get3dSecureThreeDSecureParameters
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "Get3dSecureThreeDSecureParameters" (\obj -> (GHC.Base.pure Get3dSecureThreeDSecureParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathThree_d_secure")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))
-- | Create a new 'Get3dSecureThreeDSecureParameters' with all required fields.
mkGet3dSecureThreeDSecureParameters :: Data.Text.Internal.Text -- ^ 'get3dSecureThreeDSecureParametersPathThreeDSecure'
  -> Get3dSecureThreeDSecureParameters
mkGet3dSecureThreeDSecureParameters get3dSecureThreeDSecureParametersPathThreeDSecure = Get3dSecureThreeDSecureParameters{get3dSecureThreeDSecureParametersPathThreeDSecure = get3dSecureThreeDSecureParametersPathThreeDSecure,
