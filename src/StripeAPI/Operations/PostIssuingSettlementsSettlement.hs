...
postIssuingSettlementsSettlement ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostIssuingSettlementsSettlementResponse))
postIssuingSettlementsSettlement
  config
  settlement
  body =
...
postIssuingSettlementsSettlementRaw ::
  forall m s.
...
postIssuingSettlementsSettlementM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
postIssuingSettlementsSettlementRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON PostIssuingSettlementsSettlementRequestBody where
...
instance Data.Aeson.ToJSON PostIssuingSettlementsSettlementRequestBodyMetadata' where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingSettlementsSettlementRequestBodyMetadata' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostIssuingSettlementsSettlementRequestBodyMetadata'" (\obj -> GHC.Base.pure PostIssuingSettlementsSettlementRequestBodyMetadata')
