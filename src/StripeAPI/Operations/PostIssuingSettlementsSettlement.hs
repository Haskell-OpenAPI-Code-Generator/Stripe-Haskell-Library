...
postIssuingSettlementsSettlement :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostIssuingSettlementsSettlementRequestBody
    = PostIssuingSettlementsSettlementRequestBody {postIssuingSettlementsSettlementRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
...
data PostIssuingSettlementsSettlementResponse
    = PostIssuingSettlementsSettlementResponseError GHC.Base.String
    | PostIssuingSettlementsSettlementResponse200 Issuing'settlement
