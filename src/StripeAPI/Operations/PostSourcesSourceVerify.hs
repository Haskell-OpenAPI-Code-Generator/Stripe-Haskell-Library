...
postSourcesSourceVerify :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostSourcesSourceVerifyRequestBody
    = PostSourcesSourceVerifyRequestBody {postSourcesSourceVerifyRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
