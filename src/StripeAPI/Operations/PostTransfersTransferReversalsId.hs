...
postTransfersTransferReversalsId ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response PostTransfersTransferReversalsIdResponse)
postTransfersTransferReversalsId
  parameters
  body =
    GHC.Base.fmap
...
instance Data.Aeson.ToJSON PostTransfersTransferReversalsIdParameters where
...
data PostTransfersTransferReversalsIdRequestBody
  = PostTransfersTransferReversalsIdRequestBody
      { -- | expand: Specifies which fields in the response should be expanded.
        ...
        postTransfersTransferReversalsIdRequestBodyMetadata :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
      }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
-- | > POST /v1/transfers/{transfer}/reversals/{id}
--
-- The same as 'postTransfersTransferReversalsId' but accepts an explicit configuration.
postTransfersTransferReversalsIdWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GHC.Maybe.Maybe PostTransfersTransferReversalsIdRequestBody ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response PostTransfersTransferReversalsIdResponse)
postTransfersTransferReversalsIdWithConfiguration
  config
  parameters
  body =
...
-- | > POST /v1/transfers/{transfer}/reversals/{id}
--
-- The same as 'postTransfersTransferReversalsId' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
postTransfersTransferReversalsIdWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
