...
getChargesChargeRefundsRefund ::
  ...
  StripeAPI.Common.StripeT m (Network.HTTP.Client.Types.Response GetChargesChargeRefundsRefundResponse)
getChargesChargeRefundsRefund parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetChargesChargeRefundsRefundResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if  | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                   GetChargesChargeRefundsRefundResponse200
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            Refund
                                                      )
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                   GetChargesChargeRefundsRefundResponseDefault
                                     Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                          Data.Either.Either GHC.Base.String
                                                            Error
                                                      )
...
instance Data.Aeson.ToJSON GetChargesChargeRefundsRefundParameters where
...
-- | > GET /v1/charges/{charge}/refunds/{refund}
--
-- The same as 'getChargesChargeRefundsRefund' but accepts an explicit configuration.
getChargesChargeRefundsRefundWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetChargesChargeRefundsRefundParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetChargesChargeRefundsRefundResponse)
getChargesChargeRefundsRefundWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getChargesChargeRefundsRefundRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | Contains all available parameters of this operation (query and path parameters)
  GetChargesChargeRefundsRefundParameters ->
...
getChargesChargeRefundsRefundRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/charges/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getChargesChargeRefundsRefundParametersPathCharge parameters))) GHC.Base.++ ("/refunds/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getChargesChargeRefundsRefundParametersPathRefund parameters))) GHC.Base.++ ""))))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getChargesChargeRefundsRefundParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/charges/{charge}/refunds/{refund}
--
-- The same as 'getChargesChargeRefundsRefund' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getChargesChargeRefundsRefundWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
