...
postAccountsAccountExternalAccountsId :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostAccountsAccountExternalAccountsIdRequestBody
    = PostAccountsAccountExternalAccountsIdRequestBody {postAccountsAccountExternalAccountsIdRequestBodyAccountHolderName :: (GHC.Maybe.Maybe GHC.Base.String),
