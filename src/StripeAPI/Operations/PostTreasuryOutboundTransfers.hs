...
postTreasuryOutboundTransfers body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTreasuryOutboundTransfersResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTreasuryOutboundTransfersResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                          Treasury'outboundTransfer)
                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTreasuryOutboundTransfersResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                            Error)
                                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/v1/treasury/outbound_transfers") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
mkPostTreasuryOutboundTransfersRequestBody :: GHC.Types.Int -- ^ 'postTreasuryOutboundTransfersRequestBodyAmount'
  ...
  -> Data.Text.Internal.Text -- ^ 'postTreasuryOutboundTransfersRequestBodyDestinationPaymentMethod'
  -> Data.Text.Internal.Text -- ^ 'postTreasuryOutboundTransfersRequestBodyFinancialAccount'
  -> PostTreasuryOutboundTransfersRequestBody
mkPostTreasuryOutboundTransfersRequestBody postTreasuryOutboundTransfersRequestBodyAmount postTreasuryOutboundTransfersRequestBodyCurrency postTreasuryOutboundTransfersRequestBodyDestinationPaymentMethod postTreasuryOutboundTransfersRequestBodyFinancialAccount = PostTreasuryOutboundTransfersRequestBody{postTreasuryOutboundTransfersRequestBodyAmount = postTreasuryOutboundTransfersRequestBodyAmount,
...
data PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1 = PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (postTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1" (\obj -> GHC.Base.pure PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network"))
...
data PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network' =
   PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network'EnumAch -- ^ Represents the JSON value @"ach"@
  | PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network'EnumUsDomesticWire -- ^ Represents the JSON value @"us_domestic_wire"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network'
    where toJSON (PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach" -> PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1Network'EnumAch
...
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Variants
    where toJSON (PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'PostTreasuryOutboundTransfersRequestBodyDestinationPaymentMethodOptions'UsBankAccount'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a
