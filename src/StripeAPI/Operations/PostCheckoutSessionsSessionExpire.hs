...
postCheckoutSessionsSessionExpire ::
  ...
  GHC.Maybe.Maybe PostCheckoutSessionsSessionExpireRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostCheckoutSessionsSessionExpireResponse)
postCheckoutSessionsSessionExpire
  session
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostCheckoutSessionsSessionExpireResponseError GHC.Base.id
                GHC.Base.. ( \response body ->
                               if
                                   | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                     PostCheckoutSessionsSessionExpireResponse200
                                   ...
                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                     PostCheckoutSessionsSessionExpireResponseDefault
                                       Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                            Data.Either.Either
                                                              GHC.Base.String
                                                              Error
      ...
      (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack ("/v1/checkout/sessions/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel session)) GHC.Base.++ "/expire"))) GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
instance Data.Aeson.Types.ToJSON.ToJSON PostCheckoutSessionsSessionExpireRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postCheckoutSessionsSessionExpireRequestBodyExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCheckoutSessionsSessionExpireRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCheckoutSessionsSessionExpireRequestBody" (\obj -> GHC.Base.pure PostCheckoutSessionsSessionExpireRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))
...
data PostCheckoutSessionsSessionExpireResponse
  = -- | Means either no matching case available or a parse error
    PostCheckoutSessionsSessionExpireResponseError GHC.Base.String
  | -- | Successful response.
    PostCheckoutSessionsSessionExpireResponse200 Checkout'session
  | -- | Error response.
    PostCheckoutSessionsSessionExpireResponseDefault Error
