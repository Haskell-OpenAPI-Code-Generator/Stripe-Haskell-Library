...
deleteCustomersCustomerBankAccountsId :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data DeleteCustomersCustomerBankAccountsIdRequestBody
    = DeleteCustomersCustomerBankAccountsIdRequestBody {deleteCustomersCustomerBankAccountsIdRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String))}
...
data DeleteCustomersCustomerBankAccountsIdResponse
    ...
    | DeleteCustomersCustomerBankAccountsIdResponse200 GHC.Base.String
