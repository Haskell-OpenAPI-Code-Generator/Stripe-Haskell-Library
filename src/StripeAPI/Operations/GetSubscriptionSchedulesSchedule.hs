...
instance Data.Aeson.ToJSON GetSubscriptionSchedulesScheduleParameters where
...
-- | > GET /v1/subscription_schedules/{schedule}
--
-- The same as 'getSubscriptionSchedulesSchedule' but accepts an explicit configuration.
getSubscriptionSchedulesScheduleWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetSubscriptionSchedulesScheduleParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetSubscriptionSchedulesScheduleResponse)
getSubscriptionSchedulesScheduleWithConfiguration
  config
  parameters =
    GHC.Base.fmap
      ...
      (StripeAPI.Common.doCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/subscription_schedules/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getSubscriptionSchedulesScheduleParametersPathSchedule parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSubscriptionSchedulesScheduleParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])
...
getSubscriptionSchedulesScheduleRaw parameters = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET") (Data.Text.pack ("/v1/subscription_schedules/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getSubscriptionSchedulesScheduleParametersPathSchedule parameters))) GHC.Base.++ ""))) [StripeAPI.Common.QueryParameter (Data.Text.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSubscriptionSchedulesScheduleParametersQueryExpand parameters) (Data.Text.pack "deepObject") GHC.Types.True])

-- | > GET /v1/subscription_schedules/{schedule}
--
-- The same as 'getSubscriptionSchedulesSchedule' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getSubscriptionSchedulesScheduleWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
