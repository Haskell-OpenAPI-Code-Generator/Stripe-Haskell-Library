...
postQuotes ::
  ...
  GHC.Maybe.Maybe PostQuotesRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostQuotesResponse)
postQuotes body =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either PostQuotesResponseError GHC.Base.id
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBody where
...
data PostQuotesRequestBodyApplicationFeeAmount'Variants
  = -- | Represents the JSON value @""@
    PostQuotesRequestBodyApplicationFeeAmount'EmptyString
  | PostQuotesRequestBodyApplicationFeeAmount'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyApplicationFeeAmount'Variants where
  toJSON (PostQuotesRequestBodyApplicationFeeAmount'Int a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesRequestBodyApplicationFeeAmount'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyApplicationFeeAmount'Variants where
  parseJSON val =
    if
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyApplicationFeePercent'Variants where
  toJSON (PostQuotesRequestBodyApplicationFeePercent'Double a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesRequestBodyApplicationFeePercent'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyApplicationFeePercent'Variants where
  parseJSON val =
    if
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyAutomaticTax' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyAutomaticTax'Enabled obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyAutomaticTax' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyAutomaticTax'" (\obj -> GHC.Base.pure PostQuotesRequestBodyAutomaticTax' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled"))

-- | Create a new 'PostQuotesRequestBodyAutomaticTax'' with all required fields.
mkPostQuotesRequestBodyAutomaticTax' ::
  -- | 'postQuotesRequestBodyAutomaticTax'Enabled'
  GHC.Types.Bool ->
...
data PostQuotesRequestBodyCollectionMethod'
  ...
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostQuotesRequestBodyCollectionMethod'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"charge_automatically"@
    PostQuotesRequestBodyCollectionMethod'EnumChargeAutomatically
  | -- | Represents the JSON value @"send_invoice"@
    PostQuotesRequestBodyCollectionMethod'EnumSendInvoice
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyCollectionMethod' where
  toJSON (PostQuotesRequestBodyCollectionMethod'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyCollectionMethod' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "charge_automatically" -> PostQuotesRequestBodyCollectionMethod'EnumChargeAutomatically
...
data PostQuotesRequestBodyDefaultTaxRates'Variants
  = -- | Represents the JSON value @""@
    PostQuotesRequestBodyDefaultTaxRates'EmptyString
  | PostQuotesRequestBodyDefaultTaxRates'ListTText ([Data.Text.Internal.Text])
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyDefaultTaxRates'Variants where
  toJSON (PostQuotesRequestBodyDefaultTaxRates'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesRequestBodyDefaultTaxRates'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyDefaultTaxRates'Variants where
  parseJSON val =
    if
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyDiscounts'OneOf1 where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyDiscounts'OneOf1 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyDiscounts'OneOf1" (\obj -> (GHC.Base.pure PostQuotesRequestBodyDiscounts'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount"))
...
mkPostQuotesRequestBodyDiscounts'OneOf1 =
  PostQuotesRequestBodyDiscounts'OneOf1
    { postQuotesRequestBodyDiscounts'OneOf1Coupon = GHC.Maybe.Nothing,
...
data PostQuotesRequestBodyDiscounts'Variants
  = -- | Represents the JSON value @""@
    PostQuotesRequestBodyDiscounts'EmptyString
  | PostQuotesRequestBodyDiscounts'ListTPostQuotesRequestBodyDiscounts'OneOf1 ([PostQuotesRequestBodyDiscounts'OneOf1])
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyDiscounts'Variants where
  toJSON (PostQuotesRequestBodyDiscounts'ListTPostQuotesRequestBodyDiscounts'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesRequestBodyDiscounts'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyDiscounts'Variants where
  parseJSON val =
    if
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyFromQuote' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("is_revision" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyFromQuote'IsRevision obj) : ["quote" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyFromQuote'Quote obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyFromQuote' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyFromQuote'" (\obj -> (GHC.Base.pure PostQuotesRequestBodyFromQuote' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "is_revision")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "quote"))

-- | Create a new 'PostQuotesRequestBodyFromQuote'' with all required fields.
mkPostQuotesRequestBodyFromQuote' ::
  -- | 'postQuotesRequestBodyFromQuote'Quote'
  Data.Text.Internal.Text ->
  PostQuotesRequestBodyFromQuote'
mkPostQuotesRequestBodyFromQuote' postQuotesRequestBodyFromQuote'Quote =
  PostQuotesRequestBodyFromQuote'
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyInvoiceSettings' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("days_until_due" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyInvoiceSettings'DaysUntilDue obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyInvoiceSettings' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyInvoiceSettings'" (\obj -> GHC.Base.pure PostQuotesRequestBodyInvoiceSettings' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "days_until_due"))
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyLineItems' where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyLineItems' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyLineItems'" (\obj -> (((GHC.Base.pure PostQuotesRequestBodyLineItems' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "price")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "price_data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_rates"))
...
mkPostQuotesRequestBodyLineItems' =
  PostQuotesRequestBodyLineItems'
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyLineItems'PriceData' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyLineItems'PriceData'" (\obj -> (((((GHC.Base.pure PostQuotesRequestBodyLineItems'PriceData' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "product")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "recurring")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount_decimal"))

-- | Create a new 'PostQuotesRequestBodyLineItems'PriceData'' with all required fields.
mkPostQuotesRequestBodyLineItems'PriceData' ::
  -- | 'postQuotesRequestBodyLineItems'PriceData'Currency'
  Data.Text.Internal.Text ->
  -- | 'postQuotesRequestBodyLineItems'PriceData'Product'
  Data.Text.Internal.Text ->
  PostQuotesRequestBodyLineItems'PriceData'
mkPostQuotesRequestBodyLineItems'PriceData' postQuotesRequestBodyLineItems'PriceData'Currency postQuotesRequestBodyLineItems'PriceData'Product =
  PostQuotesRequestBodyLineItems'PriceData'
    { postQuotesRequestBodyLineItems'PriceData'Currency = postQuotesRequestBodyLineItems'PriceData'Currency,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyLineItems'PriceData'Recurring' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["interval" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyLineItems'PriceData'Recurring'Interval obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyLineItems'PriceData'Recurring'IntervalCount obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyLineItems'PriceData'Recurring' where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyLineItems'PriceData'Recurring'" (\obj -> (GHC.Base.pure PostQuotesRequestBodyLineItems'PriceData'Recurring' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count"))

-- | Create a new 'PostQuotesRequestBodyLineItems'PriceData'Recurring'' with all required fields.
mkPostQuotesRequestBodyLineItems'PriceData'Recurring' ::
  -- | 'postQuotesRequestBodyLineItems'PriceData'Recurring'Interval'
  PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval' ->
  PostQuotesRequestBodyLineItems'PriceData'Recurring'
mkPostQuotesRequestBodyLineItems'PriceData'Recurring' postQuotesRequestBodyLineItems'PriceData'Recurring'Interval =
  PostQuotesRequestBodyLineItems'PriceData'Recurring'
    { postQuotesRequestBodyLineItems'PriceData'Recurring'Interval = postQuotesRequestBodyLineItems'PriceData'Recurring'Interval,
...
data PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"day"@
    PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'EnumDay
  | -- | Represents the JSON value @"month"@
    PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'EnumMonth
  | -- | Represents the JSON value @"week"@
    PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'EnumWeek
  | -- | Represents the JSON value @"year"@
    PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'EnumYear
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval' where
  toJSON (PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "day" -> PostQuotesRequestBodyLineItems'PriceData'Recurring'Interval'EnumDay
...
data PostQuotesRequestBodyLineItems'PriceData'TaxBehavior'
  = -- | This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
    PostQuotesRequestBodyLineItems'PriceData'TaxBehavior'Other Data.Aeson.Types.Internal.Value
  | -- | This constructor can be used to send values to the server which are not present in the specification yet.
    PostQuotesRequestBodyLineItems'PriceData'TaxBehavior'Typed Data.Text.Internal.Text
  | -- | Represents the JSON value @"exclusive"@
    PostQuotesRequestBodyLineItems'PriceData'TaxBehavior'EnumExclusive
  | -- | Represents the JSON value @"inclusive"@
    PostQuotesRequestBodyLineItems'PriceData'TaxBehavior'EnumInclusive
  | -- | Represents the JSON value @"unspecified"@
    PostQuotesRequestBodyLineItems'PriceData'TaxBehavior'EnumUnspecified
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyLineItems'PriceData'TaxBehavior' where
  toJSON (PostQuotesRequestBodyLineItems'PriceData'TaxBehavior'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyLineItems'PriceData'TaxBehavior' where
  parseJSON val =
    GHC.Base.pure
      ( if
            | val GHC.Classes.== "exclusive" -> PostQuotesRequestBodyLineItems'PriceData'TaxBehavior'EnumExclusive
...
data PostQuotesRequestBodyLineItems'TaxRates'Variants
  = -- | Represents the JSON value @""@
    PostQuotesRequestBodyLineItems'TaxRates'EmptyString
  | PostQuotesRequestBodyLineItems'TaxRates'ListTText ([Data.Text.Internal.Text])
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyLineItems'TaxRates'Variants where
  toJSON (PostQuotesRequestBodyLineItems'TaxRates'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesRequestBodyLineItems'TaxRates'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyLineItems'TaxRates'Variants where
  parseJSON val =
    if
...
data PostQuotesRequestBodyOnBehalfOf'Variants
  = -- | Represents the JSON value @""@
    PostQuotesRequestBodyOnBehalfOf'EmptyString
  | PostQuotesRequestBodyOnBehalfOf'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyOnBehalfOf'Variants where
  toJSON (PostQuotesRequestBodyOnBehalfOf'Text a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesRequestBodyOnBehalfOf'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyOnBehalfOf'Variants where
  parseJSON val =
    if
...
data PostQuotesRequestBodySubscriptionData'EffectiveDate'Variants
  = -- | Represents the JSON value @"current_period_end"@
    PostQuotesRequestBodySubscriptionData'EffectiveDate'CurrentPeriodEnd
  | -- | Represents the JSON value @""@
    PostQuotesRequestBodySubscriptionData'EffectiveDate'EmptyString
  | PostQuotesRequestBodySubscriptionData'EffectiveDate'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodySubscriptionData'EffectiveDate'Variants where
  toJSON (PostQuotesRequestBodySubscriptionData'EffectiveDate'Int a) = Data.Aeson.Types.ToJSON.toJSON a
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodySubscriptionData'EffectiveDate'Variants where
  parseJSON val =
    if
...
data PostQuotesRequestBodySubscriptionData'TrialPeriodDays'Variants
  = -- | Represents the JSON value @""@
    PostQuotesRequestBodySubscriptionData'TrialPeriodDays'EmptyString
  | PostQuotesRequestBodySubscriptionData'TrialPeriodDays'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodySubscriptionData'TrialPeriodDays'Variants where
  toJSON (PostQuotesRequestBodySubscriptionData'TrialPeriodDays'Int a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesRequestBodySubscriptionData'TrialPeriodDays'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodySubscriptionData'TrialPeriodDays'Variants where
  parseJSON val =
    if
...
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyTransferData'OneOf1 where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyTransferData'OneOf1 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyTransferData'OneOf1" (\obj -> ((GHC.Base.pure PostQuotesRequestBodyTransferData'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_percent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "destination"))

-- | Create a new 'PostQuotesRequestBodyTransferData'OneOf1' with all required fields.
mkPostQuotesRequestBodyTransferData'OneOf1 ::
  -- | 'postQuotesRequestBodyTransferData'OneOf1Destination'
  Data.Text.Internal.Text ->
  PostQuotesRequestBodyTransferData'OneOf1
mkPostQuotesRequestBodyTransferData'OneOf1 postQuotesRequestBodyTransferData'OneOf1Destination =
  PostQuotesRequestBodyTransferData'OneOf1
    { postQuotesRequestBodyTransferData'OneOf1Amount = GHC.Maybe.Nothing,
...
data PostQuotesRequestBodyTransferData'Variants
  = -- | Represents the JSON value @""@
    PostQuotesRequestBodyTransferData'EmptyString
  | PostQuotesRequestBodyTransferData'PostQuotesRequestBodyTransferData'OneOf1 PostQuotesRequestBodyTransferData'OneOf1
  deriving (GHC.Show.Show, GHC.Classes.Eq)

instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyTransferData'Variants where
  toJSON (PostQuotesRequestBodyTransferData'PostQuotesRequestBodyTransferData'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a
  toJSON (PostQuotesRequestBodyTransferData'EmptyString) = ""

instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyTransferData'Variants where
  parseJSON val =
    if
...
data PostQuotesResponse
  = -- | Means either no matching case available or a parse error
    PostQuotesResponseError GHC.Base.String
  | -- | Successful response.
    PostQuotesResponse200 Quote
  | -- | Error response.
    PostQuotesResponseDefault Error
  deriving (GHC.Show.Show, GHC.Classes.Eq)
