...
getApplicationFeesIdRefundsRaw config
                               endingBefore
                               expand
                               id
                               limit
...
getApplicationFeesIdRefundsM :: forall m s . (StripeAPI.Common.MonadHTTP m,
                                ...
                                Control.Monad.Trans.Reader.ReaderT (StripeAPI.Common.Configuration s)
                                                                   ...
                                                                   (Data.Either.Either Network.HTTP.Client.Types.HttpException
                                                                                       (Network.HTTP.Client.Types.Response GetApplicationFeesIdRefundsResponse))
getApplicationFeesIdRefundsM endingBefore
                             expand
                             id
                             limit
                             startingAfter
                             body = GHC.Base.fmap (GHC.Base.fmap (\response_2 -> GHC.Base.fmap (Data.Either.either GetApplicationFeesIdRefundsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_3 -> Network.HTTP.Types.Status.statusCode status_3 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetApplicationFeesIdRefundsResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                    GetApplicationFeesIdRefundsResponseBody200)
                                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetApplicationFeesIdRefundsResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                      Error)
...
getApplicationFeesIdRefundsRawM :: forall m s . (StripeAPI.Common.MonadHTTP m,
                                   ...
                                   Control.Monad.Trans.Reader.ReaderT (StripeAPI.Common.Configuration s)
                                                                      ...
                                                                      (Data.Either.Either Network.HTTP.Client.Types.HttpException
                                                                                          (Network.HTTP.Client.Types.Response Data.ByteString.Internal.ByteString))
getApplicationFeesIdRefundsRawM endingBefore
                                expand
                                id
                                limit
                                startingAfter
...
data GetApplicationFeesIdRefundsResponseBody200Object'
    ...
    deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.ToJSON GetApplicationFeesIdRefundsResponseBody200Object'
    where toJSON (GetApplicationFeesIdRefundsResponseBody200Object'EnumOther patternName) = Data.Aeson.Types.ToJSON.toJSON patternName
...
instance Data.Aeson.FromJSON GetApplicationFeesIdRefundsResponseBody200Object'
