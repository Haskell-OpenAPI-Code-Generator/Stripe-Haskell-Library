...
getCouponsCoupon ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetCouponsCouponResponse))
getCouponsCoupon
  config
  coupon
  expand
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/coupons/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel coupon)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetCouponsCouponRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetCouponsCouponRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCouponsCouponRequestBody" (\obj -> GHC.Base.pure GetCouponsCouponRequestBody)
