...
getTransfersIdReversals ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTransfersIdReversalsResponse)
getTransfersIdReversals parameters =
  GHC.Base.fmap
    ...
    ( StripeAPI.Common.doCallWithConfigurationM
        ...
        ("/v1/transfers/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getTransfersIdReversalsParametersPathId parameters))) GHC.Base.<> "/reversals"))
        [ StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTransfersIdReversalsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
