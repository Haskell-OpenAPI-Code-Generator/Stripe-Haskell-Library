...
instance Data.Aeson.ToJSON GetTransfersIdReversalsParameters where
...
-- | > GET /v1/transfers/{id}/reversals
--
-- The same as 'getTransfersIdReversals' but accepts an explicit configuration.
getTransfersIdReversalsWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GetTransfersIdReversalsParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response GetTransfersIdReversalsResponse)
getTransfersIdReversalsWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
getTransfersIdReversalsRaw parameters =
  GHC.Base.id
    ( StripeAPI.Common.doCallWithConfigurationM
        (Data.Text.toUpper GHC.Base.$ Data.Text.pack "GET")
        (Data.Text.pack ("/v1/transfers/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel (getTransfersIdReversalsParametersPathId parameters))) GHC.Base.++ "/reversals")))
...
-- | > GET /v1/transfers/{id}/reversals
--
-- The same as 'getTransfersIdReversals' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
getTransfersIdReversalsWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
