...
deleteAccountBankAccountsId :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteAccountBankAccountsIdResponse) -- ^ Monadic computation which returns the result of the operation
deleteAccountBankAccountsId id = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteAccountBankAccountsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteAccountBankAccountsIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
