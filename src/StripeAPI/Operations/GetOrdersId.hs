...
getOrdersId :: forall m . StripeAPI.Common.MonadHTTP m => GetOrdersIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetOrdersIdResponse) -- ^ Monadic computation which returns the result of the operation
getOrdersId parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetOrdersIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetOrdersIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                          Order)
...
data GetOrdersIdParameters = GetOrdersIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetOrdersIdParameters
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathId" Data.Aeson.Types.ToJSON..= getOrdersIdParametersPathId obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getOrdersIdParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetOrdersIdParameters
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetOrdersIdParameters" (\obj -> (GHC.Base.pure GetOrdersIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))
-- | Create a new 'GetOrdersIdParameters' with all required fields.
mkGetOrdersIdParameters :: Data.Text.Internal.Text -- ^ 'getOrdersIdParametersPathId'
  -> GetOrdersIdParameters
mkGetOrdersIdParameters getOrdersIdParametersPathId = GetOrdersIdParameters{getOrdersIdParametersPathId = getOrdersIdParametersPathId,
