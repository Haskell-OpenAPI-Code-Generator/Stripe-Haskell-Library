...
getRefundsRefund ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetRefundsRefundResponse))
getRefundsRefund
  config
  expand
  refund
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/refunds/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel refund)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetRefundsRefundRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetRefundsRefundRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRefundsRefundRequestBody" (\obj -> GHC.Base.pure GetRefundsRefundRequestBody)
