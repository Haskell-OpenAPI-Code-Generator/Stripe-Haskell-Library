...
getInvoicesInvoiceLines ::
  ...
  GHC.Maybe.Maybe GetInvoicesInvoiceLinesRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetInvoicesInvoiceLinesResponse))
getInvoicesInvoiceLines
  config
  endingBefore
  expand
  ...
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/invoices/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel invoice)) GHC.Base.++ "/lines")))
...
instance Data.Aeson.ToJSON GetInvoicesInvoiceLinesRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetInvoicesInvoiceLinesRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetInvoicesInvoiceLinesRequestBody" (\obj -> GHC.Base.pure GetInvoicesInvoiceLinesRequestBody)
