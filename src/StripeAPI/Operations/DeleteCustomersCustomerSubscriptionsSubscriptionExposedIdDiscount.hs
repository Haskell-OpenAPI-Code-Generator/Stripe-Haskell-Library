...
instance Data.Aeson.ToJSON DeleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscountParameters where
...
-- | > DELETE /v1/customers/{customer}/subscriptions/{subscription_exposed_id}/discount
--
-- The same as 'deleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscount' but accepts an explicit configuration.
deleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscountWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  DeleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscountParameters ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response DeleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscountResponse)
deleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscountWithConfiguration
  config
  parameters =
    GHC.Base.fmap
...
-- | > DELETE /v1/customers/{customer}/subscriptions/{subscription_exposed_id}/discount
--
-- The same as 'deleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscount' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
deleteCustomersCustomerSubscriptionsSubscriptionExposedIdDiscountWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
