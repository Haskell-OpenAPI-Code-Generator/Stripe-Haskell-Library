...
getIssuingDisputes ::
  ...
  GHC.Maybe.Maybe GetIssuingDisputesRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetIssuingDisputesResponse))
getIssuingDisputes
  config
  created
  disputedTransaction
    ...
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          ( ( Data.Text.pack "created",
              ...
              : ( ( Data.Text.pack "disputed_transaction",
                    StripeAPI.Common.stringifyModel Data.Functor.<$> disputedTransaction
                  )
...
instance Data.Aeson.ToJSON GetIssuingDisputesRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingDisputesRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuingDisputesRequestBody" (\obj -> GHC.Base.pure GetIssuingDisputesRequestBody)
