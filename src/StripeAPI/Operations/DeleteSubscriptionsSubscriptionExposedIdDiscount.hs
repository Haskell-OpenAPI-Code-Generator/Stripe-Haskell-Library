...
-- | > DELETE /v1/subscriptions/{subscription_exposed_id}/discount
--
-- The same as 'deleteSubscriptionsSubscriptionExposedIdDiscount' but accepts an explicit configuration.
deleteSubscriptionsSubscriptionExposedIdDiscountWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  Data.Text.Internal.Text ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response DeleteSubscriptionsSubscriptionExposedIdDiscountResponse)
deleteSubscriptionsSubscriptionExposedIdDiscountWithConfiguration
  config
...
deleteSubscriptionsSubscriptionExposedIdDiscountRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | subscription_exposed_id | Constraints: Maximum length of 5000
  Data.Text.Internal.Text ->
...
deleteSubscriptionsSubscriptionExposedIdDiscountRaw subscriptionExposedId = GHC.Base.id (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "DELETE") (Data.Text.pack ("/v1/subscriptions/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel subscriptionExposedId)) GHC.Base.++ "/discount"))) [])

-- | > DELETE /v1/subscriptions/{subscription_exposed_id}/discount
--
-- The same as 'deleteSubscriptionsSubscriptionExposedIdDiscount' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
deleteSubscriptionsSubscriptionExposedIdDiscountWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
