...
getClimateOrdersOrder ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetClimateOrdersOrderResponse)
getClimateOrdersOrder parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either GetClimateOrdersOrderResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if
                                 | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetClimateOrdersOrderResponse200
                                 ...
                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) ->
                                     GetClimateOrdersOrderResponseDefault
                                       Data.Functor.<$> ( Data.Aeson.eitherDecodeStrict body ::
                                                            Data.Either.Either
                                                              GHC.Base.String
                                                              Error
...
instance Data.Aeson.Types.ToJSON.ToJSON GetClimateOrdersOrderParameters where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathOrder" Data.Aeson.Types.ToJSON..= getClimateOrdersOrderParametersPathOrder obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getClimateOrdersOrderParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetClimateOrdersOrderParameters where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetClimateOrdersOrderParameters" (\obj -> (GHC.Base.pure GetClimateOrdersOrderParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathOrder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))

-- | Create a new 'GetClimateOrdersOrderParameters' with all required fields.
mkGetClimateOrdersOrderParameters ::
  -- | 'getClimateOrdersOrderParametersPathOrder'
  Data.Text.Internal.Text ->
  GetClimateOrdersOrderParameters
mkGetClimateOrdersOrderParameters getClimateOrdersOrderParametersPathOrder =
  GetClimateOrdersOrderParameters
    { getClimateOrdersOrderParametersPathOrder = getClimateOrdersOrderParametersPathOrder,
...
data GetClimateOrdersOrderResponse
  = -- | Means either no matching case available or a parse error
    GetClimateOrdersOrderResponseError GHC.Base.String
  | -- | Successful response.
    GetClimateOrdersOrderResponse200 Climate'order
  | -- | Error response.
    GetClimateOrdersOrderResponseDefault Error
