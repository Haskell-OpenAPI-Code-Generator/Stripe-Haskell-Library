...
data PostIssuingDisputesDisputeRequestBody
  = PostIssuingDisputesDisputeRequestBody
      { -- | expand: Specifies which fields in the response should be expanded.
        ...
        postIssuingDisputesDisputeRequestBodyMetadata :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
      }
  deriving
    ( GHC.Show.Show,
      GHC.Classes.Eq
...
-- | > POST /v1/issuing/disputes/{dispute}
--
-- The same as 'postIssuingDisputesDispute' but accepts an explicit configuration.
postIssuingDisputesDisputeWithConfiguration ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  ...
  GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBody ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response PostIssuingDisputesDisputeResponse)
postIssuingDisputesDisputeWithConfiguration
  config
  dispute
  body =
...
-- | > POST /v1/issuing/disputes/{dispute}
--
-- The same as 'postIssuingDisputesDispute' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
postIssuingDisputesDisputeWithConfigurationRaw ::
  forall m.
  StripeAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  StripeAPI.Common.Configuration ->
