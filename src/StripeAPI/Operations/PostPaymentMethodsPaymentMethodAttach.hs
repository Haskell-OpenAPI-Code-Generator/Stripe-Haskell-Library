...
postPaymentMethodsPaymentMethodAttach ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostPaymentMethodsPaymentMethodAttachResponse))
postPaymentMethodsPaymentMethodAttach
  config
  paymentMethod
  body =
...
postPaymentMethodsPaymentMethodAttachM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
postPaymentMethodsPaymentMethodAttachRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
