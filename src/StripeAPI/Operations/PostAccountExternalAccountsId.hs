...
postAccountExternalAccountsId :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id
  -> GHC.Maybe.Maybe PostAccountExternalAccountsIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostAccountExternalAccountsIdResponse) -- ^ Monadic computation which returns the result of the operation
postAccountExternalAccountsId id
                              body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountExternalAccountsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountExternalAccountsIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                          ExternalAccount)
...
data PostAccountExternalAccountsIdRequestBody = PostAccountExternalAccountsIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountExternalAccountsIdRequestBody
...
mkPostAccountExternalAccountsIdRequestBody = PostAccountExternalAccountsIdRequestBody{postAccountExternalAccountsIdRequestBodyAccountHolderName = GHC.Maybe.Nothing,
...
data PostAccountExternalAccountsIdRequestBodyAccountHolderType' =
   PostAccountExternalAccountsIdRequestBodyAccountHolderType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostAccountExternalAccountsIdRequestBodyAccountHolderType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostAccountExternalAccountsIdRequestBodyAccountHolderType'EnumEmptyString -- ^ Represents the JSON value @""@
  | PostAccountExternalAccountsIdRequestBodyAccountHolderType'EnumCompany -- ^ Represents the JSON value @"company"@
  | PostAccountExternalAccountsIdRequestBodyAccountHolderType'EnumIndividual -- ^ Represents the JSON value @"individual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountExternalAccountsIdRequestBodyAccountHolderType'
    where toJSON (PostAccountExternalAccountsIdRequestBodyAccountHolderType'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountExternalAccountsIdRequestBodyAccountHolderType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> PostAccountExternalAccountsIdRequestBodyAccountHolderType'EnumEmptyString
...
data PostAccountExternalAccountsIdRequestBodyAccountType' =
   PostAccountExternalAccountsIdRequestBodyAccountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostAccountExternalAccountsIdRequestBodyAccountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostAccountExternalAccountsIdRequestBodyAccountType'EnumChecking -- ^ Represents the JSON value @"checking"@
  | PostAccountExternalAccountsIdRequestBodyAccountType'EnumFutsu -- ^ Represents the JSON value @"futsu"@
  | PostAccountExternalAccountsIdRequestBodyAccountType'EnumSavings -- ^ Represents the JSON value @"savings"@
  | PostAccountExternalAccountsIdRequestBodyAccountType'EnumToza -- ^ Represents the JSON value @"toza"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountExternalAccountsIdRequestBodyAccountType'
    where toJSON (PostAccountExternalAccountsIdRequestBodyAccountType'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountExternalAccountsIdRequestBodyAccountType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "checking" -> PostAccountExternalAccountsIdRequestBodyAccountType'EnumChecking
...
data PostAccountExternalAccountsIdRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountExternalAccountsIdRequestBodyMetadata'Variants
    where toJSON (PostAccountExternalAccountsIdRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostAccountExternalAccountsIdRequestBodyMetadata'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountExternalAccountsIdRequestBodyMetadata'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostAccountExternalAccountsIdRequestBodyMetadata'EmptyString
