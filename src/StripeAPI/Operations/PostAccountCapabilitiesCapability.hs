...
postAccountCapabilitiesCapability :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ capability
  -> GHC.Maybe.Maybe PostAccountCapabilitiesCapabilityRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostAccountCapabilitiesCapabilityResponse) -- ^ Monadic computation which returns the result of the operation
postAccountCapabilitiesCapability capability
                                  body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountCapabilitiesCapabilityResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountCapabilitiesCapabilityResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      Capability)
...
data PostAccountCapabilitiesCapabilityRequestBody = PostAccountCapabilitiesCapabilityRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountCapabilitiesCapabilityRequestBody
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postAccountCapabilitiesCapabilityRequestBodyExpand obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("requested" Data.Aeson.Types.ToJSON..=)) (postAccountCapabilitiesCapabilityRequestBodyRequested obj) : GHC.Base.mempty))
...
mkPostAccountCapabilitiesCapabilityRequestBody = PostAccountCapabilitiesCapabilityRequestBody{postAccountCapabilitiesCapabilityRequestBodyExpand = GHC.Maybe.Nothing,
