...
getRecipientsId :: forall m . StripeAPI.Common.MonadHTTP m => GetRecipientsIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetRecipientsIdResponse) -- ^ Monadic computation which returns the result of the operation
getRecipientsId parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetRecipientsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetRecipientsIdResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
...
data GetRecipientsIdParameters = GetRecipientsIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdParameters
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathId" Data.Aeson.Types.ToJSON..= getRecipientsIdParametersPathId obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdParametersQueryExpand obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdParameters
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRecipientsIdParameters" (\obj -> (GHC.Base.pure GetRecipientsIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))
-- | Create a new 'GetRecipientsIdParameters' with all required fields.
mkGetRecipientsIdParameters :: Data.Text.Internal.Text -- ^ 'getRecipientsIdParametersPathId'
  -> GetRecipientsIdParameters
mkGetRecipientsIdParameters getRecipientsIdParametersPathId = GetRecipientsIdParameters{getRecipientsIdParametersPathId = getRecipientsIdParametersPathId,
...
data GetRecipientsIdResponseBody200 = GetRecipientsIdResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200
...
mkGetRecipientsIdResponseBody200 = GetRecipientsIdResponseBody200{getRecipientsIdResponseBody200ActiveAccount = GHC.Maybe.Nothing,
...
data GetRecipientsIdResponseBody200ActiveAccount'NonNullable = GetRecipientsIdResponseBody200ActiveAccount'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullable
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_name" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAccountHolderName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_type" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAccountHolderType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_type" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAccountType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("available_payout_methods" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("bank_name" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableBankName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("customer" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("default_for_currency" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableDefaultForCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("fingerprint" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableFingerprint obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("id" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableId obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("last4" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableLast4 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableMetadata obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("object" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableObject obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("routing_number" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableRoutingNumber obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableStatus obj) : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_name" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAccountHolderName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_type" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAccountHolderType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_type" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAccountType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("available_payout_methods" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("bank_name" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableBankName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("customer" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("default_for_currency" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableDefaultForCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("fingerprint" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableFingerprint obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("id" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableId obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("last4" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableLast4 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableMetadata obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("object" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableObject obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("routing_number" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableRoutingNumber obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (getRecipientsIdResponseBody200ActiveAccount'NonNullableStatus obj) : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRecipientsIdResponseBody200ActiveAccount'NonNullable" (\obj -> ((((((((((((((((GHC.Base.pure GetRecipientsIdResponseBody200ActiveAccount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "available_payout_methods")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "default_for_currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fingerprint")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "object")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "routing_number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status"))
...
mkGetRecipientsIdResponseBody200ActiveAccount'NonNullable = GetRecipientsIdResponseBody200ActiveAccount'NonNullable{getRecipientsIdResponseBody200ActiveAccount'NonNullableAccount = GHC.Maybe.Nothing,
...
data GetRecipientsIdResponseBody200ActiveAccount'NonNullableAccount'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullableAccount'NonNullableVariants
    where toJSON (GetRecipientsIdResponseBody200ActiveAccount'NonNullableAccount'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
...
data GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullable =
   GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullableEnumInstant -- ^ Represents the JSON value @"instant"@
  | GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullableEnumStandard -- ^ Represents the JSON value @"standard"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullable
    where toJSON (GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullableOther val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullable
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "instant" -> GetRecipientsIdResponseBody200ActiveAccount'NonNullableAvailablePayoutMethods'NonNullableEnumInstant
...
data GetRecipientsIdResponseBody200ActiveAccount'NonNullableCustomer'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullableCustomer'NonNullableVariants
    where toJSON (GetRecipientsIdResponseBody200ActiveAccount'NonNullableCustomer'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullableCustomer'NonNullableVariants
...
data GetRecipientsIdResponseBody200ActiveAccount'NonNullableObject' =
   GetRecipientsIdResponseBody200ActiveAccount'NonNullableObject'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetRecipientsIdResponseBody200ActiveAccount'NonNullableObject'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetRecipientsIdResponseBody200ActiveAccount'NonNullableObject'EnumBankAccount -- ^ Represents the JSON value @"bank_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullableObject'
    where toJSON (GetRecipientsIdResponseBody200ActiveAccount'NonNullableObject'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200ActiveAccount'NonNullableObject'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bank_account" -> GetRecipientsIdResponseBody200ActiveAccount'NonNullableObject'EnumBankAccount
...
data GetRecipientsIdResponseBody200Cards'NonNullable = GetRecipientsIdResponseBody200Cards'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200Cards'NonNullable
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getRecipientsIdResponseBody200Cards'NonNullableData obj] : ["has_more" Data.Aeson.Types.ToJSON..= getRecipientsIdResponseBody200Cards'NonNullableHasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getRecipientsIdResponseBody200Cards'NonNullableUrl obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200Cards'NonNullable
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRecipientsIdResponseBody200Cards'NonNullable" (\obj -> ((GHC.Base.pure GetRecipientsIdResponseBody200Cards'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))
-- | Create a new 'GetRecipientsIdResponseBody200Cards'NonNullable' with all required fields.
mkGetRecipientsIdResponseBody200Cards'NonNullable :: [Card] -- ^ 'getRecipientsIdResponseBody200Cards'NonNullableData'
  -> GHC.Types.Bool -- ^ 'getRecipientsIdResponseBody200Cards'NonNullableHasMore'
  -> Data.Text.Internal.Text -- ^ 'getRecipientsIdResponseBody200Cards'NonNullableUrl'
  -> GetRecipientsIdResponseBody200Cards'NonNullable
mkGetRecipientsIdResponseBody200Cards'NonNullable getRecipientsIdResponseBody200Cards'NonNullableData getRecipientsIdResponseBody200Cards'NonNullableHasMore getRecipientsIdResponseBody200Cards'NonNullableUrl = GetRecipientsIdResponseBody200Cards'NonNullable{getRecipientsIdResponseBody200Cards'NonNullableData = getRecipientsIdResponseBody200Cards'NonNullableData,
...
data GetRecipientsIdResponseBody200DefaultCard'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200DefaultCard'NonNullableVariants
    where toJSON (GetRecipientsIdResponseBody200DefaultCard'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (GetRecipientsIdResponseBody200DefaultCard'NonNullableCard a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200DefaultCard'NonNullableVariants
    where parseJSON val = case (GetRecipientsIdResponseBody200DefaultCard'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetRecipientsIdResponseBody200DefaultCard'NonNullableCard Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
data GetRecipientsIdResponseBody200Deleted' =
   GetRecipientsIdResponseBody200Deleted'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetRecipientsIdResponseBody200Deleted'Typed GHC.Types.Bool -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetRecipientsIdResponseBody200Deleted'EnumTrue -- ^ Represents the JSON value @true@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200Deleted'
    where toJSON (GetRecipientsIdResponseBody200Deleted'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200Deleted'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== Data.Aeson.Types.Internal.Bool GHC.Types.True -> GetRecipientsIdResponseBody200Deleted'EnumTrue
...
data GetRecipientsIdResponseBody200MigratedTo'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200MigratedTo'NonNullableVariants
    where toJSON (GetRecipientsIdResponseBody200MigratedTo'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (GetRecipientsIdResponseBody200MigratedTo'NonNullableAccount a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200MigratedTo'NonNullableVariants
    where parseJSON val = case (GetRecipientsIdResponseBody200MigratedTo'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetRecipientsIdResponseBody200MigratedTo'NonNullableAccount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
...
data GetRecipientsIdResponseBody200Object' =
   GetRecipientsIdResponseBody200Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetRecipientsIdResponseBody200Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetRecipientsIdResponseBody200Object'EnumRecipient -- ^ Represents the JSON value @"recipient"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200Object'
    where toJSON (GetRecipientsIdResponseBody200Object'Other val) = val
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200Object'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "recipient" -> GetRecipientsIdResponseBody200Object'EnumRecipient
...
data GetRecipientsIdResponseBody200RolledBackFrom'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRecipientsIdResponseBody200RolledBackFrom'Variants
    where toJSON (GetRecipientsIdResponseBody200RolledBackFrom'Text a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (GetRecipientsIdResponseBody200RolledBackFrom'Account a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON GetRecipientsIdResponseBody200RolledBackFrom'Variants
    where parseJSON val = case (GetRecipientsIdResponseBody200RolledBackFrom'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetRecipientsIdResponseBody200RolledBackFrom'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
