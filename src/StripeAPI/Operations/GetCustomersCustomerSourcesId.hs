...
getCustomersCustomerSourcesId ::
  ...
  -- | id | Constraints: Maximum length of 500
  Data.Text.Internal.Text ->
  -- | The request body to send
  GHC.Maybe.Maybe GetCustomersCustomerSourcesIdRequestBody ->
  -- | Monad containing the result of the operation
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetCustomersCustomerSourcesIdResponse))
getCustomersCustomerSourcesId
  config
  customer
  expand
...
getCustomersCustomerSourcesIdM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
getCustomersCustomerSourcesIdRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON GetCustomersCustomerSourcesIdRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerSourcesIdRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerSourcesIdRequestBody" (\obj -> GHC.Base.pure GetCustomersCustomerSourcesIdRequestBody)
