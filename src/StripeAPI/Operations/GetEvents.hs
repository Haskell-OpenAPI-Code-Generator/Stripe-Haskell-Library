...
instance Data.Aeson.Types.ToJSON.ToJSON GetEventsParameters where
  toJSON obj = Data.Aeson.Types.Internal.object ("queryCreated" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated obj : "queryDelivery_success" Data.Aeson.Types.ToJSON..= getEventsParametersQueryDeliverySuccess obj : "queryEnding_before" Data.Aeson.Types.ToJSON..= getEventsParametersQueryEndingBefore obj : "queryExpand" Data.Aeson.Types.ToJSON..= getEventsParametersQueryExpand obj : "queryLimit" Data.Aeson.Types.ToJSON..= getEventsParametersQueryLimit obj : "queryStarting_after" Data.Aeson.Types.ToJSON..= getEventsParametersQueryStartingAfter obj : "queryType" Data.Aeson.Types.ToJSON..= getEventsParametersQueryType obj : "queryTypes" Data.Aeson.Types.ToJSON..= getEventsParametersQueryTypes obj : [])
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("queryCreated" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated obj) GHC.Base.<> (("queryDelivery_success" Data.Aeson.Types.ToJSON..= getEventsParametersQueryDeliverySuccess obj) GHC.Base.<> (("queryEnding_before" Data.Aeson.Types.ToJSON..= getEventsParametersQueryEndingBefore obj) GHC.Base.<> (("queryExpand" Data.Aeson.Types.ToJSON..= getEventsParametersQueryExpand obj) GHC.Base.<> (("queryLimit" Data.Aeson.Types.ToJSON..= getEventsParametersQueryLimit obj) GHC.Base.<> (("queryStarting_after" Data.Aeson.Types.ToJSON..= getEventsParametersQueryStartingAfter obj) GHC.Base.<> (("queryType" Data.Aeson.Types.ToJSON..= getEventsParametersQueryType obj) GHC.Base.<> ("queryTypes" Data.Aeson.Types.ToJSON..= getEventsParametersQueryTypes obj))))))))
...
mkGetEventsParameters =
  GetEventsParameters
    { getEventsParametersQueryCreated = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetEventsParametersQueryCreated'OneOf2 where
  toJSON obj = Data.Aeson.Types.Internal.object ("gt" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated'OneOf2Gt obj : "gte" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated'OneOf2Gte obj : "lt" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated'OneOf2Lt obj : "lte" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated'OneOf2Lte obj : [])
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("gt" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated'OneOf2Gt obj) GHC.Base.<> (("gte" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated'OneOf2Gte obj) GHC.Base.<> (("lt" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated'OneOf2Lt obj) GHC.Base.<> ("lte" Data.Aeson.Types.ToJSON..= getEventsParametersQueryCreated'OneOf2Lte obj))))
...
-- | Create a new 'GetEventsParametersQueryCreated'OneOf2' with all required fields.
mkGetEventsParametersQueryCreated'OneOf2 :: GetEventsParametersQueryCreated'OneOf2
mkGetEventsParametersQueryCreated'OneOf2 =
  GetEventsParametersQueryCreated'OneOf2
    { getEventsParametersQueryCreated'OneOf2Gt = GHC.Maybe.Nothing,
      getEventsParametersQueryCreated'OneOf2Gte = GHC.Maybe.Nothing,
      getEventsParametersQueryCreated'OneOf2Lt = GHC.Maybe.Nothing,
      getEventsParametersQueryCreated'OneOf2Lte = GHC.Maybe.Nothing
    }
...
instance Data.Aeson.Types.FromJSON.FromJSON GetEventsParametersQueryCreated'Variants where
  parseJSON val = case (GetEventsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetEventsParametersQueryCreated'GetEventsParametersQueryCreated'OneOf2 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
instance Data.Aeson.Types.ToJSON.ToJSON GetEventsResponseBody200 where
  toJSON obj = Data.Aeson.Types.Internal.object ("data" Data.Aeson.Types.ToJSON..= getEventsResponseBody200Data obj : "has_more" Data.Aeson.Types.ToJSON..= getEventsResponseBody200HasMore obj : "url" Data.Aeson.Types.ToJSON..= getEventsResponseBody200Url obj : "object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list" : [])
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("data" Data.Aeson.Types.ToJSON..= getEventsResponseBody200Data obj) GHC.Base.<> (("has_more" Data.Aeson.Types.ToJSON..= getEventsResponseBody200HasMore obj) GHC.Base.<> (("url" Data.Aeson.Types.ToJSON..= getEventsResponseBody200Url obj) GHC.Base.<> ("object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"))))

instance Data.Aeson.Types.FromJSON.FromJSON GetEventsResponseBody200 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetEventsResponseBody200" (\obj -> ((GHC.Base.pure GetEventsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))

-- | Create a new 'GetEventsResponseBody200' with all required fields.
mkGetEventsResponseBody200 ::
  -- | 'getEventsResponseBody200Data'
  [Event] ->
  -- | 'getEventsResponseBody200HasMore'
  GHC.Types.Bool ->
  -- | 'getEventsResponseBody200Url'
  Data.Text.Internal.Text ->
  GetEventsResponseBody200
mkGetEventsResponseBody200 getEventsResponseBody200Data getEventsResponseBody200HasMore getEventsResponseBody200Url =
  GetEventsResponseBody200
    { getEventsResponseBody200Data = getEventsResponseBody200Data,
