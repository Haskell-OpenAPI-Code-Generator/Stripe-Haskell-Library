...
data PostSubscriptionItemsItemRequestBody = PostSubscriptionItemsItemRequestBody
  { -- | billing_thresholds: Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period. When updating, pass an empty string to remove previously-defined thresholds.
    ...
    -- | price: The ID of the price object. When changing a subscription item\'s price, \`quantity\` is set to 1 unless a \`quantity\` parameter is provided.
    --
    -- Constraints:
    --
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSubscriptionItemsItemRequestBodyBillingThresholds'OneOf1 where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["usage_gte" Data.Aeson.Types.ToJSON..= postSubscriptionItemsItemRequestBodyBillingThresholds'OneOf1UsageGte obj] : GHC.Base.mempty))
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["usage_gte" Data.Aeson.Types.ToJSON..= postSubscriptionItemsItemRequestBodyBillingThresholds'OneOf1UsageGte obj] : GHC.Base.mempty)))
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSubscriptionItemsItemRequestBodyPriceData'Recurring' where
  toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["interval" Data.Aeson.Types.ToJSON..= postSubscriptionItemsItemRequestBodyPriceData'Recurring'Interval obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (postSubscriptionItemsItemRequestBodyPriceData'Recurring'IntervalCount obj) : GHC.Base.mempty))
