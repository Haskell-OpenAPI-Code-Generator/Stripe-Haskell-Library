...
getFiles ::
  ...
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetFilesResponse)
getFiles parameters =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
