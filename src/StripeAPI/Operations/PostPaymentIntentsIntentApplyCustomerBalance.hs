...
postPaymentIntentsIntentApplyCustomerBalance ::
  ...
  GHC.Maybe.Maybe PostPaymentIntentsIntentApplyCustomerBalanceRequestBody ->
  -- | Monadic computation which returns the result of the operation
  StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostPaymentIntentsIntentApplyCustomerBalanceResponse)
postPaymentIntentsIntentApplyCustomerBalance
  intent
  body =
    GHC.Base.fmap
      ( \response_0 ->
          GHC.Base.fmap
            ( Data.Either.either PostPaymentIntentsIntentApplyCustomerBalanceResponseError GHC.Base.id
...
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentIntentsIntentApplyCustomerBalanceRequestBody where
...
mkPostPaymentIntentsIntentApplyCustomerBalanceRequestBody =
  PostPaymentIntentsIntentApplyCustomerBalanceRequestBody
    { postPaymentIntentsIntentApplyCustomerBalanceRequestBodyAmount = GHC.Maybe.Nothing,
...
data PostPaymentIntentsIntentApplyCustomerBalanceResponse
  = -- | Means either no matching case available or a parse error
    PostPaymentIntentsIntentApplyCustomerBalanceResponseError GHC.Base.String
  | -- | Successful response.
    PostPaymentIntentsIntentApplyCustomerBalanceResponse200 PaymentIntent
  | -- | Error response.
    PostPaymentIntentsIntentApplyCustomerBalanceResponseDefault Error
