...
postAccountPeople :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe PostAccountPeopleRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostAccountPeopleResponse) -- ^ Monadic computation which returns the result of the operation
postAccountPeople body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountPeopleResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountPeopleResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                     ...
                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostAccountPeopleResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                        Error)
                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/v1/account/people") GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostAccountPeopleRequestBody = PostAccountPeopleRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBody
...
mkPostAccountPeopleRequestBody = PostAccountPeopleRequestBody{postAccountPeopleRequestBodyAccount = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyAddress' = PostAccountPeopleRequestBodyAddress' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyAddress'
...
mkPostAccountPeopleRequestBodyAddress' = PostAccountPeopleRequestBodyAddress'{postAccountPeopleRequestBodyAddress'City = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyAddressKana' = PostAccountPeopleRequestBodyAddressKana' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyAddressKana'
...
mkPostAccountPeopleRequestBodyAddressKana' = PostAccountPeopleRequestBodyAddressKana'{postAccountPeopleRequestBodyAddressKana'City = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyAddressKanji' = PostAccountPeopleRequestBodyAddressKanji' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyAddressKanji'
...
mkPostAccountPeopleRequestBodyAddressKanji' = PostAccountPeopleRequestBodyAddressKanji'{postAccountPeopleRequestBodyAddressKanji'City = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyDob'OneOf1 = PostAccountPeopleRequestBodyDob'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyDob'OneOf1
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["day" Data.Aeson.Types.ToJSON..= postAccountPeopleRequestBodyDob'OneOf1Day obj] : ["month" Data.Aeson.Types.ToJSON..= postAccountPeopleRequestBodyDob'OneOf1Month obj] : ["year" Data.Aeson.Types.ToJSON..= postAccountPeopleRequestBodyDob'OneOf1Year obj] : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyDob'OneOf1
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountPeopleRequestBodyDob'OneOf1" (\obj -> ((GHC.Base.pure PostAccountPeopleRequestBodyDob'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "day")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "year"))
-- | Create a new 'PostAccountPeopleRequestBodyDob'OneOf1' with all required fields.
mkPostAccountPeopleRequestBodyDob'OneOf1 :: GHC.Types.Int -- ^ 'postAccountPeopleRequestBodyDob'OneOf1Day'
  -> GHC.Types.Int -- ^ 'postAccountPeopleRequestBodyDob'OneOf1Month'
  -> GHC.Types.Int -- ^ 'postAccountPeopleRequestBodyDob'OneOf1Year'
  -> PostAccountPeopleRequestBodyDob'OneOf1
mkPostAccountPeopleRequestBodyDob'OneOf1 postAccountPeopleRequestBodyDob'OneOf1Day postAccountPeopleRequestBodyDob'OneOf1Month postAccountPeopleRequestBodyDob'OneOf1Year = PostAccountPeopleRequestBodyDob'OneOf1{postAccountPeopleRequestBodyDob'OneOf1Day = postAccountPeopleRequestBodyDob'OneOf1Day,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyDob'Variants
    where toJSON (PostAccountPeopleRequestBodyDob'PostAccountPeopleRequestBodyDob'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostAccountPeopleRequestBodyDob'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyDob'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostAccountPeopleRequestBodyDob'EmptyString
...
data PostAccountPeopleRequestBodyDocuments' = PostAccountPeopleRequestBodyDocuments' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyDocuments'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("company_authorization" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'CompanyAuthorization obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("passport" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'Passport obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("visa" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'Visa obj) : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("company_authorization" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'CompanyAuthorization obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("passport" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'Passport obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("visa" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'Visa obj) : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyDocuments'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountPeopleRequestBodyDocuments'" (\obj -> ((GHC.Base.pure PostAccountPeopleRequestBodyDocuments' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "company_authorization")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "passport")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "visa"))
...
mkPostAccountPeopleRequestBodyDocuments' = PostAccountPeopleRequestBodyDocuments'{postAccountPeopleRequestBodyDocuments'CompanyAuthorization = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyDocuments'CompanyAuthorization' = PostAccountPeopleRequestBodyDocuments'CompanyAuthorization' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyDocuments'CompanyAuthorization'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("files" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'CompanyAuthorization'Files obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyDocuments'CompanyAuthorization'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountPeopleRequestBodyDocuments'CompanyAuthorization'" (\obj -> GHC.Base.pure PostAccountPeopleRequestBodyDocuments'CompanyAuthorization' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "files"))
...
data PostAccountPeopleRequestBodyDocuments'Passport' = PostAccountPeopleRequestBodyDocuments'Passport' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyDocuments'Passport'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("files" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'Passport'Files obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyDocuments'Passport'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountPeopleRequestBodyDocuments'Passport'" (\obj -> GHC.Base.pure PostAccountPeopleRequestBodyDocuments'Passport' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "files"))
...
data PostAccountPeopleRequestBodyDocuments'Visa' = PostAccountPeopleRequestBodyDocuments'Visa' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyDocuments'Visa'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("files" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyDocuments'Visa'Files obj) : GHC.Base.mempty))
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyDocuments'Visa'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountPeopleRequestBodyDocuments'Visa'" (\obj -> GHC.Base.pure PostAccountPeopleRequestBodyDocuments'Visa' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "files"))
...
data PostAccountPeopleRequestBodyFullNameAliases'Variants =
   PostAccountPeopleRequestBodyFullNameAliases'EmptyString -- ^ Represents the JSON value @""@
  | PostAccountPeopleRequestBodyFullNameAliases'ListTText ([Data.Text.Internal.Text])
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyFullNameAliases'Variants
    where toJSON (PostAccountPeopleRequestBodyFullNameAliases'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostAccountPeopleRequestBodyFullNameAliases'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyFullNameAliases'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostAccountPeopleRequestBodyFullNameAliases'EmptyString
...
data PostAccountPeopleRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyMetadata'Variants
    where toJSON (PostAccountPeopleRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostAccountPeopleRequestBodyMetadata'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyMetadata'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostAccountPeopleRequestBodyMetadata'EmptyString
...
data PostAccountPeopleRequestBodyRegisteredAddress' = PostAccountPeopleRequestBodyRegisteredAddress' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyRegisteredAddress'
    where toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'City obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'Country obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'Line1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'Line2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'PostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'State obj) : GHC.Base.mempty))
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'City obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'Country obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'Line1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'Line2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'PostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postAccountPeopleRequestBodyRegisteredAddress'State obj) : GHC.Base.mempty)))
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyRegisteredAddress'
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountPeopleRequestBodyRegisteredAddress'" (\obj -> (((((GHC.Base.pure PostAccountPeopleRequestBodyRegisteredAddress' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))
...
mkPostAccountPeopleRequestBodyRegisteredAddress' = PostAccountPeopleRequestBodyRegisteredAddress'{postAccountPeopleRequestBodyRegisteredAddress'City = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyRelationship' = PostAccountPeopleRequestBodyRelationship' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyRelationship'
...
mkPostAccountPeopleRequestBodyRelationship' = PostAccountPeopleRequestBodyRelationship'{postAccountPeopleRequestBodyRelationship'Director = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyRelationship'PercentOwnership'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyRelationship'PercentOwnership'Variants
    where toJSON (PostAccountPeopleRequestBodyRelationship'PercentOwnership'Double a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostAccountPeopleRequestBodyRelationship'PercentOwnership'EmptyString) = ""
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountPeopleRequestBodyRelationship'PercentOwnership'Variants
    where parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostAccountPeopleRequestBodyRelationship'PercentOwnership'EmptyString
...
data PostAccountPeopleRequestBodyVerification' = PostAccountPeopleRequestBodyVerification' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyVerification'
...
mkPostAccountPeopleRequestBodyVerification' = PostAccountPeopleRequestBodyVerification'{postAccountPeopleRequestBodyVerification'AdditionalDocument = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyVerification'AdditionalDocument' = PostAccountPeopleRequestBodyVerification'AdditionalDocument' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyVerification'AdditionalDocument'
...
mkPostAccountPeopleRequestBodyVerification'AdditionalDocument' = PostAccountPeopleRequestBodyVerification'AdditionalDocument'{postAccountPeopleRequestBodyVerification'AdditionalDocument'Back = GHC.Maybe.Nothing,
...
data PostAccountPeopleRequestBodyVerification'Document' = PostAccountPeopleRequestBodyVerification'Document' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountPeopleRequestBodyVerification'Document'
...
mkPostAccountPeopleRequestBodyVerification'Document' = PostAccountPeopleRequestBodyVerification'Document'{postAccountPeopleRequestBodyVerification'Document'Back = GHC.Maybe.Nothing,
