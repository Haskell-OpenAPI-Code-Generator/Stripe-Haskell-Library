...
postAccountsAccountReject :: forall m s . (StripeAPI.Common.MonadHTTP m,
...
data PostAccountsAccountRejectRequestBody
    = PostAccountsAccountRejectRequestBody {postAccountsAccountRejectRequestBodyExpand :: (GHC.Maybe.Maybe ([] GHC.Base.String)),
