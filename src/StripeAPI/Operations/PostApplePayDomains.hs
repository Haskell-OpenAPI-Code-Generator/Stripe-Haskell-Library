...
postApplePayDomains ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostApplePayDomainsResponse))
postApplePayDomains
  config
  body =
    GHC.Base.fmap
