...
postAccountsAccountCapabilitiesCapability ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response PostAccountsAccountCapabilitiesCapabilityResponse))
postAccountsAccountCapabilitiesCapability
  config
  account
  capability
...
postAccountsAccountCapabilitiesCapabilityM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
postAccountsAccountCapabilitiesCapabilityRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
