...
deleteCustomersCustomerDiscount ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response DeleteCustomersCustomerDiscountResponse))
deleteCustomersCustomerDiscount
  config
  customer
  body =
...
deleteCustomersCustomerDiscountM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
deleteCustomersCustomerDiscountRawM ::
  forall m s.
  ( StripeAPI.Common.MonadHTTP m,
    StripeAPI.Common.SecurityScheme s
  ) =>
...
instance Data.Aeson.ToJSON DeleteCustomersCustomerDiscountRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON DeleteCustomersCustomerDiscountRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "DeleteCustomersCustomerDiscountRequestBody" (\obj -> GHC.Base.pure DeleteCustomersCustomerDiscountRequestBody)
