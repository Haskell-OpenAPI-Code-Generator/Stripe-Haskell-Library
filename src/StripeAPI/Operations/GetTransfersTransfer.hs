...
getTransfersTransfer ::
  ...
  m (Data.Either.Either Network.HTTP.Client.Types.HttpException (Network.HTTP.Client.Types.Response GetTransfersTransferResponse))
getTransfersTransfer
  config
  expand
  transfer
  body =
    GHC.Base.fmap
      ...
      ( StripeAPI.Common.doBodyCallWithConfiguration
          ...
          (Data.Text.pack ("/v1/transfers/" GHC.Base.++ (Data.ByteString.Char8.unpack (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (Data.ByteString.Char8.pack GHC.Base.$ StripeAPI.Common.stringifyModel transfer)) GHC.Base.++ "")))
...
instance Data.Aeson.ToJSON GetTransfersTransferRequestBody where
  toJSON obj = Data.Aeson.object []
  toEncoding obj = Data.Aeson.pairs ((Data.Aeson..=) "string" ("string" :: GHC.Base.String))

instance Data.Aeson.Types.FromJSON.FromJSON GetTransfersTransferRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTransfersTransferRequestBody" (\obj -> GHC.Base.pure GetTransfersTransferRequestBody)
